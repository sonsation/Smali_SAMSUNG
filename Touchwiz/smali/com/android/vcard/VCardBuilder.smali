...
.method private appendPostalsForDoCoMo(Ljava/util/List;)V
    ...
    .line 1123
    .local v6, "typeAsInteger":Ljava/lang/Integer;
    if-eqz v6, :cond_2
...
.method public appendEvents(Ljava/util/List;)Lcom/android/vcard/VCardBuilder;
    ...
    .line 1647
    .local v10, "primaryBirthdayType":Ljava/lang/String;
    const/4 v9, 0x0

    .line 1649
    .local v9, "primaryBirthdaySolarDate":Ljava/lang/String;
    invoke-interface {p1}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .end local v9    # "primaryBirthdaySolarDate":Ljava/lang/String;
    .end local v10    # "primaryBirthdayType":Ljava/lang/String;
    ...
    .restart local v9    # "primaryBirthdaySolarDate":Ljava/lang/String;
    .restart local v10    # "primaryBirthdayType":Ljava/lang/String;
...
.method public appendGroupName(Ljava/util/List;Landroid/content/ContentResolver;)V
    ...
    .line 2698
    .local v11, "shouldAppendCharsetInfo":Z
    :goto_2
    ...
    .line 2700
    .local v10, "reallyUseQuotedPrintable":Z
    :goto_3
    ...
    .line 2696
    .end local v10    # "reallyUseQuotedPrintable":Z
    .end local v11    # "shouldAppendCharsetInfo":Z
    :cond_6
    const/4 v11, 0x1
    ...
    .line 2697
    .restart local v11    # "shouldAppendCharsetInfo":Z
    :cond_7
    const/4 v10, 0x0
...
.method public appendIms(Ljava/util/List;)Lcom/android/vcard/VCardBuilder;
    ...
    .restart local v8    # "typeAsInteger":Ljava/lang/Integer;
    :cond_a
    const/4 v10, 0x3
...
.method public appendNameCard(Ljava/util/List;Landroid/content/ContentResolver;)V
    ...
    .line 2716
    .local v18, "nameCardFiles":Ljava/util/LinkedHashMap;, "Ljava/util/LinkedHashMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .line 2720
    .local v16, "nameCardFile":Ljava/lang/String;
    move-object/from16 v0, v18
    ...
    .line 2721
    .local v17, "nameCardFileId":Ljava/lang/String;
    if-eqz v17, :cond_3
    ...
    .line 2752
    .local v20, "photoType":Ljava/lang/String;
    ...
    .line 2753
    .local v19, "photoString":Ljava/lang/String;
    invoke-static/range {v19 .. v19}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    .line 2755
    .local v23, "tmpBuilder":Ljava/lang/StringBuilder;
    const-string v25, "FRONT"
    ...
    .end local v23    # "tmpBuilder":Ljava/lang/StringBuilder;
    invoke-direct/range {v23 .. v23}, Ljava/lang/StringBuilder;-><init>()V

    .line 2773
    .restart local v23    # "tmpBuilder":Ljava/lang/StringBuilder;
    const/4 v12, 0x0
    ...
    .line 2777
    .local v14, "maxNumForFirstLine":I
    const-string v25, " "
    ...
    .end local v13    # "maxNum":I
    .end local v14    # "maxNumForFirstLine":I
    .end local v15    # "maxNumInGeneral":I
    .end local v19    # "photoString":Ljava/lang/String;
    .end local v20    # "photoType":Ljava/lang/String;
    .end local v23    # "tmpBuilder":Ljava/lang/StringBuilder;
    .end local v24    # "tmpStr":Ljava/lang/String;
    :cond_5
    const/16 v25, 0x0
    ...
    .restart local v19    # "photoString":Ljava/lang/String;
    .restart local v20    # "photoType":Ljava/lang/String;
    ...
    .restart local v13    # "maxNum":I
    .restart local v14    # "maxNumForFirstLine":I
    .restart local v15    # "maxNumInGeneral":I
    .restart local v24    # "tmpStr":Ljava/lang/String;
    :cond_8
    move-object/from16 v0, v24
...
.method public appendOrganizations(Ljava/util/List;)Lcom/android/vcard/VCardBuilder;
    ...
    .line 1420
    .local v18, "jobDescription":Ljava/lang/String;
    if-eqz v18, :cond_6
    ...
    .line 1424
    .local v28, "symbol":Ljava/lang/String;
    if-eqz v28, :cond_7
    ...
    .line 1428
    .local v25, "phoneticName":Ljava/lang/String;
    if-eqz v25, :cond_8
    ...
    .line 1432
    .local v20, "officeLocation":Ljava/lang/String;
    if-eqz v20, :cond_9
    ...
    .line 1437
    .local v26, "rawOrganizationArray":[Ljava/lang/String;
    ...
    .line 1438
    .local v31, "typeAsObject":Ljava/lang/Integer;
    ...
    .line 1440
    .local v17, "isPrimaryAsInteger":Ljava/lang/Integer;
    if-eqz v17, :cond_10
    ...
    .line 1443
    .local v24, "parameterList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    if-eqz v16, :cond_a
    ...
    .line 1473
    .local v27, "reallyUseQuotedPrintable":Z
    :goto_4
    ...
    .line 1500
    .local v22, "orgValue":Ljava/lang/StringBuilder;
    ...
    .end local v22    # "orgValue":Ljava/lang/StringBuilder;
    .end local v27    # "reallyUseQuotedPrintable":Z
    :goto_7
    move-object/from16 v0, p0
    ...
    .end local v17    # "isPrimaryAsInteger":Ljava/lang/Integer;
    .end local v18    # "jobDescription":Ljava/lang/String;
    .end local v19    # "label":Ljava/lang/String;
    .end local v20    # "officeLocation":Ljava/lang/String;
    .end local v24    # "parameterList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v25    # "phoneticName":Ljava/lang/String;
    .end local v26    # "rawOrganizationArray":[Ljava/lang/String;
    .end local v28    # "symbol":Ljava/lang/String;
    .end local v30    # "type":I
    .end local v31    # "typeAsObject":Ljava/lang/Integer;
    :goto_8
    ...
    .line 1440
    .restart local v17    # "isPrimaryAsInteger":Ljava/lang/Integer;
    .restart local v18    # "jobDescription":Ljava/lang/String;
    .restart local v19    # "label":Ljava/lang/String;
    .restart local v20    # "officeLocation":Ljava/lang/String;
    .restart local v25    # "phoneticName":Ljava/lang/String;
    .restart local v26    # "rawOrganizationArray":[Ljava/lang/String;
    .restart local v28    # "symbol":Ljava/lang/String;
    .restart local v31    # "typeAsObject":Ljava/lang/Integer;
    :cond_f
    const/16 v16, 0x0
    ...
    .line 1448
    .restart local v24    # "parameterList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 1473
    .restart local v27    # "reallyUseQuotedPrintable":Z
    :cond_14
    const/4 v5, 0x1
    ...
    .line 1536
    .local v21, "orgBuilder":Ljava/lang/StringBuilder;
    invoke-static {v6}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    .line 1546
    .local v23, "orgline":Ljava/lang/String;
    ...
    .line 1554
    .end local v21    # "orgBuilder":Ljava/lang/StringBuilder;
    .end local v23    # "orgline":Ljava/lang/String;
    :cond_1d
    const/16 v32, 0x1
...
.method public appendPhones(Ljava/util/List;Lcom/android/vcard/VCardPhoneNumberTranslationCallback;)Lcom/android/vcard/VCardBuilder;
    ...
    .line 890
    .local v19, "phoneSet":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    invoke-interface/range {p1 .. p1}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .line 981
    .end local v19    # "phoneSet":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_1
    if-nez v16, :cond_2
    ...
    .line 890
    .restart local v19    # "phoneSet":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_3
    ...
    .line 892
    .local v21, "typeAsObject":Ljava/lang/Integer;
    ...
    .line 925
    .local v18, "phoneNumberList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 940
    .local v15, "numberWithControlSequence":Ljava/lang/String;
    ...
    .restart local v8    # "digitsOnlyBuilder":Ljava/lang/StringBuilder;
...
.method public appendPhotos(Ljava/util/List;)Lcom/android/vcard/VCardBuilder;
    ...
    .line 1585
    .local v2, "photoState":Ljava/lang/String;
    invoke-static {v2}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
...
.method public appendSipAddresses(Ljava/util/List;)Lcom/android/vcard/VCardBuilder;
    ...
    .line 2170
    .restart local v3    # "useXProperty":Z
    goto :goto_0

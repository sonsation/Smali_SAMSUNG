...
.method private addDescriptionForRemovingPreloadApp()V
    ...
    .line 589
    .local v7, "apps":Landroid/widget/LinearLayout;
    if-eqz v7, :cond_0
    ...
    .local v24, "instream":Ljava/io/InputStream;
    :try_start_1
    ...
    .line 607
    .end local v8    # "buffreader":Ljava/io/BufferedReader;
    .end local v24    # "instream":Ljava/io/InputStream;
    :goto_1
    :try_start_3
    ...
    .restart local v24    # "instream":Ljava/io/InputStream;
    ...
    .line 614
    .local v17, "e_reader":Ljava/io/IOException;
    invoke-virtual/range {v17 .. v17}, Ljava/io/IOException;->printStackTrace()V

    goto :goto_4

    .line 618
    .end local v17    # "e_reader":Ljava/io/IOException;
    :catch_2
    move-exception v16

    .line 619
    .local v16, "e_input":Ljava/io/IOException;
    ...
    .line 608
    .end local v9    # "buffreader":Ljava/io/BufferedReader;
    .end local v16    # "e_input":Ljava/io/IOException;
    .end local v24    # "instream":Ljava/io/InputStream;
    .end local v26    # "line":Ljava/lang/String;
    .local v8, "buffreader":Ljava/io/BufferedReader;
    .local v23, "instream":Ljava/io/InputStream;
    ...
    .line 619
    .restart local v16    # "e_input":Ljava/io/IOException;
    invoke-virtual/range {v16 .. v16}, Ljava/io/IOException;->printStackTrace()V
    ...
    .line 614
    .restart local v17    # "e_reader":Ljava/io/IOException;
    invoke-virtual/range {v17 .. v17}, Ljava/io/IOException;->printStackTrace()V
    ...
    .end local v17    # "e_reader":Ljava/io/IOException;
    .restart local v15    # "e1":Ljava/io/FileNotFoundException;
    :catch_6
    move-exception v17
    ...
    .line 629
    .local v19, "hsPkgNames":Ljava/util/HashSet;
    new-instance v31, Ljava/util/ArrayList;

    .end local v31    # "pkg_names":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    move-object/from16 v0, v31
    ...
    .line 631
    .restart local v31    # "pkg_names":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    invoke-virtual/range {v31 .. v31}, Ljava/util/ArrayList;->size()I
    ...
    .end local v19    # "hsPkgNames":Ljava/util/HashSet;
    .end local v20    # "i":I

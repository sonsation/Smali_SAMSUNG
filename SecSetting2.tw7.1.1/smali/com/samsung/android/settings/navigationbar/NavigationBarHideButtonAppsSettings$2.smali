...
.method public run()V
    ...
    .line 262
    .local v12, "lais":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/LauncherActivityInfo;>;"
    const-string/jumbo v15, "ShowHideButtonAppsSettings"
    ...
    .local v11, "lai$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    .line 264
    .local v10, "lai":Landroid/content/pm/LauncherActivityInfo;
    const-string/jumbo v15, "ShowHideButtonAppsSettings"
    ...
    .end local v10    # "lai":Landroid/content/pm/LauncherActivityInfo;
    .end local v11    # "lai$iterator":Ljava/util/Iterator;
    .end local v12    # "lais":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/LauncherActivityInfo;>;"
    ...
    .restart local v11    # "lai$iterator":Ljava/util/Iterator;
    .restart local v12    # "lais":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/LauncherActivityInfo;>;"
    ...
    .line 280
    .local v14, "row":Lcom/samsung/android/settings/navigationbar/NavigationBarHideButtonAppsSettings$AppRow;
    move-object/from16 v0, p0
    ...
    .end local v14    # "row":Lcom/samsung/android/settings/navigationbar/NavigationBarHideButtonAppsSettings$AppRow;
    :cond_4
    const-string/jumbo v15, "ShowHideButtonAppsSettings"

...
.method public endElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "(reset) xml:base"
    ...
    const-string v1, "Invalid catalog entry (rbase)"
    ...
    :cond_4
    const-string v0, "urn:oasis:names:tc:entity:xmlns:tr9401:catalog"
    ...
    const-string v1, "Invalid catalog entry type"
    ...
    const-string v4, "(reset) override"
    ...
    const-string v1, "Invalid catalog entry (roverride)"
...
.method public startElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xml/sax/Attributes;)V
    ...
    :goto_4
    const-string v2, "delegatePublic"
    ...
    const-string v2, "delegateSystem"
    ...
    const-string v1, "Invalid catalog entry (base)"
    ...
    const-string v2, "Invalid prefer: must be \'system\' or \'public\'"
    ...
    const-string v1, "Invalid catalog entry (override)"
    ...
    :cond_d
    const-string v2, "publicIdStartString"
    ...
    const-string v4, "delegatePublic"

    const-string v5, "publicIdStartString"
    ...
    :cond_f
    const-string v2, "systemIdStartString"
    ...
    const-string v4, "delegateSystem"

    const-string v5, "systemIdStartString"
    ...
    :cond_11
    const-string v2, "uriStartString"
    ...
    const-string v4, "delegateURI"

    const-string v5, "uriStartString"
    ...
    :cond_15
    const-string v2, "systemIdSuffix"
    ...
    const-string v5, "systemIdSuffix"
    ...
    const-string v4, "Invalid catalog entry type"
    ...
    :cond_28
    const-string v2, "urn:oasis:names:tc:entity:xmlns:tr9401:catalog"
    ...
    const-string v3, "Invalid catalog entry type"
    ...
    const-string v1, "Invalid catalog entry"

...
.method private findDTValidator(Lmf/org/w3c/dom/Element;Ljava/lang/String;Lmf/org/apache/xerces/xni/QName;SLmf/org/apache/xerces/impl/xs/traversers/XSDocumentInfo;)Lmf/org/apache/xerces/impl/dv/XSSimpleType;
    ...
    :cond_8
    const-string v0, "cos-st-restricts.2.3.1.1"
    ...
    :cond_9
    const-string v0, "cos-st-restricts.3.3.1.1"
...
.method private getSimpleType(Ljava/lang/String;Lmf/org/w3c/dom/Element;[Ljava/lang/Object;Lmf/org/apache/xerces/impl/xs/traversers/XSDocumentInfo;Lmf/org/apache/xerces/impl/xs/SchemaGrammar;)Lmf/org/apache/xerces/impl/dv/XSSimpleType;
    ...
    const-string v6, "(annotation?, (restriction | list | union))"
    ...
    const-string v8, "(annotation?, (restriction | list | union))"
    ...
    const-string v8, "src-simple-type.2.a"
    ...
    :cond_24
    const-string v8, "src-simple-type.3.a"
    ...
    const-string v8, "src-simple-type.2.b"
    ...
    :cond_2f
    const-string v8, "src-simple-type.3.b"
    ...
    :cond_31
    const-string v8, "src-union-memberTypes-or-simpleTypes"
    ...
    const-string v3, "cos-st-restricts.2.1"
    ...
    const-string v9, "(annotation?, (simpleType?, (minExclusive | minInclusive | maxExclusive | maxInclusive | totalDigits | fractionDigits | length | minLength | maxLength | enumeration | whiteSpace | pattern)*))"

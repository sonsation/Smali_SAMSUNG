...
.method private final scanAttType(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_e
    const-string v0, "MSG_SPACE_REQUIRED_AFTER_NOTATION_IN_NOTATIONTYPE"
    ...
    :cond_f
    const-string v0, "MSG_OPEN_PAREN_REQUIRED_IN_NOTATIONTYPE"
    ...
    :cond_11
    const-string v0, "MSG_NAME_REQUIRED_IN_NOTATIONTYPE"
    ...
    :cond_14
    const-string v0, "AttTypeRequiredInAttDef"
    ...
    :cond_16
    const-string v0, "MSG_NMTOKEN_REQUIRED_IN_ENUMERATION"
...
.method private final scanConditionalSect(I)V
    ...
    const-string v0, "MSG_MARKUP_NOT_RECOGNIZED_IN_DTD"
    ...
    const-string v4, "INVALID_PE_IN_CONDITIONAL"
    ...
    :cond_1a
    const-string v0, "IgnoreSectUnterminated"
...
.method private final scanEntityDecl()V
    ...
    :cond_11
    const-string v2, "SemicolonRequiredInPEReference"
    ...
    :cond_16
    const-string v1, "MSG_ENTITY_NAME_REQUIRED_IN_ENTITYDECL"
    ...
    :cond_19
    const-string v1, "MSG_SPACE_REQUIRED_AFTER_ENTITY_NAME_IN_ENTITYDECL"
    ...
    const-string v1, "MSG_NOTATION_NAME_REQUIRED_FOR_UNPARSED_ENTITYDECL"
    ...
    :cond_1f
    const-string v1, "MSG_SPACE_REQUIRED_BEFORE_NDATA_IN_UNPARSED_ENTITYDECL"
    ...
    :cond_21
    const-string v1, "MSG_SPACE_REQUIRED_BEFORE_NOTATION_NAME_IN_UNPARSED_ENTITYDECL"
    ...
    :cond_24
    const-string v1, "EntityDeclUnterminated"
...
.method private final scanMixed(Ljava/lang/String;)V
    ...
    :cond_4
    const-string v0, "MSG_ELEMENT_TYPE_REQUIRED_IN_MIXED_CONTENT"
...
.method private final scanNotationDecl()V
    ...
    :cond_2
    const-string v0, "MSG_SPACE_REQUIRED_BEFORE_NOTATION_NAME_IN_NOTATIONDECL"
    ...
    :cond_4
    const-string v0, "MSG_NOTATION_NAME_REQUIRED_IN_NOTATIONDECL"
    ...
    :cond_7
    const-string v0, "MSG_SPACE_REQUIRED_AFTER_NOTATION_NAME_IN_NOTATIONDECL"
    ...
    const-string v0, "ExternalIDorPublicIDRequired"
...
.method public endEntity(Ljava/lang/String;Lmf/org/apache/xerces/xni/Augmentations;)V
    ...
    const-string v3, "ImproperDeclarationNesting"
    ...
    :cond_9
    const-string v0, "IncludeSectUnterminated"
...
.method protected final scanElementDecl()V
    ...
    :cond_2
    const-string v0, "MSG_SPACE_REQUIRED_BEFORE_ELEMENT_TYPE_IN_ELEMENTDECL"
    ...
    :cond_3
    const-string v0, "MSG_ELEMENT_TYPE_REQUIRED_IN_ELEMENTDECL"
    ...
    :cond_5
    const-string v0, "MSG_SPACE_REQUIRED_BEFORE_CONTENTSPEC_IN_ELEMENTDECL"
...
.method protected final scanEntityValue(Lmf/org/apache/xerces/xni/XMLString;Lmf/org/apache/xerces/xni/XMLString;)V
    ...
    const-string v0, "OpenQuoteMissingInDecl"
    ...
    :cond_d
    const-string v1, "PEReferenceWithinMarkup"
    ...
    :cond_f
    const-string v1, "InvalidCharInLiteral"
    ...
    :cond_11
    const-string v0, "CloseQuoteMissingInDecl"

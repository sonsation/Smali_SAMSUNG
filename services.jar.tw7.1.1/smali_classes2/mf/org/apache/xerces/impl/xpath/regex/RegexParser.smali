...
.method decodeEscaped()I
    ...
    :cond_2
    const-string v0, "parser.descape.1"
    ...
    :cond_6
    const-string v0, "parser.descape.2"
    ...
    const-string v0, "parser.descape.4"
    ...
    :cond_8
    const-string v0, "parser.descape.3"
    ...
    const-string v0, "parser.descappe.4"
    ...
    :sswitch_8
    const-string v0, "parser.descape.5"
...
.method declared-synchronized parse(Ljava/lang/String;I)Lmf/org/apache/xerces/impl/xpath/regex/Token;
    ...
    :cond_1
    :try_start_2
    const-string v0, "parser.parse.1"
...
.method parseFactor()Lmf/org/apache/xerces/impl/xpath/regex/Token;
    ...
    :cond_6
    const-string v0, "parser.quantifier.5"
...
.method processBackreference()Lmf/org/apache/xerces/impl/xpath/regex/Token;
    ...
    :cond_1
    const-string v0, "parser.parse.2"
...
.method processCondition()Lmf/org/apache/xerces/impl/xpath/regex/Token;
    ...
    :cond_1
    const-string v0, "parser.factor.4"
    ...
    :cond_8
    const-string v0, "parser.factor.1"

...
.method protected scanAttributeValue(Lmf/org/apache/xerces/xni/XMLString;Lmf/org/apache/xerces/xni/XMLString;Ljava/lang/String;ZLjava/lang/String;)Z
    ...
    :cond_17
    const-string v1, "ReferenceToExternalEntity"
    ...
    :cond_1a
    const-string v1, "LessthanInAttValue"
    ...
    const-string v1, "InvalidCharInAttValue"
...
.method protected scanCharReferenceValue(Lmf/org/apache/xerces/util/XMLStringBuffer;Lmf/org/apache/xerces/util/XMLStringBuffer;)I
    ...
    const-string v5, "InvalidCharRef"
...
.method protected scanExternalID([Ljava/lang/String;Z)V
    ...
    const-string v0, "SpaceRequiredAfterSYSTEM"
    ...
    :cond_a
    const-string v0, "QuoteRequiredInSystemID"
...
.method protected scanPIData(Ljava/lang/String;Lmf/org/apache/xerces/xni/XMLString;)V
    ...
    :cond_4
    const-string v0, "SpaceRequiredInPI"
    ...
    :goto_2
    const-string v1, "ColonNotLegalWithNS"
...
.method public scanPseudoAttribute(ZLmf/org/apache/xerces/xni/XMLString;)Ljava/lang/String;
    ...
    :cond_1
    const-string v0, "PseudoAttrNameExpected"
    ...
    const-string v0, "EqRequiredInXMLDecl"
    ...
    :cond_3
    const-string v0, "EqRequiredInTextDecl"
    ...
    const-string v0, "QuoteRequiredInXMLDecl"
    ...
    :cond_5
    const-string v0, "QuoteRequiredInTextDecl"
    ...
    const-string v0, "CloseQuoteMissingInXMLDecl"
    ...
    :cond_f
    const-string v0, "CloseQuoteMissingInTextDecl"
...
.method protected scanPubidLiteral(Lmf/org/apache/xerces/xni/XMLString;)Z
    ...
    const-string v0, "QuoteRequiredInPublicID"
    ...
    const-string v0, "InvalidCharInPublicID"
    ...
    :cond_8
    const-string v0, "PublicIDUnterminated"
...
.method protected scanSurrogates(Lmf/org/apache/xerces/util/XMLStringBuffer;)Z
    ...
    :cond_0
    const-string v1, "InvalidCharInContent"
    ...
    :cond_1
    const-string v0, "InvalidCharInContent"
...
.method protected scanXMLDeclOrTextDecl(Z[Ljava/lang/String;)V
    ...
    const-string v4, "NoMorePseudoAttributes"
    ...
    const-string v4, "VersionInfoRequired"
    ...
    const-string v0, "SpaceRequiredBeforeVersionInXMLDecl"
    ...
    :cond_3
    const-string v0, "SpaceRequiredBeforeVersionInTextDecl"
    ...
    :cond_5
    const-string v0, "VersionInfoRequired"
    ...
    const-string v0, "SpaceRequiredBeforeEncodingInXMLDecl"
    ...
    :cond_7
    const-string v0, "SpaceRequiredBeforeEncodingInTextDecl"
    ...
    :cond_9
    const-string v4, "EncodingDeclRequired"
    ...
    :cond_10
    const-string v0, "SpaceRequiredBeforeStandalone"
    ...
    const-string v0, "MorePseudoAttributes"
    ...
    const-string v0, "EncodingDeclRequired"
    ...
    :cond_1a
    const-string v0, "XMLDeclUnterminated"

...
.method protected getDate(Ljava/lang/String;IILmf/org/apache/xerces/impl/dv/xs/AbstractDateTimeDV$DateTimeData;)I
    ...
    const-string v1, "CCYY-MM must be followed by \'-\' sign"
...
.method protected getYearMonth(Ljava/lang/String;IILmf/org/apache/xerces/impl/dv/xs/AbstractDateTimeDV$DateTimeData;)I
    ...
    const-string v1, "Year separator is missing or misplaced"
    ...
    const-string v1, "Year must have \'CCYY\' format"
    ...
    const-string v1, "Leading zeros are required if the year value would otherwise have fewer than four digits; otherwise they are forbidden"
    ...
    const-string v1, "CCYY must be followed by \'-\' sign"

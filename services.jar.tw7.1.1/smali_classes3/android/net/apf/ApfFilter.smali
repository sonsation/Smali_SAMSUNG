...
.method private beginProgramLocked()Landroid/net/apf/ApfGenerator;
    ...
    const-string v2, "skipArpFilters"
    ...
    const-string v3, "skipIPv4Filters"
...
.method private generateArpFilterLocked(Landroid/net/apf/ApfGenerator;)V
    ...
    const-string v2, "checkTargetIPv4"
...
.method private generateIPv4FilterLocked(Landroid/net/apf/ApfGenerator;)V
    ...
    const-string v1, "skip_dhcp_v4_filter"
    ...
    const-string v3, "skip_dhcp_v4_filter"
    ...
    const-string v2, "skip_dhcp_v4_filter"
    ...
    const-string v4, "skip_dhcp_v4_filter"
...
.method private generateIPv6FilterLocked(Landroid/net/apf/ApfGenerator;)V
    ...
    const-string v0, "skipIPv6MulticastFilter"
    ...
    :goto_0
    const-string v1, "skipUnsolicitedMulticastNA"
...
.method public static maybeCreate(Landroid/net/apf/ApfCapabilities;Ljava/net/NetworkInterface;Landroid/net/ip/IpManager$Callback;Z)Landroid/net/apf/ApfFilter;
    ...
    const-string v2, "Unacceptably small APF limit: "
    ...
    const-string v2, "Unsupported APF version: "
...
.method private declared-synchronized processRa([BI)Landroid/net/apf/ApfFilter$ProcessRaResult;
    ...
    :try_start_5
    const-string v3, "ApfFilter"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "Error parsing RA: "
...
.method public declared-synchronized dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v3, "No program installed."
    ...
    const-string v4, "Program updates: "
    ...
    const-string v3, "Last program length %d, installed %ds ago, lifetime %ds"
    ...
    const-string v3, "Seen: %d, last %ds ago"
...
.method installNewProgramLocked()V
    ...
    const-string v4, "Program failed to generate: "
...
.method maybeStartFilter()V
    ...
    const-string v4, "Error starting filter"

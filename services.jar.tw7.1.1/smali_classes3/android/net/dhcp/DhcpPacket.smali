...
.method static decodeFullPacket(Ljava/nio/ByteBuffer;I)Landroid/net/dhcp/DhcpPacket;
    ...
    const-string v12, "L2 packet too short, %d < %d"
    ...
    const-string v12, "Unexpected L2 type 0x%04x, expected 0x%04x"
    ...
    const-string v12, "L3 packet too short, %d < %d"
    ...
    const-string v12, "Invalid IP version %d"
    ...
    const-string v12, "Protocol not UDP: %d"
    ...
    const-string v12, "Invalid type or BOOTP packet too short, %d < %d"
    ...
    const-string v12, "Unexpected UDP ports %d->%d"
    ...
    const-string v12, "not a DHCP message"
    ...
    const-string v12, "Invalid IPv4 address: %s"
    ...
    const-string v12, "Bad magic cookie 0x%08x, should be 0x%08x"
    ...
    const-string v12, "BufferUnderflowException"
    ...
    const-string v12, "Unimplemented DHCP type %d"
    ...
    const-string v12, "No DHCP message type option"

...
.method private checkCCModeOnDevice()I
    ...
    const-string v2, "check the current status #1 ..."
...
.method private checkDevicePolicy()I
    ...
    const-string v11, "SEC_FLOATING_FEATURE_ACCESSIBILITY_SUPPORT_DIRECTION_LOCK"
    ...
    const-string v10, "DIRECTION LOCK ON"
    ...
    const-string v11, "Failed. maximumFailedPasswordsForWipe = "
    ...
    const-string v10, "Failed. the screen is not locked by password"
    ...
    const-string v11, "Failed. Recovery password policy has been set. isPasswordRecoverable = "
    ...
    const-string v10, "Failed. PasswordHistoryLength has been set."
    ...
    const-string v11, "Failed. RevocationCheckPolicy has not been set yet. isRevocationCheckEnabled = "
    ...
    const-string v10, "ODE check SUCCESS"
    ...
    const-string v10, "Face Lock check FAILED"
    ...
    :cond_3
    const-string v10, "DIRECTION LOCK OFF"
    ...
    :cond_4
    const-string v10, "MaxPassword check SUCCESS"
    ...
    :cond_5
    const-string v10, "ScreenLock check SUCCESS"
    ...
    :cond_6
    const-string v10, "RecoveryPassword check SUCCESS"
    ...
    :cond_7
    const-string v10, "PasswordHistoryLength check SUCCESS"
    ...
    :cond_8
    const-string v10, "RevocationCheckPolicy check SUCCESS"
    ...
    const-string v11, "Failed. ODE check = "
    ...
    :pswitch_0
    const-string v10, "ENCRYPTED BOTH"
    ...
    :pswitch_1
    const-string v10, "ENCRYPTED INTERNAL"
    ...
    :cond_f
    const-string v10, "Face Lock check SUCCESS"
...
.method private checkICD()I
    ...
    const-string v1, "Failed to get icd tamper"
    ...
    const-string v1, "Failed. icd tamper is set"
...
.method private enforceSB(Z)I
    ...
    const-string v3, "Failed. setSBFlagOn() res = "
    ...
    const-string v3, "Failed. SBFlag has yet to set. current flag = "
    ...
    const-string v3, "Failed. setSBFlagOff() res = "
...
.method private isRevocationCheckEnabled()I
    ...
    :cond_1
    const-string v0, "certPolicy is null"
...
.method private performCCModePreProcess()I
    ...
    const-string v2, "Integrity verification failed. checkICD = "
    ...
    :cond_0
    const-string v1, "Integrity verification succeeded"
    ...
    const-string v2, "Getting fips status failed. res = "
    ...
    const-string v2, "Failed. Boringssl self test = "
    ...
    const-string v2, "Boringssl self-test failed. res = "
    ...
    :cond_2
    const-string v1, "Boringssl self-test success"
...
.method private setCCMode(I)I
    ...
    const-string v6, "SystemProperties Exception Occurs"
    ...
    const-string v6, "SystemProperties RuntimeException Occurs"
...
.method private setCCModeFlag(I)I
    ...
    const-string v4, "Failed. CCMode Flag has yet to set. current flag = "
...
.method private setFlags(ZI)I
    ...
    const-string v2, "Failed. enforceSB : "
    ...
    const-string v2, "Failed. setCCModeFlag : "
...
.method private setNotification(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "SecurityManager : Notice for applying security policy"
    ...
    const-string v8, "com.samsung.android.service.SecurityManager.UPDATE"
...
.method public enableMDFPPMode(Z)I
    ...
    const-string v2, "Failed. CCMode is already enabled."
    ...
    const-string v2, "Failed. CCMode is already ready."
...
.method public sendSurveyLog(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    const-string v3, "com.samsung.android.service.SecurityManager"
    ...
    :cond_2
    const-string v2, "Survey mode is not supported."
...
.method public verifyVPN()I
    ...
    const-string v2, "Failed. verifyVPN = "
    ...
    const-string v2, "VPN verification failed. verifyVPN = "
...
.method public verifyWPA()I
    ...
    const-string v2, "Failed. verifyWPA = "
    ...
    const-string v2, "WPA verification failed. verifyWPA = "

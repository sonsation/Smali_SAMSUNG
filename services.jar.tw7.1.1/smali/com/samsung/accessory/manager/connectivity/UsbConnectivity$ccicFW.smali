...
.method private declared-synchronized writeFile(I)V
    ...
    const-string v2, "SAccessoryManager - CCIC Write: try to printIn.  operate = "
    ...
    const-string v1, "/sys/class/sec/ccic/samsung_uvdm"
    ...
    const-string v1, "SAccessoryManager - CCIC Write: finally.."
    ...
    const-string v1, "An authentication state updated.. no need to retry...close stream.."
    ...
    const-string v2, "SAccessoryManager - CCIC Write: IOException. error =  "
    ...
    const-string v2, "SAccessoryManager - CCIC Write: FileNotFoundException. error =  "
    ...
    const-string v2, "SAccessoryManager - CCIC Write: finally.."
    ...
    const-string v2, "An authentication state updated.. no need to retry...close stream.."
...
.method public onFinishedTask(Z)V
    ...
    const-string v2, "SAccessoryManager - RetryTimerTask.. onFinishedTask.. Timer - cancel, stream - close"

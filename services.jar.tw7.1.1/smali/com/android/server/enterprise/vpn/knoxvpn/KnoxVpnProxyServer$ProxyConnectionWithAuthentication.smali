...
.method public run()V
    ...
    const-string v6, "Invalid threadid cannot obtain state cache."
    ...
    const-string v6, "In ProxyConnectionWithAuthentication: mAuthenticator = null. Aborting this thread."
    ...
    const-string v7, "HTTP/1.1 500 Internal Server Error\r\n"
    ...
    const-string v8, ": Re-authentication failed in ProxyConnectionWithAuthentication for threadID:"
    ...
    const-string v8, ". Restarting UI activity"
    ...
    const-string v6, "In ProxyConnectionWithAuthentication Resetting connection to server."
    ...
    const-string v6, "In ProxyConnectionWithAuthentication: Exception occured during verification. Ending this thread."
    ...
    const-string v8, "Verification success. Authorized? = "
    ...
    const-string v6, "Source socket has already been closed. Nothing to do."
    ...
    const-string v6, "Destination socket has already been closed. Nothing to do."
    ...
    const-string v7, "In ProxyConnectionWithAuthentication:run. Sockets all OK."
    ...
    const-string v7, "In ProxyConnectionWithAuthentication:run. Removing thread"

...
.method private parseResponse(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v6, "The PAC URL has not been downloaded yet, no proxy is applied"
...
.method private proxyFromHostPort(Ljava/net/Proxy$Type;Ljava/lang/String;)Ljava/net/Proxy;
    ...
    const-string v9, "Unable to parse proxy "
    ...
    const-string v9, "Unable to parse updated proxy "
...
.method public run()V
    ...
    const-string v6, "Starting request thread: "
    ...
    const-string v6, "Starting request thread for the request line "
    ...
    const-string v6, "The url is going to be proxied through  "
    ...
    const-string v6, ": isAuthenticationRequired being sent with = "
    ...
    const-string v6, ": isAuthenticationRequired = "
    ...
    const-string v34, "AUTHENTICATION_DETECTION_FAILED"
    ...
    const-string v6, ": isAuthenticationRequired Into in AUTHENTICATION_IN_PROGRESS_FROM_STATE cache =  "
    ...
    const-string v6, ": isAuthenticationRequired Into in AUTHENTICATION_IN_PROGRESS_FROM_RESPONSE cache =  "
    ...
    const-string v6, ": isAuthenticationRequired Adding for =  "
    ...
    const-string v5, "Authentication NOT Required."
    ...
    const-string v6, "Exception occured while applying the proxy type for the url for the profile "
    ...
    const-string v6, "Exception occured while running the ProxyConnection for the profile "

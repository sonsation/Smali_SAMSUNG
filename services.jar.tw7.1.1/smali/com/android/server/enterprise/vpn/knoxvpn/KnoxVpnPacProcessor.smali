...
.method private checkIfRetryNeeded(Ljava/lang/String;)V
    ...
    const-string v5, "Downloading the pac url failed, going to retry for the "
    ...
    const-string v5, "Downloading the pac url failed even after the final retry attempt "
    ...
    const-string v5, "Exception occured while retry attempt to download pac file "
    ...
    const-string v5, "Downloading the pac url failed for the first time, start the retry process "
...
.method private downloadPacUrl(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v5, "ConnectException occured while trying to download the pac url"
    ...
    const-string v4, "Connection: close\r"
    ...
    const-string v6, "The pac line printed is "
    ...
    const-string v5, "The pac file has been downloaded successfully,cancelling further retry attempts"
    ...
    const-string v6, "The Misc value for the pac file has been set successfully "
    ...
    const-string v5, "Exception occured due to the pac service not intialized"
    ...
    const-string v5, "SocketException occured while trying to download the pac url"
    ...
    const-string v5, "Exception occured while trying to pac url "
    ...
    const-string v5, "cannot find the dns server to resolve the pac url"
    ...
    const-string v5, "GaiException occured while trying to download the pac url "
    ...
    const-string v5, "Got Interruption while trying to resolve the domain name "
    ...
    const-string v5, "IOException occured while trying to download the pac url "
    ...
    const-string v5, "Downloading the pac url failed due to Interruption, close the existing connections"
...
.method private extractUrlParameters(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "The current status of the download thread of the profile "
...
.method private getPacUrlDownloadStatus(Ljava/lang/String;)Z
    ...
    const-string v5, "check to see if the pac url has been downloaded successfully "
    ...
    const-string v4, " error occured while trying to get download status pac file"
...
.method private getValidEndPointAddress(ILjava/lang/String;ILjava/lang/String;I)Ljava/net/Socket;
    ...
    const-string v18, "KnoxVpnPacProcessor"

    const-string v19, "The pac file is going to be downloaded from an interface having ipv4 address"
    ...
    const-string v20, "The resolved host address is a ipv4 address "
    ...
    const-string v16, "KnoxVpnPacProcessor"

    const-string v17, "The pac url being entered is not of numeric form and need to do a dns look up"
    ...
    const-string v17, "GaiException occured while trying to query the ip address for the pac url domain name"
    ...
    const-string v19, "The pac file is going to be downloaded from an interface having ipv6 address"
    ...
    const-string v20, "The resolved host address is a ipv6 address "
    ...
    const-string v20, "IO Exception occured while trying to connect to the pac url remote address "
...
.method protected makeProxyRequest(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v7, " is going to go through the proxy "
    ...
    const-string v7, "Invalid host was passed for pac resolution "
...
.method protected setCurrentProxyScript(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "The pac service has not been intialized while trying to set the proxy script, trying to bind again"
    ...
    const-string v4, "Try to download the pac url for the profile after the interface is up for the profile "
    ...
    const-string v3, " error occured while trying to get current status pac file"
...
.method protected startPacSupport(Ljava/lang/String;)V
    ...
    const-string v5, " error occured while trying to start the pac script for the profile "
...
.method protected stopPacSupport(Ljava/lang/String;)V
    ...
    const-string v5, "check to see if the pac support is removed for the profile "
    ...
    const-string v5, " error occured while trying to remove the pac script for the profile "

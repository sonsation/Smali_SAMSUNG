...
.method public addVpnProfileToDatabase(Lcom/samsung/android/knox/net/vpn/KnoxVpnContext;Ljava/lang/String;)Z
    ...
    const-string v28, "FW-KnoxVpnHelper"
    ...
    const-string v28, "KNOX_VPN_PARAMETERS"
    ...
    const-string v29, "Inside addVpnProfileToDatabase <-->"
    ...
    const-string v29, "Inside knox specific AttrObj != null <-->"

    invoke-static/range {v28 .. v29}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_1
    const-string v28, "chaining_enabled"
    ...
    const-string v30, "Value for chainingEnabled <-->"
    ...
    const-string v30, "Value for proxyServer <-->"
    ...
    const-string v30, "Value for proxyPort <-->"
    ...
    const-string v30, "Value for pacurl <-->"
    ...
    const-string v30, "Admin has enabled id tracking feature "
    ...
    :goto_0
    :try_start_1
    const-string v28, "connectionType"
    ...
    const-string v30, "connection type value = "
    ...
    const-string v30, "Value for vpnConnectionType <-->"
    ...
    const-string v30, "add profile in database : status is "
...
.method public addVpnProfileToMap(Lcom/samsung/android/knox/net/vpn/KnoxVpnContext;Ljava/lang/String;)Z
    ...
    const-string v26, "FW-KnoxVpnHelper"

    new-instance v27, Ljava/lang/StringBuilder;

    invoke-direct/range {v27 .. v27}, Ljava/lang/StringBuilder;-><init>()V

    const-string v28, "Value for chainingEnabled <-->"
    ...
    const-string v28, "Value for proxyServer <-->"
    ...
    const-string v28, "Value for proxyPort <-->"
    ...
    const-string v28, "connection type value = "
    ...
    const-string v28, "Admin has enabled id tracking feature in addVpnProfileToMap"
...
.method public chainingForAddAll(Ljava/lang/String;I)Z
    ...
    const-string v9, "chainingForAddAll: profile hashmap value is "
...
.method public checkSystemVpn(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v7, "checkSystemVpn : profileName =  "
    ...
    const-string v7, "checkSystemVpn : vpnType =  "
    ...
    const-string v7, "Exception checkSystemVpn : "
...
.method protected getActiveLinkProperty()Landroid/net/LinkProperties;
    ...
    const-string v6, "The active interface name from the link property is  "
...
.method protected getActiveNetworkInterface()Ljava/lang/String;
    ...
    const-string v6, "The active interface name is "
...
.method protected sendPacConfigBroadcast(Ljava/util/HashMap;ILjava/lang/String;I)V
    ...
    const-string v11, "FW-KnoxVpnHelper"
    ...
    :goto_1
    const-string v11, "android.intent.extra.PROXY_INFO"
    ...
    const-string v13, "Exception occured while sending proxy broadcast to knox vpn apps "

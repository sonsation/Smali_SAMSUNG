...
.method private abortAllWaitingThreads()V
    ...
    const-string v7, "Aborting all threads."
    ...
    const-string v9, "Removing from cache "
    ...
    const-string v8, "In abortAllWaitingThreads: resetting state to "
...
.method private getAuthenticator(Ljava/lang/String;I[Ljava/lang/String;)Lcom/android/server/enterprise/vpn/knoxvpn/proxyauth/ProxyAuthenticator;
    ...
    const-string v3, "In getAuthenticator: Resetting connection to server."
...
.method private getRequiredAuthenticationType(Ljava/net/Socket;[Ljava/lang/String;)Lcom/android/server/enterprise/vpn/knoxvpn/proxyauth/ProxyAuthenticator;
    ...
    const-string v7, "In getRequiredAuthenticationType"
    ...
    const-string v8, "Sending line to determine auth type: "
    ...
    const-string v7, "Returning authType Basic"
    ...
    const-string v7, "Returning authType NTLM"
    ...
    const-string v7, "Returning authType None!!"
...
.method private getServerConnectedSocket(Ljava/lang/String;I)Ljava/net/Socket;
    ...
    const-string v19, "KnoxVpnProxyServer"

    const-string v20, "The proxy url has been resolved to having ipv4 address"
    ...
    const-string v21, "The resolved host address is a ipv4 address "
    ...
    const-string v17, "KnoxVpnProxyServer"

    const-string v18, "The proxy server being entered is not of numeric form and need to do a dns look up"
    ...
    const-string v18, "GaiException occured while trying to query the ip address for the proxy server domain name"
    ...
    const-string v20, "The proxy url has been resolved to having ipv6 address"
    ...
    const-string v21, "The resolved host address is a ipv6 address "
    ...
    const-string v21, "IO Exception occured while trying to connect to the proxy server remote address "
...
.method private isAuthenticationRequired(Ljava/lang/String;I[Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnProxyServer$AuthenticationRequestReturnStatus;
    ...
    const-string v4, "CREDENTIAL_PRESENT_NOT_AUTHORIZED set. Resetting to AUTHORIZED"
...
.method public onCredentialReceive(Landroid/content/Intent;Lcom/samsung/android/knox/net/vpn/ICredentialStatusCallback;)V
    ...
    const-string v2, "In onCredentialReceive"
...
.method public run()V
    ...
    const-string v6, "Error occured while accepting the packets from the local proxy port for the profile "
    ...
    const-string v6, "Exception occured while trying to fetch the list of uid added to the profile during starting the local server"
    ...
    const-string v5, "Exception occured while trying to close the socket"
...
.method protected updatePermissionForAppsToaccessLocalHost(ILjava/util/HashMap;)V
    ...
    const-string v11, "Exception occurred while trying to apply rules to access local host for the vpn profile "

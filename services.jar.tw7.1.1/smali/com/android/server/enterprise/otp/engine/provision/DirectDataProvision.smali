...
.method private prepareDataForSecureStorage(Landroid/os/Bundle;Z)I
    ...
    const-string v11, "OTP_OATH_PROTOCOL"
    ...
    :cond_2
    const-string v11, "SECRET_ENCODING_TYPE"
    ...
    const-string v11, "SHARED_SECRET"
    ...
    const-string v11, "SECRET_ENCRYPTION_ALGO"
    ...
    const-string v11, "SECRET_ENCRYPTION_IV"
    ...
    :goto_1
    const-string v11, "SECRET_ENCRYPTION_PBE_SALT"
    ...
    :goto_2
    const-string v11, "SECRET_ENCRYPTION_PASSWORD"
    ...
    :cond_6
    const-string v11, "DirectDataProvision::prepareDataForSecureStorage shared secret is not in proper hex format"
    ...
    :cond_7
    const-string v11, "DirectDataProvision::prepareDataForSecureStorage encryption_iv is not in proper hex format"
    ...
    :cond_8
    const-string v11, "DirectDataProvision::prepareDataForSecureStorage pbe_salt is not in proper hex format"
    ...
    :cond_9
    const-string v11, "DirectDataProvision::prepareDataForSecureStorage pbe_pwd is not in proper hex format"
    ...
    const-string v12, "DirectDataProvision::IllegalArgumentException - Exception "
    ...
    const-string v12, "OTP Token creation failed"
    ...
    const-string v12, "DirectDataProvision::UnsupportedEncodingException - Exception "
...
.method public doResync(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    const-string v2, "DirectDataProvision::doResync ENTER"
    ...
    :cond_0
    const-string v2, "DirectDataProvision::doResync | Invalid tokenId"

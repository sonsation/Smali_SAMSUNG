...
.method public static isOcraSuiteValid(Ljava/lang/String;)Z
    ...
    const-string v3, "OCRACheck::isOcraSuiteValid Enter"

    invoke-static {v3}, Lcom/android/server/enterprise/otp/engine/common/Print;->i(Ljava/lang/String;)V

    if-nez p0, :cond_0

    const-string v3, "OCRACheck::isOcraSuiteValid OcraSuite is NULL"
    ...
    const-string v3, "OCRACheck::splitSuite OcraSuite not valid"
...
.method public static isOtpServiceSupportPresent(Ljava/lang/String;)I
    ...
    const-string v2, "OCRACheck::isOtpServiceSupportPresent Enter"
    ...
    const-string v2, "OCRACheck::isOtpServiceSupportPresent OcraSuite has SHA512"
    ...
    const-string v2, "OCRACheck::isOtpServiceSupportPresent OcraSuite requires Pin in SHA512"
    ...
    :cond_3
    const-string v2, "OCRACheck::isOtpServiceSupportPresent OcraSuite requires Session support"

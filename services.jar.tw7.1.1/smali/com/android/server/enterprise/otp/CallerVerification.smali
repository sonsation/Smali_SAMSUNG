...
.method public static verifyAdminAccess(Landroid/content/Context;Ljava/lang/String;)I
    ...
    const-string v3, "Caller doesn\'t have permission to access OTP Provision Apis. ["
...
.method public static verifyCreateAccess(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v3, "Maximum token limit per device exceeded. Only 30 tokens per device can be provisioned"
...
.method public static verifyCryptoAccess(Landroid/content/Context;Ljava/lang/String;ZI)I
    ...
    const-string v3, "Caller is trying to access OTP TokenId that doesn\'t exist. ["
    ...
    const-string v3, "Caller doesn\'t have permission to access this OTP Token. ["
...
.method public static verifyGenerateAccess(Landroid/content/Context;Ljava/lang/String;)I
    ...
    const-string v3, "Caller is trying to generate OTP beyond fair usage limit. ["
...
.method public static verifyProvisionPermission(Landroid/content/Context;)Z
    ...
    const-string v3, "CallerVerification::verifyCallerPermission - Verification Failed [Package = "
    ...
    const-string v3, "android.permission.sec.OTP_PROVISION"
    ...
    const-string v1, "com.samsung.android.knox.permission.KNOX_OTP_PROVISION"
    ...
    const-string v0, "CallerVerification::verifyCallerPermission new Permission- Success"
    ...
    const-string v3, ", new Permission = "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string v3, "com.samsung.android.knox.permission.KNOX_OTP_PROVISION"
    ...
    const-string v1, "Permission Denial: This api call requires android.permission.sec.OTP_PROVISION or com.samsung.android.knox.permission.KNOX_OTP_PROVISION"

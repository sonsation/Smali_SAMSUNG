...
.method private setupIntentFilter()V
    ...
    const-string v0, "OTPService:: registering FactoryResetReceiver"
...
.method public generateOtpEx(Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    const-string v10, "OTPService::generateOtpEx Enter - token Id "
    ...
    const-string v9, "OTPService::generateOtpEx: Skip operation. DB Upgrade active."
...
.method public getDerivedKey(Ljava/lang/String;Landroid/os/Bundle;)[B
    ...
    :cond_0
    const-string v2, "OTPService::getDerivedKey: Invalid input."
    ...
    const-string v2, "OTPService::getDerivedKey: Skip operation. DB Upgrade active."
    ...
    const-string v3, "OTPService::getDerivedKey Enter [tokenId = "
    ...
    const-string v3, "OTPService::getDerivedKey Enter [keyParams = "
    ...
    const-string v3, "OTPService::generateOtp: Token doesnt exist for given vendor TokenId = %s"
    ...
    const-string v3, "CRYPTO_KDF_TYPE"
    ...
    const-string v3, "OTPService::getDerivedKey - caller verification failed [Error = "
...
.method public getHmac(Ljava/lang/String;I[B)[B
    ...
    :cond_0
    const-string v2, "OTPService::getHmac: Invalid input."
    ...
    const-string v2, "OTPService::getHmac: Skip operation. DB Upgrade active."
    ...
    const-string v3, "OTPService::getHmac Enter [type = "
    ...
    const-string v3, "OTPService::getHmac - caller verification failed [Error = "
...
.method public keyProvClientHello(Lcom/samsung/android/knox/otp/DSKPPKeyProvTrigger;)Lcom/samsung/android/knox/otp/DSKPPKeyProvClientHello;
    ...
    const-string v1, "OTPService::keyProvisionClientHello Enter"

    invoke-static {v1}, Lcom/android/server/enterprise/otp/engine/common/Print;->e(Ljava/lang/String;)V

    if-nez p1, :cond_0

    const-string v1, "OTPService::keyProvisionClientHello: Skip operation. DSKPP Key Provision Trigger data is null."
    ...
    const-string v1, "OTPService::keyProvisionClientHello: Skip operation. DB Upgrade active."
...
.method public notifyToAddSystemService(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    const-string v2, "OTPService:: OTP service is added: "
    ...
    const-string v2, "OTPService:: Failure add service"

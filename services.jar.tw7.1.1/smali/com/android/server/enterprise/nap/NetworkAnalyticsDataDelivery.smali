...
.method private static getHash(Ljava/io/File;)Ljava/lang/String;
    ...
    :goto_1
    :try_start_2
    const-string v14, "NetworkAnalytics:NetworkAnalyticsDataDelivery"
    ...
    const-string v15, "close FileInputStream: IOException"
    ...
    const-string v15, "NetworkAnalytics:NetworkAnalyticsDataDelivery"

    const-string v16, "close FileInputStream: IOException"
...
.method public static getPackageHash(II)Ljava/lang/String;
    ...
    const-string v7, "Unable to retrieve package name for uid:"
    ...
    const-string v6, "apkHashCodeTable.containsKey(packageName)"
    ...
    const-string v7, "Unable to retrieve app info for packageName:"
    ...
    const-string v7, "baseApk unable to find for packageName:"
    ...
    const-string v7, "Obtained hash for packageName:"
...
.method private static getPackageNameForPid(I)Ljava/lang/String;
    ...
    const-string v7, "NetworkAnalytics:NetworkAnalyticsDataDelivery"
...
.method public deliverData(Ljava/util/List;)I
    ...
    const-string v8, "NetworkAnalytics:NetworkAnalyticsDataDelivery"

    const-string v9, "deliverData: Data received NULL or empty"
    ...
    const-string v9, "deliverData: No data delivery herlper entries."
    ...
    const-string v10, "deliverData: service connection is null for entry:"
    ...
    const-string v9, "deliverData: RemoteException "
    ...
    const-string v10, "deliverData: Delivering data to client:"
    ...
    const-string v9, "deliverData: Exception "

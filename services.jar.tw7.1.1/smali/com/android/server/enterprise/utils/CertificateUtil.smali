...
.method private extractPkcs12([BLjava/lang/String;I)Z
    ...
    const-string v7, "Skipping non-key entry"
...
.method private declared-synchronized installFrom(Ljava/security/KeyStore$PrivateKeyEntry;I)Z
    ...
    const-string v13, "Certificate policy not found"
...
.method private parseCert([BI)Z
    ...
    const-string v10, "Certificate policy not found"
    ...
    const-string v10, "Failed talking to certificate policy"
...
.method public installAsUser(Ljava/lang/String;[BLjava/lang/String;Ljava/lang/String;II)Z
    ...
    const-string v13, "CertificateUtil"

    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string v15, "CaCerts put state for wifi keystore : "
    ...
    const-string v15, "CaCerts put state for vpn and apps keystore : "
    ...
    const-string v15, "CaCerts put state : "
    ...
    const-string v15, "UserCert put state for wifi keystore : "
    ...
    const-string v15, "UserCert put state for vpn and apps keystore : "
    ...
    const-string v14, "Saving private key with FLAG_NONE for WIFI"
    ...
    const-string v15, "UserPKey put state for wifi keystore : "
    ...
    const-string v15, "UserPKey put state for vpn and apps keystore : "
...
.method public sendIntentToSettings(IZ)V
    ...
    const-string v8, "com.samsung.android.knox.intent.action.REFRESH_CREDENTIALS_UI_INTERNAL"

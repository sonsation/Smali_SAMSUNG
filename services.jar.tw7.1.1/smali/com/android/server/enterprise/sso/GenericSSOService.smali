...
.method private _addWhiteListPackages(Lcom/samsung/android/knox/ContextInfo;Ljava/util/List;I)I
    ...
    const-string v20, "In _addWhiteListPackages: cxtInfo is null"
    ...
    const-string v20, "In _addWhiteListPackages: MDM uid is not matched"
    ...
    const-string v21, "In _addWhiteListPackage: UserId: "
    ...
    const-string v20, "In _addWhiteListPackage: No SSO Vendors have been enrolled."
    ...
    const-string v20, "In _addWhiteListPackage: Invalid Parameters. Package Name or Certificate is null"
    ...
    const-string v20, "In _addWhiteListPackage: the given whitelistpkg has already been registered"
    ...
    const-string v20, "In _addWhiteListPackage: NullPointerException."
    ...
    const-string v20, "In _addWhiteListPackage: Returning Fail."
    ...
    const-string v20, "In _addWhiteListPackage: the package hasn\'t been whitelisted"
    ...
    const-string v21, "In _addWhiteListPackage:  <"
    ...
    const-string v20, "In _addWhiteListPackage: Exception."
    ...
    const-string v20, "In _addWhiteListPackage: the package signature hasn\'t been specified"
    ...
    const-string v20, "In _addWhiteListPackages: removing whitelistAll flag"
    ...
    const-string v21, "In _addWhiteListPackages: return from remove whitelisting all apps = "
...
.method private _configureSSOByFile(Lcom/samsung/android/knox/ContextInfo;[BI)I
    ...
    const-string v32, "GenericSSOService"

    new-instance v33, Ljava/lang/StringBuilder;

    invoke-direct/range {v33 .. v33}, Ljava/lang/StringBuilder;-><init>()V

    const-string v34, "In _configureSSOByFile: MDM uid is not matched = "
    ...
    const-string v33, "In _configureSSOByFile: config is null or is empty"
    ...
    const-string v34, "In _configureSSOByFile: tmp sso config doc is updated in "
    ...
    const-string v34, "In _configureSSOByFile: updated sso config doc is saved at "
    ...
    const-string v32, "application_policy"
    ...
    const-string v33, "In _configureSSOByFile: Authenticator not installed"
    ...
    const-string v33, "In _configureSSOByFile: Authenticator signature is not matched"
    ...
    const-string v33, "In _configureSSOByFile: tempConfigFile failed to be saved to ssoconfig.xml"
    ...
    const-string v34, "In _configureSSOByFile: there\'s already one sso vendor enrolled for userId "
    ...
    const-string v34, ", please unenroll the existing one first"
    ...
    const-string v33, "In configureSSOByFile: failed because of pushAuthenticatorConfig()"
    ...
    const-string v33, "In configureSSOByFile: Exception"
    ...
    const-string v33, "In configureSSOByFile: IO exception in configureSSOByFile"
    ...
    const-string v33, "In _configureSSOByFile: File not found exception in configureSSOByFile"
...
.method private _enrollSSOVendor(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;IZ)I
    ...
    const-string v30, "In _enrollSSOVendor mdmUid = "
    ...
    const-string v30, "In _enrollSSOVendor userid = "
    ...
    const-string v29, "In _enrollSSOVendor: authenticator is null or empty"
    ...
    const-string v29, "In _enrollSSOVendor: there\'s already one sso vendor enrolled"
    ...
    const-string v29, "In _enrollSSOVendor: Authenticator not installed"
    ...
    const-string v29, "In _enrollSSOVendor: Authenticator signature is not matched"
    ...
    const-string v29, "In _enrollSSOVendor: MDM uid is not matched"
    ...
    const-string v30, "In _enrollSSOVendor:  <"
    ...
    const-string v30, "> parameter for - packageName "

    invoke-virtual/range {v29 .. v30}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v29

    const-string v30, " is added"
    ...
    const-string v29, "In _enrollSSOVendor: NullPointerException"
    ...
    const-string v29, "In _enrollSSOVendor: Authenticator signature is not specified"
    ...
    const-string v29, "In _enrollSSOVendor: DOMException"
    ...
    const-string v29, "In _enrollSSOVendor: failed because of pushAuthenticatorConfig()"
    ...
    const-string v29, "In _enrollSSOVendor: Exception"
...
.method private addAppTokenToSecureStorageForUser(ILjava/lang/String;Lcom/samsung/android/knox/sso/common/TokenInfo;)I
    ...
    const-string v11, "In addAppTokenToSecureStorageForUser: the token for "
    ...
    const-string v10, "In addAppTokenToSecureStorageForUser: NullPointerException"
    ...
    const-string v11, "In addAppTokenToSecureStorageForUser: error: "
...
.method private addTokenToSecureStorageForUser(ILjava/lang/String;Lcom/samsung/android/knox/sso/common/TokenInfo;)I
    ...
    const-string v13, "In addTokenToSecureStorageForUser: token to save is null"
    ...
    const-string v13, "In addTokenToSecureStorageForUser: the usercert doesn\'t exist"
    ...
    const-string v13, "In addTokenToSecureStorageForUser: the deviceCert doesn\'t exist"
    ...
    const-string v13, "devicecertificate"
    ...
    const-string v14, "In addTokenToSecureStorageForUser: the token for "
    ...
    const-string v12, "SAML_RESPONSE_USER_CERT"
    ...
    const-string v12, "OAUTH_RESPONSE_USER_CERT"
    ...
    const-string v13, "In addTokenToSecureStorageForUser: NullPointerException"
    ...
    :cond_b
    :try_start_1
    const-string v12, "SAML_RESPONSE_DEVICE_CERT"
    ...
    const-string v12, "OAUTH_RESPONSE_DEVICE_CERT"
    ...
    const-string v13, "In addTokenToSecureStorageForUser: Exception"
...
.method private addUserAndDeviceCertificatesForUser(ILcom/samsung/android/knox/sso/common/TokenInfo;)I
    ...
    const-string v11, "In addUserAndDeviceCertificates: the usercert doesn\'t exist"
    ...
    const-string v11, "In addUserAndDeviceCertificates: the deviceCert doesn\'t exist"
    ...
    const-string v11, "In addUserAndDeviceCertificates: NullPointerException"
    ...
    const-string v12, "In addUserAndDeviceCertificates: error: "
...
.method private clearConfigAndTokenForAuthenticator(I)I
    ...
    const-string v6, "In clearConfigAndTokenForAuthenticator: Fail to clear records remotely"
    ...
    const-string v6, "clearConfigAndTokenForAuthenticator: Exception"
    ...
    const-string v6, "clearConfigAndTokenForAuthenticator: SecurityException"
...
.method private clearUserCertAndAppToken(Lcom/samsung/android/knox/ContextInfo;)I
    ...
    const-string v10, "In clearUserCertAndAppToken: Processing packageName = "
    ...
    const-string v9, "In clearUserCertAndAppToken: NullPointerException"
    ...
    const-string v9, "In clearUserCertAndAppToken: Exception"
...
.method private decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v20, "In decrypt: Key alias or token to encrypt is null"
    ...
    const-string v20, "In decrypt: the retrieved key in keystore is not SecretKey"
    ...
    const-string v21, "In decrypt: Provider is "
    ...
    const-string v21, "In decrypt: Decrypted output is "
    ...
    const-string v21, "In decrypt: the length = "
    ...
    const-string v20, "In decrypt: cipher is null"
    ...
    const-string v20, "In decrypt: Exception"
    ...
    const-string v20, "In decrypt: GeneralSecurityException"
    ...
    const-string v20, "In decrypt: InvalidAlgorithmParameterException"
    ...
    const-string v20, "In decrypt: IOException"
    ...
    const-string v20, "In decrypt: UnrecoverableKeyException"
    ...
    const-string v20, "In decrypt: BadPaddingException"
    ...
    const-string v20, "In decrypt: IllegalBlockSizeException"
    ...
    const-string v20, "In encrypt: NoSuchPaddingException"
    ...
    const-string v20, "In decrypt: InvalidKeyException"
    ...
    const-string v20, "In decrypt: KeyStoreException"
    ...
    const-string v20, "In decrypt: NoSuchAlgorithmException"
...
.method private deleteAppTokenForUser(ILjava/lang/String;)I
    ...
    const-string v5, "In deleteAppTokenForUser: packageName is null or empty"
    ...
    const-string v6, "In deleteAppTokenForUser: the token for packageName "
    ...
    const-string v5, "In deleteAppTokenForUser: NullPointerException"
    ...
    const-string v5, "In deleteAppTokenForUser: Exception"
...
.method private deleteUserAndDeviceCertForUser(I)I
    ...
    const-string v6, "In deleteUserAndDeviceCertForUser: userCertNode is null"
    ...
    const-string v6, "In deleteUserAndDeviceCertForUser: deviceCertNode is null"
    ...
    const-string v6, "In deleteUserAndDeviceCertForUser: userCertNode is removed"
    ...
    const-string v6, "In deleteUserAndDeviceCertForUser: NullPointerException"
    ...
    const-string v6, "In deleteUserAndDeviceCertForUser: deviceCertNode is removed"
    ...
    const-string v6, "In deleteUserAndDeviceCertForUser: Exception"
...
.method private encrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v25, "In encrypt: Key alias or token to encrypt is null"
    ...
    const-string v25, "In encrypt: the retrieved key in keystore is not SecretKey"
    ...
    const-string v24, "AES/CBC/PKCS5Padding"
    ...
    const-string v26, "In encrypt: Provider is "
    ...
    const-string v26, "In encrypt: Encrypted output "
    ...
    const-string v26, "In encrypt: the length = "
    ...
    const-string v25, "In encrypt: Exception"
    ...
    const-string v25, "In encrypt: IOException"
    ...
    const-string v25, "In encrypt: UnrecoverableKeyException"
    ...
    const-string v25, "In encrypt: KeyStoreException"
    ...
    const-string v25, "In encrypt: ProviderException"
    ...
    const-string v25, "In encrypt: BadPaddingException"
    ...
    const-string v25, "In encrypt: IllegalBlockSizeException"
    ...
    const-string v25, "In encrypt: NoSuchPaddingException"
    ...
    const-string v25, "In encrypt: NoSuchAlgorithmException"
    ...
    const-string v25, "In encrypt: NoSuchProviderException"
    ...
    const-string v25, "In encrypt: InvalidKeyException"
    ...
    const-string v25, "In encrypt: InvalidAlgorithmParameterException"
...
.method private getAccessTokenByProtocolType(Lcom/samsung/android/knox/sso/common/TokenInfo;)Ljava/lang/String;
    ...
    const-string v3, "In getAccessTokenByProtocolType: token is not valid"
...
.method private getConfigDataForPkgName(ILjava/lang/String;)Landroid/os/Bundle;
    ...
    const-string v12, "clientpackagesignature"
    ...
    const-string v12, "In getConfigDataForPkgName: NullPointerException"
    ...
    const-string v12, "In getConfigDataForPkgName: Exception"
...
.method private getInstanceOfKeyStore(Ljava/lang/String;)Ljava/security/KeyStore;
    ...
    const-string v8, " is initialized"
    ...
    const-string v7, "In getInstanceOfKeyStore: CertificateException"
    ...
    const-string v7, "In getInstanceOfKeyStore: NoSuchAlgorithmException"
    ...
    const-string v7, "In getInstanceOfKeyStore: IOException"
    ...
    const-string v7, "In getInstanceOfKeyStore: NullPointerException"
    ...
    const-string v8, "In getInstanceOfKeyStore: KeyStore "
    ...
    const-string v8, " initializaiton failed (Android API level = "
    ...
    const-string v7, "In getInstanceOfKeyStore: KeyStoreException"
...
.method private getPackageCertForPkgname(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string v11, "In getPackageCertForPkgname: User id = "
    ...
    const-string v10, "In getPackageCertForPkgname: pkgInfo is null"
    ...
    const-string v10, "In getPackageCertForPkgname: Exception"
    ...
    const-string v10, "In getPackageCertForPkgname: NullPointerException"
...
.method private getPackageNameForPid(I)Ljava/lang/String;
    ...
    const-string v9, "In getPackageNameForPid:  pid = "
    ...
    const-string v9, " package name = android"
    ...
    const-string v8, "In getPackageNameForPid: Exception in getPackageNameForPid"
    ...
    const-string v8, "In getPackageNameForPid: null pointer exception in getPackageNameForPid"
...
.method private getRefreshTokenByProtocolType(Lcom/samsung/android/knox/sso/common/TokenInfo;)Ljava/lang/String;
    ...
    const-string v3, "In getRefreshTokenByProtocolType: token is not valid"
...
.method private getSSOServiceIntent(Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string v4, ".genericssoconnection"
    ...
    const-string v5, "In getSSOServiceIntent: action is: "
    ...
    const-string v4, "In getSSOServiceIntent: Exception"
    ...
    const-string v4, "In getSSOServiceIntent: NullPointerException"
...
.method private initRequestConfigDoc(I)V
    ...
    const-string v12, "In initRequestConfigDoc: ssoconfig.xml doesn\'t exist for userId "
    ...
    const-string v12, ", an empty config file is created"
    ...
    const-string v12, " is loaded for userId "
    ...
    const-string v11, "In initRequestConfigDoc: ssoconfig.xml does exist"
    ...
    const-string v11, "In initRequestConfigDoc: SAXException"
    ...
    const-string v11, "In initRequestConfigDoc: ParserConfigurationException"
    ...
    const-string v11, "In initRequestConfigDoc: IOException"
...
.method private initTokenConfigDoc(I)V
    ...
    const-string v12, "In initTokenConfigDoc: ssotoken.xml doesn\'t exist for userId "
    ...
    const-string v12, "In initTokenConfigDoc: "
    ...
    const-string v11, "In initTokenConfigDoc: ssotoken.xml does exist"
    ...
    const-string v11, "In initTokenConfigDoc: SAXException"
    ...
    const-string v11, "In initTokenConfigDoc: ParserConfigurationException"
    ...
    const-string v11, "In initTokenConfigDoc: IOException"
...
.method private installedServiceIsPermitted(ILandroid/os/Bundle;)Z
    ...
    const-string v5, "In installedServiceIsPermitted: service package cert is matched between configured and installed"
    ...
    const-string v5, "In installedServiceIsPermitted: Exception"
...
.method private isCallingMDMMatch(II)Z
    ...
    const-string v5, "In isCallingMDMMatch: the enrolledVendor is null, return true"
    ...
    const-string v5, "In isCallingMDMMatch: the configDoc is null, return true"
    ...
    const-string v5, "In isCallingMDMMatch: NullPointerException"
...
.method private reAuthenInAuthenticator(I)I
    ...
    const-string v16, "In reAuthenInAuthenticator: Fail to pass the service package cert check"
    ...
    const-string v16, "In reAuthenInAuthenticator: cannot get SSO Service intent"
    ...
    const-string v16, "In reAuthenInAuthenticator: sso service is not ready to use"
    ...
    const-string v16, "In reAuthenInAuthenticator: Exception"
    ...
    const-string v16, "In reAuthenInAuthenticator: RemoteException"
    ...
    const-string v16, "In reAuthenInAuthenticator: NullPointerException"
...
.method private saveConfigToFile(Lorg/w3c/dom/Document;Ljava/lang/String;)V
    ...
    const-string v14, "In getTokenConfigForUserId: IOException"
    ...
    const-string v14, "In getTokenConfigForUserId: NullPointerException"
    ...
    const-string v14, "In getTokenConfigForUserId: FileNotFoundException"
    ...
    const-string v14, "In getTokenConfigForUserId: TransformerException"
    ...
    const-string v14, "In getTokenConfigForUserId: TransformerConfigurationException"
...
.method private vendorPermissionCheck(ILjava/lang/String;)Z
    ...
    const-string v11, "In vendorPermissionCheck: exception "
    ...
    const-string v9, "com.sec.enterprise.knox.shareddevice.keyguard"
...
.method public _unenrollSSOVendor(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;I)I
    ...
    const-string v10, "In unenrollSSOVendor: MDM uid is not matched"
    ...
    const-string v10, "In unenrollSSOVendor: authenticatorPkgName is null or empty"
    ...
    const-string v10, "In unenrollSSOVendor: failed clearConfigAndTokenFor Authenticator"
    ...
    const-string v11, "In unenrollSSOVendor: this authenticator "
    ...
    const-string v11, " is not enrolled"
    ...
    const-string v10, "In unenrollSSOVendor: Exception"
    ...
    const-string v10, "In unenrollSSOVendor: NullPointerException"
...
.method public deleteWhiteListPackages(Lcom/samsung/android/knox/ContextInfo;Ljava/util/List;)I
    ...
    const-string v12, "In deleteWhiteListPackages: cxtInfo is null"
    ...
    const-string v12, "In deleteWhiteListPackages: MDM uid is not matched"
    ...
    const-string v12, "In deleteWhiteListPackages: Invalid Parameters."
    ...
    const-string v12, "In deleteWhiteListPackages: No SSO Vendors have been enrolled."
    ...
    const-string v12, "In deleteWhiteListPackages: this sso vendor is not registered"
    ...
    const-string v12, "In deleteWhiteListPackages: the package hasn\'t been whitelisted"
    ...
    const-string v12, "In deleteWhiteListPackages: NullPointerException."
    ...
    const-string v12, "In deleteWhiteListPackages: package name is found in the whitelist of the given sso ssolution service"
    ...
    const-string v12, "In deleteWhiteListPackages: package name is removed from the whitelist of the given sso ssolution service"
    ...
    const-string v12, "In deleteWhiteListPackages: Exception."
    ...
    const-string v12, "In deleteWhiteListPackages: removing whitelistall flag"
    ...
    const-string v13, "In deleteWhiteListPackages: return from remove whitelisting all apps(Remove log later) = "
...
.method public getAppTokenFromGenericSSO(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;)Lcom/samsung/android/knox/sso/common/TokenInfo;
    ...
    const-string v4, "In getAppTokenFromGenericSSO: appPkgName is null or empty string"
    ...
    const-string v4, "In getAppTokenFromGenericSSO: authenticator is not permitted to call this API"
...
.method public notifyToAddSystemService(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    const-string v3, "Generic SSO service is added: "
...
.method public onAdminRemoved(I)V
    ...
    const-string v12, "In onAdminRemoved: Admin removed"
    ...
    const-string v11, "In onAdminRemoved: Generic SSO was not used"
    ...
    const-string v11, "In onAdminRemoved: MDM uid is not matched"
    ...
    const-string v11, "In onAdminRemoved: Fail to clear records remotely"
    ...
    const-string v11, "In onAdminRemoved: Exception"
    ...
    const-string v11, "In onAdminRemoved: SecurityException"
...
.method public setCustomerBrandInfo(Lcom/samsung/android/knox/ContextInfo;Landroid/os/Bundle;)I
    ...
    const-string v16, "GenericSSOService"

    const-string v17, "In setCustomerBrandInfo: cxtInfo is null"
    ...
    const-string v17, "In setCustomizedBrandingInfo: invalid parameters"
    ...
    const-string v17, "In setCustomerBrandInfo: MDM uid is not matched"
    ...
    const-string v18, "In setCustomizedBrandingInfo: UserID = "
    ...
    const-string v17, "In setCustomizedBrandingInfo: No SSO Vendors have been enrolled."
    ...
    const-string v16, "customerbrand"
    ...
    :cond_9
    const-string v16, "customer_brand_logo"
    ...
    const-string v18, "In setCustomizedBrandingInfo:  <"
    ...
    const-string v17, "In setCustomizedBrandingInfo: NullPointerException"
    ...
    const-string v17, "In setCustomizedBrandingInfo: Exception"

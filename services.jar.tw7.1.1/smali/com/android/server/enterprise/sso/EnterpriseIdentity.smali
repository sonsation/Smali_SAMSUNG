...
.method private _setAuthenticationConfig(ILcom/samsung/android/knox/container/AuthenticationConfig;)I
    ...
    const-string v14, "authenticationprovider"
    ...
    const-string v15, "In _setAuthenticationConfig: Incorrect configuration. Both hide and enforce set to true."
    ...
    const-string v16, "In _setAuthenticationConfig Authenticator:   "
    ...
    const-string v16, "In _setAuthenticationConfig FORCE_ENTERPRISE_IDENTITY_LOCK:   "
    ...
    const-string v16, "In _setAuthenticationConfig HIDE_ENTERPRISE_IDENTITY_LOCK:   "
    ...
    const-string v16, "In _setAuthenticationConfig ENFORCE_REMOTEALWAYS:   "
    ...
    const-string v16, "In _setAuthenticationConfig IS_CONFIGURED_BY_MDM:  "
    ...
    const-string v16, "In setAuthenticationConfig:  <"
    ...
    const-string v16, "> parameter for - packageName "
    ...
    const-string v15, "In setAuthenticationConfig when node not null: Incorrect configuration. Both hide and enforce set to true."
...
.method private bindToEnterpriseIdAuthenticator(ILjava/lang/String;)Lcom/samsung/android/knox/sso/serviceprovider/GenericSSOSupportSolution;
    ...
    const-string v7, "In bindToEnterpriseIdAuthenticator: The EnterpriseIdService is already bound"
    ...
    const-string v7, ".genericssoconnection"
    ...
    const-string v8, "In bindToEnterpriseIdAuthenticator: action is: "
    ...
    const-string v8, "In bindToEnterpriseIdAuthenticator: Binding to the service..."
    ...
    const-string v8, "In bindToEnterpriseIdAuthenticator: CoutnDownLatch return false"
    ...
    const-string v8, "In bindToEnterpriseIdAuthenticator: InterruptedException"
    ...
    const-string v7, "In bindToEnterpriseIdAuthenticator: NullPointerException"
    ...
    const-string v8, "In bindToEnterpriseIdAuthenticator: Fail to bind to sso service"
    ...
    const-string v7, "In bindToEnterpriseIdAuthenticator: Exception"
...
.method private initAuthenticationConfigDoc(I)V
    ...
    const-string v12, "In initAuthenticationConfigDoc: ssoconfig.xml doesn\'t exist for userId "
    ...
    const-string v12, " is loaded with auth details for userId "
    ...
    const-string v11, "In initAuthenticationConfigDoc: SAXException"
    ...
    const-string v11, "In initAuthenticationConfigDoc: ParserConfigurationException"
    ...
    const-string v11, "In initAuthenticationConfigDoc: IOException"
...
.method private saveConfigToFile(Lorg/w3c/dom/Document;Ljava/lang/String;)V
    ...
    const-string v14, "In saveConfigToFile: config file is saved successfully"
...
.method public getAuthenticationConfig(I)Lcom/samsung/android/knox/container/AuthenticationConfig;
    ...
    const-string v16, "In getAuthenticationConfig: cannot get configDoc for userID:"
    ...
    const-string v15, "In getAuthenticationConfig: SSO_PROVIDER_PACKAGE_SIGNATURE=null in XML"
    ...
    const-string v15, "In getAuthenticationConfig: Error to look up. ENFORCE_REMOTE_AUTH_ALWAYS=null in XML"
    ...
    const-string v15, "In getAuthenticationConfig: Error to look up. FORCE_ENTERPRISE_IDENTITY_LOCK=null in XML"
    ...
    const-string v15, "In getAuthenticationConfig: Error to look up. HIDE_ENTERPRISE_ID_LOCK=null in XML"
    ...
    const-string v15, "In getAuthenticationConfig: Error to look up. isConfiguredByMDM=null in XML"
    ...
    const-string v16, "In getAuthenticationConfig: RemoteAuthAlways: "
    ...
    const-string v16, "Authenticator: "
    ...
    const-string v15, "In getAuthenticationConfig: Exception"
...
.method public performUserAuthentication(Lcom/samsung/android/knox/ContextInfo;Lcom/samsung/android/knox/container/AuthenticationConfig;)Lcom/samsung/android/knox/sso/common/TokenInfo;
    ...
    const-string v2, "In performUserAuthentication: calling _setAuthenticationConfig"
    ...
    const-string v3, "In performUserAuthentication: The authenticator is"

...
.method static constructor <clinit>()V
    ...
    const-string v1, "KeyGenParameterSpec"

    const/4 v2, 0x5

    aput-object v1, v0, v2

    const-string v1, "OkHostnameVerifier"
    ...
    const-string v1, "OpenSSLRandom"

    const/16 v2, 0x8

    aput-object v1, v0, v2

    const-string v1, "PKIXRevocationChecker"
...
.method private checkAuditPrivilegedAllowed(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v4, "Error: Invalid auditlog parameters!"
...
.method private createAdmins()V
    ...
    const-string v9, "auditLogEnabled"
    ...
    :cond_2
    const-string v9, "auditLogIptables"
...
.method private extractRulesFromCv(Landroid/content/ContentValues;)Lcom/samsung/android/knox/log/AuditLogRulesInfo;
    ...
    const-string v10, "auditLogRuleSeverity"

    invoke-virtual {p1, v10}, Landroid/content/ContentValues;->getAsInteger(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v6

    const-string v10, "auditLogRuleOutcome"

    invoke-virtual {p1, v10}, Landroid/content/ContentValues;->getAsInteger(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v3

    const-string v10, "auditLogKernelEnabled"
    ...
    const-string v10, "auditLogRuleGroups"
    ...
    :cond_0
    const-string v10, "auditLogRuleUsers"
...
.method private startStopEdmAuditProcess()V
    ...
    const-string v5, "Error on start/stop edmaudit process: "
...
.method public checkAuditLogEnforce(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v5, "Error: Invalid auditlog parameters!"
    ...
    const-string v5, " AuditLogger calls from Profile return default value"
...
.method public isIPTablesLoggingEnabled(Lcom/samsung/android/knox/ContextInfo;)Z
    ...
    const-string v2, " isIPTablesLoggingEnabled calls from Profile return default value"

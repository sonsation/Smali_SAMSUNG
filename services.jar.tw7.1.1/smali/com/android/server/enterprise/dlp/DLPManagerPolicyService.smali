...
.method private bindToDLPService(I)V
    ...
    const-string v17, "com.samsung.android.knox.intent.action.DLP_SERVICE_BIND_INTERNAL"
    ...
    const-string v20, "In bindToService: InterruptedException: "
...
.method private setConfig(Lcom/samsung/android/knox/ContextInfo;Landroid/os/Bundle;)Z
    ...
    const-string v30, "DLP : In setDLPExpiry userId : "
    ...
    const-string v28, "android.intent.extra.user_handle"
    ...
    const-string v29, "Knox version not supported for DLP Audit events."
    ...
    const-string v30, "DLP : Extensions set for user: "
    ...
    const-string v29, "Knox version not supported for extension"
    ...
    const-string v30, "DLP : Domain set for user: "
    ...
    const-string v29, "Knox version not supported for domains list"
    ...
    :cond_15
    :try_start_f
    const-string v28, "com.android.providers.media"
    ...
    const-string v30, "DLP : isActivated : "
    ...
    const-string v29, "DLP: config is null"
...
.method public addToAuditLog(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;II)V
    ...
    const-string v5, " Actual callerPackage : "
    ...
    const-string v5, " Audit logging with pkg : "
    ...
    const-string v3, "Invalid Opcode for audit logging. Returning!"
    ...
    const-string v3, " created DLP file ["
    ...
    const-string v5, "addToAuditLog exception:"
    ...
    const-string v3, "Audit logging is diabled or no config found for file create event, returning!"
    ...
    const-string v3, "Audit logging is diabled or no config found for open event, returning!"
    ...
    const-string v3, "Audit logging is diabled or no config found for file rename event, returning!"
    ...
    const-string v3, "attempt to access expired DLP file ["
    ...
    const-string v3, "Audit logging is diabled or no config found for file expired event, returning!"
    ...
    const-string v3, "] access denied to ["
    ...
    const-string v3, "Audit logging is diabled or no config found for access denied event, returning!"
    ...
    const-string v3, "DLP config doesn\'t exist for user or caller is not media provider or trusted component.. UIDs dont match !"
...
.method public isShareAllowed(Lcom/samsung/android/knox/ContextInfo;[Ljava/lang/String;Ljava/lang/String;II)Z
    ...
    const-string v24, "DLP: isShareAllowed: ctxInfo is null, returning false!"
    ...
    const-string v25, " isCallerAppDLP:"
    ...
    const-string v25, " isConsumerAppDLP:"
    ...
    const-string v25, "Exception in isShareAllowed : "
    ...
    const-string v25, "NameNotFoundException occured for package name : "
    ...
    const-string v24, "In the default case"
    ...
    const-string v24, "DLP Is not activated"
...
.method public notifyDLPOpenedFile(Lcom/samsung/android/knox/ContextInfo;ILjava/lang/String;)Z
    ...
    const-string v9, "DLP: notifyDLPOpenedFile: cxtInfo is null, returning false!"
...
.method public setExpiryDate(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;J)Z
    ...
    const-string v6, "DLP: setExpiryDate: cxtInfo is null, returning false!"

...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_0
    const-string v40, "android.hardware.usb.action.USB_STATE"
    ...
    :cond_4
    const-string v40, "android.net.conn.CONNECTIVITY_CHANGE"
    ...
    const-string v40, "Tethering"

    const-string v41, "Tethering got CONNECTIVITY_ACTION"
    ...
    :cond_5
    const-string v40, "android.net.wifi.WIFI_AP_STATE_CHANGED"
    ...
    const-string v43, "Canceling WiFi tethering request - AP_STATE="
    ...
    :cond_9
    const-string v40, "android.intent.action.CONFIGURATION_CHANGED"
    ...
    :cond_d
    const-string v40, "com.samsung.android.net.wifi.WIFI_AP_STA_STATUS_CHANGED"
    ...
    const-string v42, "[WIFI] onReceive() WIFI_AP_STA_STATUS_CHANGED_ACTION intent, type of EVENT: "
    ...
    const-string v42, "**number of client: "
    ...
    const-string v41, "Wifi Ap is not enabled."
    ...
    const-string v42, "createMaxApNotification(), clients = "
    ...
    const-string v40, "com.samsung.android.net.wifi.MAXAP_NOTI"
    ...
    :cond_1b
    const-string v40, "android.net.wifi.wifiap_power_mode_alarm"
    ...
    const-string v42, "ALARM_START : set "
    ...
    const-string v42, "WIFIAP_POWER_MODE_VALUE_CHANGED, clients = "
    ...
    const-string v41, "ALARM_START because of WIFIAP_POWER_MODE_VALUE_CHANGED"
    ...
    const-string v41, "--> data disable"

    invoke-static/range {v40 .. v41}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v40, "Tethering"

    const-string v41, "--> ap disable"
    ...
    const-string v42, "Cannot acquire wake lock ~~"
    ...
    const-string v42, "Cannot release wake lock ~~"
    ...
    :cond_23
    const-string v40, "android.net.wifi.wifiap_stand_by_mode_start"
    ...
    const-string v42, "[WIFI] onReceive() WIFIAP_STAND_BY_MODE_START intent, type of EVENT: "
    ...
    :cond_24
    const-string v40, "android.intent.action.BATTERY_CHANGED"
    ...
    const-string v42, "BATTERY_CHANGED, level = "
    ...
    const-string v40, "com.samsung.settings.wifi.PLUG_STATE_CHANGED"
    ...
    const-string v41, "clearLowBatteryNotification"
    ...
    :cond_2d
    const-string v40, "android.intent.action.BOOT_COMPLETED"
    ...
    const-string v41, "Boot complete."
    ...
    const-string v41, "Activate USB Net on boot up"
    ...
    const-string v41, "[Tethering always mode] call setUsbTethering()"
    ...
    :cond_30
    const-string v40, "android.app.action.DEVICE_POLICY_MANAGER_STATE_CHANGED"
    ...
    const-string v41, "[ActiveSync] onReceive() ACTION_DEVICE_POLICY_MANAGER_STATE_CHANGED intent"
    ...
    const-string v41, "[ActiveSync] onReceive() Internet sharing has banned due to security policy."
    ...
    const-string v43, "Tethering"

    new-instance v44, Ljava/lang/StringBuilder;

    invoke-direct/range {v44 .. v44}, Ljava/lang/StringBuilder;-><init>()V

    const-string v45, "[ActiveSync] onReceive() Untether on "
    ...
    const-string v42, "[ActiveSync] onReceive() Error listing Interfaces :"
    ...
    const-string v41, "[ActiveSync] onReceive() Internet sharing is NOT banned any more."
    ...
    :cond_34
    const-string v40, "com.samsung.android.intent.action.TETHERING_DENIED"
    ...
    const-string v41, "Tethering Denied"

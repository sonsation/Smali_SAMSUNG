...
.method private configureLocalDns(Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    const-string v7, "No netd service instance available; not setting local IPv6 addresses"
    ...
    const-string v8, "Failed to remove local dns IP: "
    ...
    const-string v8, "Failed to add local dns IP: "
    ...
    const-string v7, "Failed to update local DNS caching server"
...
.method private configureLocalRoutes(Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    const-string v6, "Failed to remove %d IPv6 routes from local table."
    ...
    const-string v6, "Failed to remove IPv6 routes from local table: "
    ...
    const-string v6, "Failed to add IPv6 routes to local table: "
...
.method public start()Z
    ...
    const-string v4, "Failed to find NetworkInterface for "
    ...
    const-string v4, "Failed to find hardware address for "

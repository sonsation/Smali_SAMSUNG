...
.method public backupAccountAccessPermissions(I)[B
    ...
    :try_start_1
    const-string v17, "SELECT name, uid FROM accounts, grants WHERE accounts_id=_id"
    ...
    const-string v21, "account-sha-256"
    ...
    :try_start_9
    const-string v17, "AccountManagerBackupHelper"

    const-string v19, "Error backing up account access grants"
...
.method public restoreAccountAccessPermissions([BI)V
    ...
    const-string v3, "AccountManagerBackupHelper"

    const-string v7, "Error restoring app permissions"

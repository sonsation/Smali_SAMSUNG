...
.method private findPreferredWebViewPackage()Landroid/content/pm/PackageInfo;
    ...
    const-string v4, "Could not find a loadable WebView package"
...
.method public changeProviderAndSetting(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v7, "Tried to change WebView provider but failed to fetch WebView package "
...
.method public waitForAndGetProvider()Landroid/webkit/WebViewProviderResponse;
    ...
    const-string v13, "creating relro file timed out"
    ...
    const-string v15, "Timed out waiting for relro creation, relros started "
    ...
    const-string v15, " relros finished "
    ...
    const-string v15, " package dirty? "

...
.method public dumpTcpStats(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v0, "addr is existed : TCP or UDP"

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v0, "addr is xxx.xxx.xxx.xxx_53 or xxxx:xxxx:xxxx:xxxx::xxxx_53 : UDP(DNS)"

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v0, "addr is _0 : UNIX DOMAIN SOCKET"

...
.method private addOrUpdatePortLocked(Ljava/lang/String;IIZIZIZLcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v4, "addOrUpdatePortLocked()--"
    ...
    const-string v4, "addOrUpdatePortLocked() mPorts DISPOSITION_REMOVED -> DISPOSITION_CHANGED"
    ...
    const-string v4, "addOrUpdatePortLocked() mPorts DISPOSITION_REMOVED -> DISPOSITION_READY"
...
.method private checkLogEnableAtKernel()V
    ...
    const-string v4, "!@UsbPortManager KERNEL_LOG_PREFIX: "
...
.method private updatePortsLocked(Lcom/android/internal/util/IndentingPrintWriter;Landroid/os/UEventObserver$UEvent;)V
    ...
    const-string v20, ") default - mDisposition : "
    ...
    const-string v20, ") DISPOSITION_ADDED -> DISPOSITION_READY"
    ...
    const-string v20, ") DISPOSITION_CHANGED -> DISPOSITION_READY"
    ...
    const-string v20, ") DISPOSITION_REMOVED size="
...
.method public addSimulatedPort(Ljava/lang/String;ILcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v2, "Port with same name already exists.  Please remove it first."
...
.method public connectSimulatedPort(Ljava/lang/String;IZIZIZLcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v3, "Cannot connect simulated port which does not exist."
    ...
    const-string v3, "Cannot connect simulated port in null mode, "
...
.method public disconnectSimulatedPort(Ljava/lang/String;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v3, "Cannot disconnect simulated port which does not exist."
...
.method public init_port_role_data()V
    ...
    const-string v6, "), mCanChangeMode("
    ...
    const-string v6, "), mCanChangePowerRole("
    ...
    const-string v6, "), mCanChangeDataRole("
...
.method public removeSimulatedPort(Ljava/lang/String;Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v3, "Cannot remove simulated port which does not exist."
...
.method public resetSimulation(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string v2, "Removing all simulated ports and ending simulation."

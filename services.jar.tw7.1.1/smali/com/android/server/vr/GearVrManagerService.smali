...
.method private dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v7, "Permission Denial: can\'t dump GearVrManagerService from pid="
    ...
    :cond_1
    const-string v6, "********* Dump of GearVrManagerService *********"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "VRAPI=16"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "VRAPI_MINOR=3"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "VRAPI_PATCH=9"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "GEAR_VR_MANAGER_SERVICE_VERSION_CODE=1"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    invoke-virtual {p2}, Ljava/io/PrintWriter;->println()V

    const-string v6, "SUPPORT_HMT=true"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "SUPPORT_DAYDREAM=true"
    ...
    const-string v7, "    mPreviousDockState:"
    ...
    const-string v7, "    mPreviousMountState:"
    ...
    const-string v7, "    mPreviousTaState:"
    ...
    const-string v7, "    mSetupWizardComplete:"
    ...
    const-string v7, "    mDeveloperMode:"
    ...
    const-string v7, "    isHomeKeyBlocked:"
    ...
    const-string v6, "Remote Callbacks:"
    ...
    const-string v6, "********* Dump of GearVrManagerExternal *********"
    ...
    :cond_e
    const-string v6, "Dump current vr state, or:"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "  set vr <true/false>"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "     set vr state directly."

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "  set state <value>"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "     set vr state value directly."

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "  set dock"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "     set vr state docked."

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "  set undock"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "     set vr state undocked."

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "  set mount"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "     set vr state mount."

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "  set unmount"

    invoke-virtual {p2, v6}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v6, "     set vr state unmount."
...
.method private enforceCallingFromVRSVC(Ljava/lang/String;)V
    ...
    const-string v8, "Permission denied signature="
    ...
    const-string v8, ", VRService only."
...
.method private isVrActivity(Landroid/content/pm/ActivityInfo;)Z
    ...
    const-string v2, "com.samsung.android.vr.activity"
...
.method private isVrServiceInstalledAndEnabled()Z
    ...
    const-string v9, "com.samsung.android.hmt.vrsvc"
    ...
    const-string v10, "com.samsung.android.hmt.vrsvc"

    const-string v11, "com.samsung.android.hmt.vrsvc.system.VRSystemService"
...
.method private writeSysNode(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v7, "FileNotFound! node="
    ...
    const-string v7, "IOException! node="
...
.method public onBootPhase(I)V
    ...
    const-string v6, "---- GearVrManagerService onBootPhase "
    ...
    const-string v4, "com.samsung.feature.hmt"
    ...
    const-string v6, "Gear VR Boot completed, UPSM Enabled"

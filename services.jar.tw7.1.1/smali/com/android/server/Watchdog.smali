...
.method static constructor <clinit>()V
    ...
    const-string v1, "/system/bin/drmserver"

    const/4 v2, 0x2

    aput-object v1, v0, v2

    const-string v1, "/system/bin/mediadrmserver"
...
.method public run()V
    ...
    const-string v55, "/data/anr/traces.txt"
    ...
    const-string v55, "Watchdog"

    const-string v56, "Failed to create /data/anr/traces.txt"
    ...
    const-string v58, " -> readlink error"
    ...
    const-string v56, "/proc/self/maps"
    ...
    const-string v55, "/data/log/fd_list.txt"
    ...
    const-string v56, "!@ The number of fd in system_server is over (RLIMIT-100), so we make fd_list file for debugging."
    ...
    const-string v56, "chown system:log /data/log/fd_list.txt"
    ...
    const-string v56, "chmod 640 /data/log/fd_list.txt"
    ...
    const-string v56, "Failed to write system_server MAPS info"
    ...
    const-string v56, "Failed to write contens in fd_list.txt"
    ...
    const-string v57, "chown system:log /data/log/fd_list.txt"
    ...
    const-string v57, "chmod 640 /data/log/fd_list.txt"
    ...
    const-string v56, "!@ The number of fd in system_server is over (RLIMIT-100), so we ran dumpstate for debugging."

    invoke-static/range {v55 .. v56}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    const-string v55, "bugreportsem"
    ...
    const-string v56, "Triggering SysRq for system_server watchdog"
    ...
    const-string v55, "/proc/sysrq-trigger"
    ...
    const-string v56, "Reporting stuck state to activity controller"

    invoke-static/range {v55 .. v56}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    :try_start_1d
    const-string v55, "Service dumps disabled due to hung system process."
    ...
    const-string v56, "Activity controller requested to coninue to wait"
    ...
    const-string v56, "Failed to write \'c\' to /proc/sysrq-trigger"
    ...
    const-string v56, "Debugger connected: Watchdog is *not* killing the system process"
    ...
    const-string v56, "Debugger was connected: Watchdog is *not* killing the system process"
    ...
    const-string v56, "Restart not allowed: Watchdog is *not* killing the system process"
    ...
    const-string v57, "!@*** WATCHDOG KILLING SYSTEM PROCESS: "
    ...
    const-string v55, "\"CAUSE\":\"!@*** WATCHDOG KILLING SYSTEM PROCESS: "
    ...
    const-string v55, "/data/log/pf_reset_reason.txt"
    ...
    const-string v57, "Failed to close /data/log/pf_reset_reason.txt"
    ...
    const-string v57, "Failed to write to /data/log/pf_reset_reason.txt"
    ...
    const-string v58, "Failed to close /data/log/pf_reset_reason.txt"

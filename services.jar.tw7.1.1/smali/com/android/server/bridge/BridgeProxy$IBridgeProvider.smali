...
.method private getComponentName(Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    const-string v7, "Cannot find service name for providerName: "
    ...
    const-string v7, " package name of provider sync service ==  "
...
.method public handleShortcut(ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "RemoteShortcuts"
    ...
    const-string v7, " before startservice intent shortcutIcon.getWidth():"
    ...
    const-string v7, " shortcutIcon.getHeight(): "
    ...
    const-string v7, "Package name is "
    ...
    const-string v5, "createOrRemove"
    ...
    const-string v7, " preinstalled Package name is "
    ...
    const-string v6, " before startservice intent"
    ...
    const-string v6, " set does not contain package"
...
.method public queryProvider(Ljava/lang/String;Ljava/lang/String;I[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/content/CustomCursor;
    ...
    const-string v16, " IBridgeProvider queryProvider() called"
    ...
    const-string v16, "No services registered to provide. (prefs empty)"
    ...
    const-string v17, "ProviderNames MATCH, we will now sync up for providerName="
    ...
    const-string v17, "Contacts: syncOnlyFavoritesContactsPolicy = "
    ...
    const-string v17, " SyncToAsyncService I am waiting now"
    ...
    const-string v18, " SyncToAsyncService  package+fullServiceName == "
    ...
    const-string v18, " Sync during switch package == "
    ...
    const-string v18, "IProviderCallBack.Stub before result: "
    ...
    const-string v18, "IProviderCallBack.Stub after result: "

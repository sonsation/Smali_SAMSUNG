...
.method private getNoOfEvents()I
    ...
    const-string v3, "ACCOUNT_NAME NOT LIKE ? AND DELETED=? "
...
.method private getNoOfTasks()I
    ...
    const-string v3, "ACCOUNTNAME NOT LIKE ? AND DELETED=?"
...
.method private getRecentlyUpdateEventsList()Ljava/util/ArrayList;
    ...
    const-string v3, "ACCOUNT_NAME NOT LIKE ? AND DELETED=? AND secTimeStamp > ? "
...
.method private getRecentlyUpdateTasksList()Ljava/util/ArrayList;
    ...
    const-string v3, "ACCOUNTNAME NOT LIKE ? AND DELETED=? AND secTimeStamp > ? "
...
.method private registerCalendarObserver()V
    ...
    const-string v2, " , No_of_events_last_synced : "
    ...
    const-string v2, " , No_of_tasks_last_synced : "
    ...
    const-string v2, " ,mLastSyncedCalendarColor : "
...
.method private registerContactObserver()V
    ...
    const-string v2, " , No_of_contact_last_synced : "
...
.method private startCalendarSync()V
    ...
    const-string v1, "Calendar onChange startCalendarSync"

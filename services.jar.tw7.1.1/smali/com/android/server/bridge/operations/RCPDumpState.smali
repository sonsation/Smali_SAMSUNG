...
.method private dumpStateEvents(Ljava/io/PrintWriter;II)V
    ...
    :try_start_0
    const-string v20, "ACCOUNT_NAME NOT LIKE ? AND DELETED=? "
    :try_end_0
    ...
    const-string v3, "calendar_personal%"
    ...
    const-string v5, "CALENDAR_EVENTS"
    ...
    const-string v3, "Source Events ID\'s : "
    ...
    :goto_0
    :try_start_2
    const-string v8, "ACCOUNT_NAME = ? AND DELETED=? "
    ...
    const-string v3, "Destination Events ID\'s : "
    ...
    const-string v12, "RCP_CALENDAR_EVENTS"

    const-string v17, "_id_original ASC"
    ...
    const-string v3, "RCP local db (SourceId:DestinationId) :  "
...
.method private dumpStateGroups(Ljava/io/PrintWriter;II)V
    ...
    const-string v8, "account_type<>? AND account_type NOT LIKE ? AND _id NOT IN (?,?,?,?)  AND deleted=?"
    ...
    const-string v5, "GROUPS_CONTACTS"
    ...
    const-string v3, "Source Group ID\'s : "
    ...
    :try_start_1
    const-string v8, "account_name= ? OR account_name = ? AND deleted=?"
    ...
    const-string v3, "Destination Group ID\'s : "
    ...
    const-string v12, "RCP_GROUPS_CONTACTS"
...
.method private dumpStateRawContacts(Ljava/io/PrintWriter;II)V
    ...
    :try_start_0
    const-string v8, "account_type<>? AND account_type NOT LIKE ? AND deleted=?"
    ...
    const-string v3, "Source Raw_Contacts ID\'s : "
    ...
    const-string v3, "Destination Raw_Contacts ID\'s : "
    ...
    const-string v3, "_id_raw_original"

    const/4 v4, 0x0

    aput-object v3, v14, v4

    const-string v3, "_id_raw_container"
    ...
    const-string v12, "RCP_RAW_CONTACTS"

    const-string v17, "_id_raw_original ASC"
...
.method private dumpStateTasks(Ljava/io/PrintWriter;II)V
    ...
    :try_start_0
    const-string v8, "ACCOUNTNAME NOT LIKE ? AND DELETED=?"
    ...
    const-string v5, "CALENDAR_TASKS"
    ...
    const-string v3, "Source Tasks ID\'s : "
    ...
    :goto_0
    :try_start_1
    const-string v8, "_sync_account = ? AND DELETED=?"
    ...
    const-string v3, "Destination Tasks ID\'s : "
    ...
    const-string v12, "RCP_CALENDAR_TASKS"
...
.method public dumpStateFileOpsTable(Ljava/io/PrintWriter;I)V
    ...
    const-string v6, "com.sec.knox.bridge.provider.knoxcontentmgrdbprovider"

...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :goto_0
    const-string v14, "WifiDisplayController"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, "Received WIFI_P2P_STATE_CHANGED_ACTION: enabled="
    ...
    :cond_2
    const-string v14, "android.net.wifi.p2p.PEERS_CHANGED"
    ...
    const-string v15, "Received WIFI_P2P_PEERS_CHANGED_ACTION."
    ...
    const-string v16, "Received WIFI_P2P_CONNECTION_CHANGED_ACTION: networkInfo="
    ...
    :cond_4
    const-string v14, "android.net.wifi.p2p.THIS_DEVICE_CHANGED"
    ...
    const-string v16, "Received WIFI_P2P_THIS_DEVICE_CHANGED_ACTION: mThisDevice= "
    ...
    const-string v16, "AP is connected! AP Frquency:"
    ...
    :cond_b
    const-string v14, "com.samsung.settings.POWERSAVING_CHANGED"
    ...
    :cond_10
    const-string v14, "com.sec.android.sidesync.action.FINISH_SIDESYNC_APP"
    ...
    :cond_11
    const-string v14, "com.samsung.wfd.RESULT_WFD_UPDATE"
    ...
    const-string v16, "SEM_ACTION_RESULT_WFD_UPDATE << result:"
    ...
    :cond_12
    const-string v14, "android.net.wifi.p2p.REQUEST_STATE_CHANGE"
    ...
    const-string v16, "Received WifiP2pManager.WIFI_P2P_REQUEST_CHANGED_ACTION : requestAccepted = "
    ...
    const-string v15, "User accepted PIN connect"
    ...
    const-string v15, "User cancelled PIN connect or timeout"
    ...
    :cond_16
    const-string v14, "com.kddi.android.sptab_source.SUCCESS_CONNECT_SOURCE"
    ...
    :cond_17
    const-string v14, "com.kddi.android.sptab_source.SUCCESS_DISCONNECT_SOURCE"

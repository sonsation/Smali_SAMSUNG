...
.method private updateColorModesLocked([II)Z
    ...
    const-string v7, "Active color mode no longer available, reverting to default mode."
    ...
    const-string v7, "Default and active color mode is no longer available! Reverting to first available mode."
    ...
    const-string v6, "No color modes available!"
...
.method public requestModeInTransactionLocked(I)Z
    ...
    const-string v3, " trying with default mode ID"
...
.method public updatePhysicalDisplayInfoLocked([Landroid/view/SurfaceControl$PhysicalDisplayInfo;I[II)Z
    ...
    const-string v11, "Default display mode no longer available, using currently active mode as default."
    ...
    const-string v11, "Active display mode no longer available, reverting to default mode."

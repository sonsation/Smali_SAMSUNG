...
.method public sendNotificationForAppPermissionMonitor(II)V
    ...
    const-string v4, "DisplayManagerService_APM : "

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Exception notify permission monitor service about access from APM_FLAG_SCNCAP nfe = "
    ...
    const-string v6, "Exception notify permission monitor service about access from APM_FLAG_SCNCAP ex = "
    ...
    const-string v6, "Exception notify permission monitor service about access from APM_FLAG_SCNCAP re = "

...
.method private scanPackages()V
    ...
    const-string v10, "TvRemoteProvWatcher"
    ...
    const-string v10, "com.android.media.tv.remoteprovider.TvRemoteProvider"
...
.method private verifyServiceTrusted(Landroid/content/pm/ServiceInfo;)Z
    ...
    const-string v1, "android.permission.BIND_TV_REMOTE_SERVICE"
    ...
    const-string v2, "Ignoring atv remote provider service because the package has not been set and/or whitelisted: "
    ...
    const-string v2, "Ignoring atv remote provider service because it did not require the BIND_TV_REMOTE_SERVICE permission in its manifest: "
    ...
    const-string v2, "Ignoring atv remote provider service because its package does not have TV_VIRTUAL_REMOTE_CONTROLLER permission: "

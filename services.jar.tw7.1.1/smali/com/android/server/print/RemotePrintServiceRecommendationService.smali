...
.method constructor <init>(Landroid/content/Context;Landroid/os/UserHandle;Lcom/android/server/print/RemotePrintServiceRecommendationService$RemotePrintServiceRecommendationServiceCallbacks;)V
    ...
    const-string v3, "Could not connect to print service recommendation service"
...
.method private getServiceIntent(Landroid/os/UserHandle;)Landroid/content/Intent;
    ...
    const-string v7, "android.printservice.recommendation.RecommendationService"
    ...
    const-string v7, " instead of exactly one service found"
    ...
    const-string v6, "Cannot read appInfo for service"
    ...
    const-string v6, "Service is not part of the system"
    ...
    const-string v7, "android.permission.BIND_PRINT_RECOMMENDATION_SERVICE"
...
.method close()V
    ...
    const-string v3, "Could not unregister callbacks"

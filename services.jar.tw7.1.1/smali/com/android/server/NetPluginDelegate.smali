...
.method public static getTetherStats(Landroid/net/NetworkStats;Landroid/net/NetworkStats;Landroid/net/NetworkStats;)V
    ...
    const-string v2, "Error calling getTetherStats Method on extension jar"
    ...
    const-string v2, "Failed to invoke getTetherStats()"
...
.method private static declared-synchronized loadTetherExtJar()Z
    ...
    const-string v8, "/framework/ConnectivityExt.jar"
    ...
    const-string v8, "ConnectivityExt jar file not present"
    ...
    const-string v8, "Failed to find, instantiate or access ConnectivityExt jar "
...
.method public static natStarted(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "Error calling natStarted Method on extension jar"
    ...
    const-string v2, "Failed to invoke natStarted()"
...
.method public static natStopped(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "Error calling natStopped Method on extension jar"
    ...
    const-string v2, "Failed to invoke natStopped()"
...
.method public static peekTetherStats()Landroid/net/NetworkStats;
    ...
    const-string v4, "Error calling peekTetherStats Method on extension jar"
    ...
    const-string v4, "Failed to invoke peekTetherStats()"
...
.method public static setQuota(Ljava/lang/String;J)V
    ...
    const-string v2, "Failed to invoke setQuota()"
...
.method public static setUpstream(Landroid/net/Network;)V
    ...
    const-string v2, "Failed to invoke setUpstream()"

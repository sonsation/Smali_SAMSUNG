...
.method private actionToString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    const-string v0, "FIRST_ALARM_APPLOCKER"
    ...
    const-string v0, "App Locker First -- 10Min"

    return-object v0

    :cond_3
    const-string v0, "REPEAT_ALARM_APPLOCKER"
    ...
    const-string v0, "App Locker Repeat -- 1Hour"

    return-object v0

    :cond_4
    const-string v0, "FIRST_ALARM_AUTORUN"
    ...
    const-string v0, "Auto Run First -- 5Min"

    return-object v0

    :cond_5
    const-string v0, "REPEAT_ALARM_AUTORUN"
    ...
    const-string v0, "Auto Run Repeat -- 5Min"
    ...
    :cond_7
    const-string v0, "com.android.server.am.ACTION_UI_SET_ARES"
    ...
    const-string v0, "User Set AREs(China Model)"

    return-object v0

    :cond_8
    const-string v0, "com.android.server.am.ACTION_MEMORY_NOT_ENOUGH_ARES"
    ...
    const-string v0, "AREs memory not enough"

    return-object v0

    :cond_9
    const-string v0, "ALARM_ARES_MEMORY_NOT_ENOUGH"
    ...
    const-string v0, "AREs memory not enough alarm"
...
.method private setAlarm(Ljava/lang/String;J)V
    ...
    const-string v1, "FIRST_ALARM_APPLOCKER"
    ...
    :cond_2
    const-string v1, "REPEAT_ALARM_APPLOCKER"
    ...
    :cond_4
    const-string v1, "FIRST_ALARM_AUTORUN"
    ...
    :cond_6
    const-string v1, "REPEAT_ALARM_AUTORUN"
    ...
    :cond_8
    const-string v1, "FIRST_ALARM_AUTORUN_TRAFFIC_STAT"
    ...
    :cond_a
    const-string v1, "REPEAT_ALARM_AUTORUN_TRAFFIC_STAT"
    ...
    :cond_c
    const-string v1, "ALARM_ARES_MEMORY_NOT_ENOUGH"
    ...
    :cond_e
    const-string v1, "FIRST_ALARM_ARES_TRAFFIC_STAT"
...
.method public registerReceiver(Z)V
    ...
    const-string v9, "MARS_REQUEST_PKG_INFO"
    ...
    const-string v9, "android.os.action.CHARGING"

    invoke-virtual {v2, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "android.os.action.DISCHARGING"
    ...
    const-string v9, "com.android.server.am.ACTION_UI_SET_ALWAYS_OPTIMIZING"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "com.android.server.am.ACTION_PACKAGE_NOTUSED_RECENTLY"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "com.android.server.am.ACTION_SMUI_SETTING_TRUN_ON"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "FIRST_ALARM_APPLOCKER"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "REPEAT_ALARM_APPLOCKER"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "FIRST_ALARM_AUTORUN"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "REPEAT_ALARM_AUTORUN"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "com.android.server.am.ACTION_UI_SET_AUTORUN_OFF"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "FIRST_ALARM_AUTORUN_TRAFFIC_STAT"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "REPEAT_ALARM_AUTORUN_TRAFFIC_STAT"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "com.samsung.intent.action.SET_RUNNING_LOCATION"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "com.android.server.am.ACTION_MEMORY_NOT_ENOUGH_ARES"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "com.android.server.am.ACTION_UI_SET_ARES"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "ALARM_ARES_MEMORY_NOT_ENOUGH"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v9, "FIRST_ALARM_ARES_TRAFFIC_STAT"
    ...
    const-string v9, "com.samsung.android.server.am.ACTION_UI_TRIGGER_POLICY"
    ...
    const-string v9, "com.samsung.knox.securefolder.SETUP_COMPLETE"
...
.method public registerSecureFolderReceiver(I)V
    ...
    const-string v0, "com.sec.knox.action.PACKAGE_CHANGED"

...
.method static executeCommand(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string v6, "-- AMP perf enable change to "
    ...
    const-string v6, "-- AMP enable change to "
    ...
    :cond_6
    const-string v5, "_relaunch_resume="
    ...
    const-string v6, "-- AMP relaunch_resume change to "
    ...
    const-string v5, "-- AMP time cannot be under 100ms"
    ...
    const-string v6, "-- AMP cannot change time. value: "
    ...
    const-string v6, "-- AMP TIMEOUT_APP_SWITCH change to "
    ...
    const-string v6, "-- AMP TIMEOUT_ACT_START change to "
    ...
    const-string v6, "-- AMP TIMEOUT_ACT_RESUME change to "
    ...
    const-string v6, "-- AMP TIMEOUT_PREV_RESUME change to "
    ...
    const-string v6, "-- AMP debug change to "
    ...
    const-string v6, "-- AMP debug_trace change to "
...
.method private setBoosterActResume(ZLcom/android/server/am/ActivityRecord;)V
    ...
    const-string v9, "AMS_ACT_RESUME"
    ...
    const-string v9, "AMP_acquire() ACT_RESUME"
    ...
    const-string v10, "AMP_acquire() ACT_RESUME failed. stop boosting of "
    ...
    const-string v10, "AMP_acquire() ACT_RESUME failed. e: "
    ...
    const-string v9, "AMP_release() ACT_RESUME"
    ...
    const-string v9, "AMP_release() ACT_RESUME failed"
    ...
    const-string v10, "AMP_release() ACT_RESUME failed. e: "
...
.method private setBoosterActStart(ZLcom/android/server/am/ActivityRecord;)V
    ...
    const-string v9, "AMP_acquire() ACT_START"
    ...
    const-string v10, "AMP_acquire() ACT_START failed. stop boosting of "
    ...
    const-string v10, "AMP_acquire() ACT_START failed. e: "
    ...
    const-string v9, "AMP_release() ACT_START"
    ...
    const-string v9, "AMP_release() ACT_START failed"
    ...
    const-string v10, "AMP_release() ACT_START failed. e: "
...
.method private setBoosterAppSwitch(ZLcom/android/server/am/ActivityRecord;)V
    ...
    const-string v9, "AMS_APP_SWITCH"
    ...
    const-string v9, "AMP_acquire() APP_SWITCH"
    ...
    const-string v10, "AMP_acquire() APP_SWITCH failed. stop boosting of "
    ...
    const-string v10, "AMP_acquire() APP_SWITCH failed. e: "
    ...
    const-string v9, "AMP_release() APP_SWITCH"
    ...
    const-string v9, "AMP_release() APP_SWITCH failed"
...
.method private setBoosterHome(ZZLcom/android/server/am/ActivityRecord;)V
    ...
    const-string v9, "AMP_acquire() HOME"
    ...
    const-string v9, "AMP_acquire() HOME failed"
    ...
    const-string v10, "AMP_acquire() HOME failed. e: "
...
.method private setBoosterRelaunchResume(Lcom/android/server/am/ActivityRecord;)V
    ...
    const-string v5, "AMS_RELAUNCH_RESUME"
    ...
    const-string v5, "AMP_acquire() RELAUNCH_RESUME"
    ...
    const-string v5, "AMP_acquire() RELAUNCH_RESUME failed"
    ...
    const-string v6, "AMP_acquire() RELAUNCH_RESUME failed. e: "
...
.method private setBoosterTail(ZLcom/android/server/am/ActivityRecord;)V
    ...
    const-string v6, " is not finished"
    ...
    const-string v5, "AMS_RESUME_TAIL"
    ...
    const-string v5, "AMP_acquire() TAIL"
...
.method getCurBoostInfoStr()Ljava/lang/String;
    ...
    const-string v3, ", AMP_PERF_ENABLE: "
    ...
    const-string v3, ", TIMEOUT_ACT_START: "
    ...
    const-string v3, ", TIMEOUT_APP_SWITCH: "

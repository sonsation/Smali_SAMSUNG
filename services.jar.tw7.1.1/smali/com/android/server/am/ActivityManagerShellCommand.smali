...
.method static dumpHelp(Ljava/io/PrintWriter;Z)V
    ...
    const-string v0, "    Kill all processes associated with the given application."
    ...
    const-string v0, "  lenient-background-check [<true|false>]"

    invoke-virtual {p0, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v0, "    Optionally controls lenient background check mode, returns current mode."
...
.method runLenientBackgroundCheck(Ljava/io/PrintWriter;)I
    ...
    const-string v2, "Lenient background check enabled"
    ...
    :cond_2
    :try_start_1
    const-string v2, "Lenient background check disabled"
...
.method runTrackAssociations(Ljava/io/PrintWriter;)I
    ...
    const-string v0, "Association tracking started."
    ...
    :cond_0
    :try_start_1
    const-string v0, "Association tracking already enabled."
...
.method runUntrackAssociations(Ljava/io/PrintWriter;)I
    ...
    const-string v0, "Association tracking stopped."
    ...
    :cond_0
    :try_start_1
    const-string v0, "Association tracking not running."

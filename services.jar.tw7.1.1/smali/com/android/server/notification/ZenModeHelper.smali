...
.method private applyRestrictions(ZI)V
    ...
    const-string v4, "com.sec.dsm.system"
...
.method private cleanUpZenRules()V
    ...
    const-string v8, "Cleaning invalid automatic rule"
...
.method private computeZenModeTW()I
    ...
    const-string v6, "Keep current mode for setting allow or schedule time at this time : mode = "
    ...
    const-string v6, "Set zen mode ON by schedule : "
    ...
    const-string v6, "Set zen mode by zenSeverity : "
    ...
    const-string v6, "Set zen mode OFF by schedule : "
    ...
    const-string v6, "Set zen mode OFF by schedule switch : "
    ...
    const-string v6, "Set zen mode by manualRule : "
    ...
    const-string v6, "Set zen mode for exception case : "
...
.method private static dump(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Landroid/service/notification/ZenModeConfig;)V
    ...
    :cond_0
    const-string v2, "allow(calls=%s,callsFrom=%s,repeatCallers=%s,messages=%s,messagesFrom=%s,alarms=%s,events=%s,reminders=%s,whenScreenOff,whenScreenOn=%s)\n"
...
.method private evaluateZenMode(Ljava/lang/String;Z)Z
    ...
    const-string v4, "Set zen mode by [manual] : "
...
.method public sendBroadcastForZenModeChange(I)V
    ...
    const-string v3, "android.intent.action.DND_CHANGED"

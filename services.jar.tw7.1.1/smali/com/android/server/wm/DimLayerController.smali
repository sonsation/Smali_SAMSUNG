...
.method private animateDimLayers(Lcom/android/server/wm/DimLayer$DimLayerUser;)Z
    ...
    const-string v12, "animateDimLayers, dimLayerUser="
    ...
    const-string v12, " state.animator="
    ...
    const-string v12, " state.continueDimming="
...
.method private stopDimmingIfNeeded(Lcom/android/server/wm/DimLayer$DimLayerUser;)V
    ...
    const-string v4, " state.continueDimming="
    ...
    const-string v4, " state.dimLayer.isDimming="
...
.method adjustExitingDimLayer(Lcom/android/server/wm/DimLayer$DimLayerUser;Lcom/android/server/wm/WindowStateAnimator;)V
    ...
    const-string v3, "adjustExitingDimLayer trying to set exiting dim layer for: "
    ...
    const-string v3, ", but no dim layer user found."
    ...
    const-string v3, ", but dim layer user is invalid."
...
.method applyDim(Lcom/android/server/wm/DimLayer$DimLayerUser;Lcom/android/server/wm/WindowStateAnimator;Z)V
    ...
    const-string v2, ", but dim layer user is invalid."
...
.method startDimmingIfNeeded(Lcom/android/server/wm/DimLayer$DimLayerUser;Lcom/android/server/wm/WindowStateAnimator;Z)V
    ...
    const-string v4, " newWinAnimator="
    ...
    const-string v4, " state.animator="

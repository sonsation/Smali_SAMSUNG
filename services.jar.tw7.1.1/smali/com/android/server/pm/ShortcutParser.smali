...
.method public static parseShortcuts(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;I)Ljava/util/List;
    ...
    const-string v8, "Exception caught while parsing shortcut XML for package="
...
.method private static parseShortcutsOneFile(Lcom/android/server/pm/ShortcutService;Landroid/content/pm/ActivityInfo;Ljava/lang/String;ILjava/util/List;)Ljava/util/List;
    ...
    :try_start_0
    const-string v2, "android.app.shortcuts"
    ...
    const-string v6, " has no intent. Skipping it."
    ...
    const-string v6, " shortcuts found for "
    ...
    const-string v6, ". Skipping the rest."
    ...
    const-string v4, "Shortcut\'s extras contain un-persistable values. Skipping it."
    ...
    const-string v4, "Ignoring excessive intent tag."

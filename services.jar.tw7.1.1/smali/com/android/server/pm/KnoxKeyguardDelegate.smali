...
.method private getBitmapWallpaper()Landroid/graphics/Bitmap;
    ...
    const-string v5, "KnoxKeyguardDelegate"
...
.method private getDefaultWallpaper(Lcom/android/server/pm/KnoxNativeKeyguardHost;)V
    ...
    :cond_0
    :goto_0
    const-string v8, "KnoxKeyguardDelegate"
...
.method private openDefaultInfinityWallpaper()Ljava/io/InputStream;
    ...
    const-string v10, "default_thumb_"
    ...
    :cond_1
    :goto_2
    const-string v9, "KnoxKeyguardDelegate"
...
.method private sendKeyguardCommand(IZI)V
    ...
    const-string v7, " is not running now!"
    ...
    const-string v7, "\'s state is SUER_LOCKED"
    ...
    const-string v7, "\'s state is TIMA_COMPROMISED"
    ...
    const-string v6, "UPSM enabed! cannot start service"
    ...
    const-string v7, "cannot start KnoxKeyguardServiceAsUser: "
    ...
    const-string v7, "com.samsung.knox.kss.KnoxKeyguardService"
...
.method clearAll()V
    ...
    const-string v1, "Maybe the system state is not good. It will be cleared and back to launcher"
    ...
    const-string v1, "Maybe the system state is not good. It will be cleared"

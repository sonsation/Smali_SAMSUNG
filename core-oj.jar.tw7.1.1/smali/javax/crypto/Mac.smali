...
.method private chooseProvider(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    const-string v9, "No installed provider supports this key: "
...
.method chooseFirstProvider()V
    ...
    const-string v9, "Mac.init() not first method called, disabling delayed provider selection"
    ...
    const-string v9, "Further warnings of this type will be suppressed"
    ...
    .line 355
    const-string v7, "Could not construct MacSpi instance"
...
.method public final doFinal([BI)V
    ...
    const-string v3, "MAC not initialized"
    ...
    .line 621
    const-string v3, "Cannot store MAC in output buffer"
...
.method public final doFinal()[B
    ...
    const-string v2, "MAC not initialized"

...
.method private getDefaultPRNG(Z[B)V
    ...
    const-string v4, "No SecureRandom implementation!"
...
.method public static getInstance(Ljava/lang/String;Ljava/lang/String;)Ljava/security/SecureRandom;
    ...
    .line 371
    const-string v2, " * New versions of the Android SDK no longer support the Crypto provider."

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 372
    const-string v2, " * If your app was relying on setSeed() to derive keys from strings, you"

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 373
    const-string v2, " * should switch to using SecretKeySpec to load raw key bytes directly OR"

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 374
    const-string v2, " * use a real key derivation function (KDF). See advice here : "

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 375
    const-string v2, " * http://android-developers.blogspot.com/2016/06/security-crypto-provider-deprecated-in.html "
    ...
    .line 379
    const-string v2, " Returning an instance of SecureRandom from the Crypto provider"

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 380
    const-string v2, " as a temporary measure so that the apps targeting earlier SDKs"

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 381
    const-string v2, " keep working. Please do not rely on the presence of the Crypto"

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 382
    const-string v2, " provider in the codebase, as our plan is to delete it"

    invoke-static {v2}, Ljava/lang/System;->logE(Ljava/lang/String;)V

    .line 383
    const-string v2, " completely in the future."

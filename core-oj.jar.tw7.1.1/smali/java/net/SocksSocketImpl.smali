...
.method private bindV4(Ljava/io/InputStream;Ljava/io/OutputStream;Ljava/net/InetAddress;I)V
    ...
    const-string v8, "SOCKS V4 requires IPv4 only addresses"
    ...
    const-string v9, "Reply from SOCKS server has bad length: "
    ...
    const-string v8, "Reply from SOCKS server has bad version"
    ...
    const-string v7, "Reply from SOCKS server contains bad status"
    ...
    .end local v2    # "ex":Ljava/net/SocketException;
    const-string v7, "SOCKS request rejected"
    ...
    .end local v2    # "ex":Ljava/net/SocketException;
    const-string v7, "SOCKS server couldn\'t reach destination"
    ...
    .end local v2    # "ex":Ljava/net/SocketException;
    const-string v7, "SOCKS authentication failed"
...
.method private connectV4(Ljava/io/InputStream;Ljava/io/OutputStream;Ljava/net/InetSocketAddress;J)V
    ...
    const-string v6, "SOCKS V4 requires IPv4 only addresses"
    ...
    const-string v7, "Reply from SOCKS server has bad length: "
    ...
    const-string v6, "Reply from SOCKS server has bad version"
    ...
    const-string v5, "Reply from SOCKS server contains bad status"
    ...
    .end local v1    # "ex":Ljava/net/SocketException;
    const-string v5, "SOCKS request rejected"
    ...
    .end local v1    # "ex":Ljava/net/SocketException;
    const-string v5, "SOCKS server couldn\'t reach destination"
    ...
    .end local v1    # "ex":Ljava/net/SocketException;
    const-string v5, "SOCKS authentication failed"
...
.method private readSocksReply(Ljava/io/InputStream;[BJ)I
    ...
    const-string v7, "Malformed reply from SOCKS server"
    ...
    const-string v7, "Connect timed out"
...
.method protected connect(Ljava/net/SocketAddress;I)V
    ...
    const-string v8, "SOCKS : No acceptable methods"
    ...
    const-string v8, "SOCKS : authentication failed"
    ...
    const-string v8, "Reply from SOCKS server has bad length"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "Reply from SOCKS server contains wrong code"
    ...
    const-string v8, "Reply from SOCKS server badly formatted"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS server general failure"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS: Connection not allowed by ruleset"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS: Network unreachable"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS: Host unreachable"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS: Connection refused"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS: TTL expired"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS: Command not supported"
    ...
    .end local v17    # "ex":Ljava/net/SocketException;
    const-string v2, "SOCKS: address type not supported"
...
.method protected declared-synchronized socksBind(Ljava/net/InetSocketAddress;)V
    ...
    const-string v26, "Unknown proxy type : "
    ...
    const-string v26, "Unknow address type for proxy: "
    ...
    const-string v26, "Can\'t connect to SOCKS proxy:"
    ...
    const-string v25, "SOCKS : No acceptable methods"
    ...
    const-string v25, "SOCKS : authentication failed"
    ...
    const-string v26, "unsupported address type : "
    ...
    const-string v25, "Reply from SOCKS server badly formatted"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS server general failure"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS: Bind not allowed by ruleset"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS: Network unreachable"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS: Host unreachable"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS: Connection refused"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS: TTL expired"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS: Command not supported"
    ...
    .end local v9    # "ex":Ljava/net/SocketException;
    const-string v24, "SOCKS: address type not supported"

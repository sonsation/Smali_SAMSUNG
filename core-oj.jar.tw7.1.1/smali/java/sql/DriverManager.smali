...
.method public static declared-synchronized deregisterDriver(Ljava/sql/Driver;)V
    ...
    const-string v3, "DriverManager.deregisterDriver: "
    ...
    :cond_2
    :try_start_2
    const-string v1, "    couldn\'t find driver to unload"
...
.method private static getConnection(Ljava/lang/String;Ljava/util/Properties;Ljava/lang/ClassLoader;)Ljava/sql/Connection;
    ...
    const-string v6, "The url cannot be null"

    const-string v7, "08001"
    ...
    const-string v6, "DriverManager.getConnection(\""
    ...
    const-string v6, "getConnection failed: "
    ...
    const-string v6, "getConnection: no suitable driver found for "
    ...
    const-string v7, "No suitable driver found for "
...
.method public static getDriver(Ljava/lang/String;)Ljava/sql/Driver;
    ...
    const-string v5, "DriverManager.getDriver(\""
    ...
    const-string v5, "getDriver returning "
    ...
    .end local v0    # "aDriver":Ljava/sql/DriverInfo;
    :cond_2
    const-string v4, "getDriver: no suitable driver"
...
.method private static loadInitialDrivers()V
    ...
    const-string v5, "DriverManager.initialize: jdbc.drivers = "
    ...
    const-string v5, "number of Drivers:"
    ...
    const-string v7, "DriverManager.Initialize: loading "

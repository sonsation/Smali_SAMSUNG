...
.method public static saveAndRemoveProperties(Ljava/util/Properties;)V
    ...
    const-string v4, "System initialization has completed"
    ...
    .line 266
    const-string v3, "sun.nio.MaxDirectMemorySize"
    ...
    :cond_1
    :goto_0
    const-string v3, "sun.nio.PageAlignDirectMemory"
    ...
    .line 286
    :cond_2
    const-string v3, "sun.lang.ClassLoader.allowArraySyntax"
    ...
    .line 294
    const-string v3, "jdk.reflect.allowGetCallerClass"
    ...
    .line 298
    const-string v3, "jdk.logging.allowStackWalkSearch"
    ...
    .line 302
    const-string v3, "java.lang.Integer.IntegerCache.high"

    invoke-virtual {p0, v3}, Ljava/util/Properties;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 305
    const-string v3, "sun.zip.disableMemoryMapping"

    invoke-virtual {p0, v3}, Ljava/util/Properties;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 308
    const-string v3, "sun.java.launcher.diag"

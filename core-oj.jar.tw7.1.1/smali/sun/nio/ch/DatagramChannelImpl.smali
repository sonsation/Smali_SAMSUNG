...
.method public getOption(Ljava/net/SocketOption;)Ljava/lang/Object;
    ...
    const-string v6, "Unable to map address to interface"
    ...
    const-string v6, "Unable to map index to interface"
...
.method public receive(Ljava/nio/ByteBuffer;)Ljava/net/SocketAddress;
    ...
    const-string v6, "Read-only buffer"
...
.method public send(Ljava/nio/ByteBuffer;Ljava/net/SocketAddress;)I
    ...
    const-string v5, "Target address not resolved"
...
.method public setOption(Ljava/net/SocketOption;Ljava/lang/Object;)Ljava/nio/channels/DatagramChannel;
    ...
    const-string v7, "Cannot set IP_MULTICAST_IF to \'null\'"
    ...
    const-string v7, "Network interface cannot be identified"
    ...
    const-string v7, "Network interface not configured for IPv4"

...
.method static getLength(ILjava/io/InputStream;)I
    ...
    const-string v4, "DerInputStream.getLength(): lengthTag="
    ...
    const-string v2, "incorrect DER encoding."
    ...
    const-string v3, "DerInputStream.getLength(): Invalid length bytes"
...
.method private init([BII)V
    ...
    const-string v3, "Encoding bytes too short"
...
.method private readString(BLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "DER input not a "
    ...
    const-string v4, "short read of DER "
...
.method public getOctetString()[B
    ...
    const-string v3, "DER input not an octet string"
...
.method public getUnalignedBitString()Lsun/security/util/BitArray;
    ...
    const-string v4, "DER input not a bit string"
    ...
    const-string v4, "short read of DER bit string"
...
.method protected readVector(IZ)[Lsun/security/util/DerValue;
    ...
    const-string v15, "Indefinite length encoding not supported"
    ...
    const-string v15, "extra data at end of vector"

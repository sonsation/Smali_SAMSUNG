...
.method private getTime(IZ)Ljava/util/Date;
    ...
    .line 380
    const-string v20, " time, unsupported precision for seconds value"
    ...
    const-string v20, " time, invalid format"
    ...
    const-string v20, " time, invalid offset"
    ...
    const-string v20, " time, garbage offset"
...
.method getBigInteger(IZ)Ljava/math/BigInteger;
    ...
    const-string v2, "short read of integer"
    ...
    const-string v2, "Invalid encoding: zero length Int value"
...
.method public getBitString(I)[B
    ...
    const-string v3, "short read of bit string"
    ...
    const-string v3, "Invalid encoding: zero length bit string"
    ...
    const-string v3, "Invalid number of padding bits"
...
.method getUnalignedBitString()Lsun/security/util/BitArray;
    ...
    const-string v7, "Invalid value for unused bits: "

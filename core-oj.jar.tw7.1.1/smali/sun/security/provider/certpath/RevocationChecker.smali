...
.method private buildToNewKey(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Set;)V
    ...
    const-string v5, "RevocationChecker.buildToNewKey() starting work"
    ...
    const-string v5, "adding AIAext CertStore"
    ...
    const-string v7, "RevocationChecker.buildToNewKey: error decoding cert: "
    ...
    const-string v5, "RevocationChecker.buildToNewKey() about to try build ..."
    ...
    const-string v5, "RevocationChecker.buildToNewKey() about to check revocation ..."
    ...
    const-string v7, "RevocationChecker.buildToNewKey() index "
    ...
    const-string v7, "RevocationChecker.buildToNewKey() got key "
...
.method private check(Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/security/PublicKey;Z)V
    ...
    const-string v1, "Skipping revocation check, not end entity cert"
    ...
    const-string v2, "RevocationChecker.check() "
    ...
    const-string v1, "RevocationChecker.check() failover failed"
...
.method private checkApprovedCRLs(Ljava/security/cert/X509Certificate;Ljava/util/Set;)V
    ...
    const-string v4, "RevocationChecker.checkApprovedCRLs() cert SN: "
    ...
    const-string v4, "RevocationChecker.checkApprovedCRLs() CRL entry: "
    ...
    .line 640
    const-string v2, "Unrecognized critical extension(s) in revoked CRL entry"
...
.method private checkCRLs(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/security/cert/X509Certificate;ZZLjava/util/Set;Ljava/util/Set;)V
    ...
    const-string v9, "RevocationChecker.checkCRLs() ---checking revocation status ..."
    ...
    const-string v9, "RevocationChecker.checkCRLs() circular dependency"
    ...
    .line 484
    const-string v7, "Could not determine revocation status"
    ...
    const-string v10, "RevocationChecker.checkCRLs() CertStoreException: "
    ...
    .line 510
    const-string v7, "Unable to determine revocation status due to network error"
    ...
    const-string v10, "RevocationChecker.checkCRLs() possible crls.size() = "
    ...
    const-string v10, "RevocationChecker.checkCRLs() approved crls.size() = "
    ...
    .line 557
    const-string v16, "Unable to determine revocation status due to network error"
    ...
    .line 593
    const-string v16, "Could not determine revocation status"
...
.method private checkOCSP(Ljava/security/cert/X509Certificate;Ljava/util/Collection;)V
    ...
    const-string v3, "Found cached OCSP response"
    ...
    const-string v3, "1.3.6.1.5.5.7.48.1.2"
    ...
    .line 712
    const-string v3, "Certificate does not specify OCSP responder"
    ...
    .line 722
    const-string v10, "Unable to determine revocation status due to network error"
    ...
    .line 741
    const-string v16, "Certificate\'s revocation status is unknown"
...
.method private static getResponderCert(Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;Ljava/util/List;)Ljava/security/cert/X509Certificate;
    ...
    .line 251
    const-string v4, "cannot parse ocsp.responderCertIssuerName property"
    ...
    .line 257
    const-string v4, "cannot parse ocsp.responderCertSerialNumber property"
...
.method private static getResponderCert(Ljava/security/cert/X509CertSelector;Ljava/util/Set;Ljava/util/List;)Ljava/security/cert/X509Certificate;
    ...
    const-string v9, "CertStore exception:"
    ...
    .line 294
    const-string v8, "Cannot find the responder\'s certificate (set using the OCSP security properties)."
...
.method private verifyPossibleCRLs(Ljava/util/Set;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Z[ZLjava/util/Set;)Ljava/util/Collection;
    ...
    const-string v6, "RevocationChecker.verifyPossibleCRLs: Checking CRLDPs for "
    ...
    const-string v6, "Exception while verifying CRL: "
...
.method private verifyWithSeparateSigningKey(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;ZLjava/util/Set;)V
    ...
    .line 876
    const-string v6, "revocation status"
    ...
    .line 889
    const-string v1, "RevocationChecker.verifyWithSeparateSigningKey() circular dependency"
...
.method init(Ljava/security/cert/TrustAnchor;Lsun/security/provider/certpath/PKIX$ValidatorParams;)V
    ...
    const-string v9, "Unrecognized revocation parameter option: "
    ...
    const-string v9, "RevocationChecker: error creating Collection CertStore: "

...
.method constructor <init>(Ljava/security/cert/CertStoreParameters;)V
    ...
    .line 162
    const-string v2, "params must be instanceof URICertStoreParameters"
...
.method static getInstance(Lsun/security/x509/AccessDescription;)Ljava/security/cert/CertStore;
    ...
    const-string v5, "exception creating CertStore: "
...
.method private static initializeTimeout()I
    ...
    const-string v2, "com.sun.security.crl.timeout"
...
.method public declared-synchronized engineGetCRLs(Ljava/security/cert/CRLSelector;)Ljava/util/Collection;
    ...
    const-string v16, "Returning CRL from cache"
    ...
    const-string v17, "Not modified, using cached copy"
    ...
    const-string v16, "Exception fetching CRL:"
    ...
    const-string v17, "Downloading new CRL..."
...
.method public declared-synchronized engineGetCertificates(Ljava/security/cert/CertSelector;)Ljava/util/Collection;
    ...
    const-string v13, "Returning certificates from cache"
    ...
    const-string v14, "Not modified, using cached copy"
    ...
    const-string v13, "Exception fetching certificates:"
    ...
    const-string v14, "Downloading new certificates..."

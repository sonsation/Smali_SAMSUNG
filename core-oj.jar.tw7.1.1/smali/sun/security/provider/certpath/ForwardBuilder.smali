...
.method private getMatchingCACerts(Lsun/security/provider/certpath/ForwardState;Ljava/util/List;Ljava/util/Collection;)V
    ...
    const-string v8, "ForwardBuilder.getMatchingCACerts()..."
    ...
    const-string v8, "ForwardBuilder.getMatchingCACerts(): ca is target"
    ...
    const-string v8, "ForwardBuilder.getMatchingCACerts: found matching trust anchor"
    ...
    const-string v9, "ForwardBuilder.getMatchingCACerts: found "
...
.method getMatchingCerts(Lsun/security/provider/certpath/State;Ljava/util/List;)Ljava/util/Collection;
    ...
    const-string v3, "ForwardBuilder.getMatchingCerts()..."
...
.method isPathCompleted(Ljava/security/cert/X509Certificate;)Z
    ...
    const-string v7, "ForwardBuilder.isPathCompleted() invalid DSA key found"
    ...
    const-string v7, "ForwardBuilder.isPathCompleted() unexpected exception"
...
.method verifyCert(Ljava/security/cert/X509Certificate;Lsun/security/provider/certpath/State;Ljava/util/List;)V
    ...
    .line 737
    const-string v1, "Unrecognized critical extension(s)"
    ...
    const-string v1, "cert is NOT a CA cert"

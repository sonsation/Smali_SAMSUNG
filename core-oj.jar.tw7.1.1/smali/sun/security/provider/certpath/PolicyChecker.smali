...
.method private checkPolicy(Ljava/security/cert/X509Certificate;)V
    ...
    .prologue
    .line 200
    const-string v10, "certificate policies"
    ...
    const-string v2, "PolicyChecker.checkPolicy() ---checking "
    ...
    const-string v2, "PolicyChecker.checkPolicy() BEFORE PROCESSING: policyTree = "
    ...
    const-string v2, "PolicyChecker.checkPolicy() AFTER PROCESSING: explicitPolicy = "
    ...
    const-string v2, "PolicyChecker.checkPolicy() AFTER PROCESSING: policyMapping = "
    ...
    const-string v2, "PolicyChecker.checkPolicy() AFTER PROCESSING: inhibitAnyPolicy = "
    ...
    const-string v2, "PolicyChecker.checkPolicy() AFTER PROCESSING: policyTree = "
    ...
    const-string v2, "PolicyChecker.checkPolicy() "
...
.method static mergeExplicitPolicy(ILsun/security/x509/X509CertImpl;Z)I
    ...
    const-string v5, "PolicyChecker.mergeExplicitPolicy() require Index from cert = "
    ...
    const-string v4, "PolicyChecker.mergeExplicitPolicy unexpected exception"
...
.method static mergeInhibitAnyPolicy(ILsun/security/x509/X509CertImpl;)I
    ...
    const-string v5, "PolicyChecker.mergeInhibitAnyPolicy() skipCerts Index from cert = "
    ...
    const-string v4, "PolicyChecker.mergeInhibitAnyPolicy unexpected exception"
...
.method static mergePolicyMapping(ILsun/security/x509/X509CertImpl;)I
    ...
    const-string v5, "PolicyChecker.mergePolicyMapping() inhibit Index from cert = "
    ...
    const-string v4, "PolicyChecker.mergePolicyMapping unexpected exception"
...
.method private static processParents(IZZLsun/security/provider/certpath/PolicyNodeImpl;Ljava/lang/String;Ljava/util/Set;Z)Z
    ...
    const-string v9, "PolicyChecker.processParents(): matchAny = "
    ...
    const-string v9, "PolicyChecker.processParents() found parent:\n"
    ...
    .line 696
    const-string v9, "expected policy set already appears in "
...
.method static processPolicies(ILjava/util/Set;IIIZLsun/security/provider/certpath/PolicyNodeImpl;Lsun/security/x509/X509CertImpl;Z)Lsun/security/provider/certpath/PolicyNodeImpl;
    ...
    const-string v9, "PolicyChecker.processPolicies() policiesCritical = "
    ...
    const-string v9, "PolicyChecker.processPolicies() rejectPolicyQualifiers = "
    ...
    const-string v5, "Exception while retrieving policyOIDs"
    ...
    const-string v9, "PolicyChecker.processPolicies() processing policy: "
    ...
    .line 488
    const-string v4, "critical policy qualifiers present in certificate"
    ...
    const-string v5, "PolicyChecker.processPolicies() processing policy: 2.5.29.32.0"
    ...
    .line 573
    const-string v16, "non-null policy tree required and policy tree is null"
    ...
    const-string v5, "PolicyChecker.processPolicies() no policies present in cert"
...
.method private static processPolicyMappings(Lsun/security/x509/X509CertImpl;IILsun/security/provider/certpath/PolicyNodeImpl;ZLjava/util/Set;)Lsun/security/provider/certpath/PolicyNodeImpl;
    ...
    const-string v6, "PolicyChecker.processPolicyMappings() inside policyMapping check"
    ...
    const-string v8, "PolicyChecker.processPolicyMappings() issuerDomain = "
    ...
    const-string v8, "PolicyChecker.processPolicyMappings() subjectDomain = "
    ...
    .line 781
    const-string v3, "encountered an issuerDomainPolicy of ANY_POLICY"
    ...
    const-string v6, "PolicyChecker.processPolicyMappings() mapping exception"
    ...
    const-string v6, "Exception while checking mapping"
    ...
    .line 787
    const-string v3, "encountered a subjectDomainPolicy of ANY_POLICY"
    ...
    const-string v8, "PolicyChecker.processPolicyMappings() after deleting: policy tree = "
    ...
    const-string v6, "setting rootNode to null"
...
.method private static removeInvalidNodes(Lsun/security/provider/certpath/PolicyNodeImpl;ILjava/util/Set;Lsun/security/x509/CertificatePoliciesExtension;)Lsun/security/provider/certpath/PolicyNodeImpl;
    ...
    const-string v13, "PolicyChecker.processPolicies() processing policy second time: "
    ...
    const-string v13, "PolicyChecker.processPolicies() before deleting: policy tree = "
    ...
    const-string v13, "PolicyChecker.processPolicies() after deleting: policy tree = "
    ...
    const-string v12, "Exception while retrieving policyOIDs"

...
.method constructor <init>([B)V
    ...
    const-string v29, "OCSPResponse bytes...\n\n"
    ...
    const-string v28, "Bad encoding in OCSP response: expected ASN.1 SEQUENCE tag."
    ...
    const-string v29, "OCSP response status: "
    ...
    const-string v29, "Unknown OCSPResponse status: "
    ...
    const-string v28, "Bad encoding in responseBytes element of OCSP response: expected ASN.1 context specific tag 0."
    ...
    const-string v28, "Bad encoding in responseBytes element of OCSP response: expected ASN.1 SEQUENCE tag."
    ...
    const-string v28, "OCSP response type: basic"
    ...
    const-string v28, "Unexpected BasicOCSPResponse value"
    ...
    const-string v29, "OCSP response type: "
    ...
    const-string v29, "Unsupported OCSP response type: "
    ...
    const-string v28, "Bad encoding in tbsResponseData element of OCSP response: expected ASN.1 SEQUENCE tag."
    ...
    const-string v28, "Bad encoding in version  element of OCSP response: bad format"
    ...
    const-string v29, "Responder\'s name: "
    ...
    const-string v29, "OCSP response produced at: "
    ...
    const-string v29, "OCSP number of SingleResponses: "
    ...
    const-string v29, "Responder\'s key ID: "
    ...
    const-string v28, "Bad encoding in responderID element of OCSP response: expected ASN.1 context specific tag 0 or 1"
    ...
    const-string v29, "OCSP extension: "
    ...
    const-string v29, "Unsupported OCSP critical extension: "
    ...
    const-string v28, "Bad encoding in certs element of OCSP response: expected ASN.1 context specific tag 0."
    ...
    const-string v29, "OCSP response cert #"
    ...
    const-string v28, "Bad encoding in X509 Certificate"
...
.method private static initializeClockSkew()I
    ...
    const-string v2, "com.sun.security.ocsp.clockSkew"
...
.method private verifySignature(Ljava/security/cert/X509Certificate;)Z
    ...
    const-string v3, "Verified signature of OCSP Response"
    ...
    .line 647
    const-string v3, "Error verifying signature of OCSP Response"
...
.method verify(Ljava/util/List;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;Ljava/util/Date;[B)V
    ...
    const-string v4, "OCSP response error: "
    ...
    .line 417
    const-string v3, "OCSP response does not include a response for a certificate supplied in the OCSP request"
    ...
    const-string v4, "Status of certificate (with serial number "
    ...
    const-string v3, "OCSP response is signed by the target\'s Issuing CA"
    ...
    .line 581
    const-string v3, "Error verifying OCSP Response\'s signature"
    ...
    .line 437
    const-string v3, "Invalid issuer or trusted responder certificate"
    ...
    const-string v3, "OCSP response is signed by a Trusted Responder"
    ...
    const-string v3, "Responder\'s certificate includes the extension id-pkix-ocsp-nocheck."
    ...
    const-string v3, "OCSP response is signed by an Authorized Responder"
    ...
    .line 504
    const-string v3, "Responder\'s certificate not valid for signing OCSP responses"
    ...
    .line 567
    const-string v3, "Responder\'s certificate is not authorized to sign OCSP responses"
    ...
    .line 586
    const-string v3, "Unable to verify OCSP Response\'s signature"
    ...
    const-string v4, "Response\'s validity interval is from "
    ...
    .line 614
    const-string v3, "Response is unreliable: its validity interval is out-of-date"
    ...
    const-string v3, "Nonces don\'t match"

...
.method static hops(Lsun/security/x509/GeneralNameInterface;Lsun/security/x509/GeneralNameInterface;I)I
    ...
    const-string v8, "Builder.hops(): Names are different types"
    ...
    const-string v8, "Builder.hops(): hopDistance not implemented for this name type"
    ...
    const-string v8, "Builder.hops(): Names are in different namespaces"
...
.method static targetDistance(Lsun/security/x509/NameConstraintsExtension;Ljava/security/cert/X509Certificate;Lsun/security/x509/GeneralNameInterface;)I
    ...
    const-string v17, "certificate does not satisfy existing name constraints"
    ...
    const-string v17, "Invalid certificate"
    ...
    const-string v18, "Builder.targetDistance() merged constraints: "
    ...
    .line 344
    :cond_6
    const-string v16, "permitted_subtrees"
    ...
    const-string v16, "excluded_subtrees"
    ...
    const-string v18, "Builder.targetDistance() reduced constraints: "
    ...
    const-string v17, "New certificate not allowed to sign certificate for target"
...
.method addMatchingCerts(Ljava/security/cert/X509CertSelector;Ljava/util/Collection;Ljava/util/Collection;Z)Z
    ...
    const-string v10, "Builder.addMatchingCerts: adding target cert"
    ...
    const-string v11, "Builder.addMatchingCerts, non-fatal exception retrieving certs: "

...
.method private build()Ljava/security/cert/PKIXCertPathBuilderResult;
    ...
    const-string v3, "SunCertPathBuilder.engineBuild: 2nd pass"
    ...
    const-string v3, "unable to find valid certification path to requested target"
...
.method private buildCertPath(ZLjava/util/List;)Ljava/security/cert/PKIXCertPathBuilderResult;
    ...
    const-string v1, "SunCertPathBuilder.engineBuild() pathCompleted"
    ...
    const-string v1, "SunCertPathBuilder.engineBuild() exception in build"
    ...
    const-string v1, "unable to find valid certification path to requested target"
    ...
    const-string v1, "SunCertPathBuilder.engineBuild() exception in wrap-up"
...
.method private buildReverse(Ljava/util/List;Ljava/util/LinkedList;)V
    ...
    const-string v1, "SunCertPathBuilder.buildReverse()..."
    ...
    const-string v3, "SunCertPathBuilder.buildReverse() InitialPolicies: "
    ...
    const-string v1, "SunCertPathBuilder.buildReverse() returned from depthFirstSearchReverse()"
    ...
    const-string v3, "SunCertPathBuilder.buildReverse() certPathList.size: "
...
.method private depthFirstSearchForward(Ljavax/security/auth/x500/X500Principal;Lsun/security/provider/certpath/ForwardState;Lsun/security/provider/certpath/ForwardBuilder;Ljava/util/List;Ljava/util/LinkedList;)V
    ...
    const-string v7, "SunCertPathBuilder.depthFirstSearchForward("
    ...
    const-string v7, "SunCertPathBuilder.depthFirstSearchForward(): certs.size="
    ...
    const-string v6, "SunCertPathBuilder.depthFirstSearchForward(): commencing final verification"
    ...
    const-string v7, "SunCertPathBuilder.depthFirstSearchForward using buildParams public key: "
    ...
    .line 460
    const-string v6, "Only one PKIXRevocationChecker can be specified"
    ...
    const-string v7, "SunCertPathBuilder.depthFirstSearchForward(): validation failed: "
    ...
    const-string v7, "current subject = "
    ...
    const-string v7, "SunCertPathBuilder.depthFirstSearchForward(): final verification failed: "
    ...
    .line 558
    const-string v12, "unrecognized critical extension(s)"
    ...
    const-string v6, "SunCertPathBuilder.depthFirstSearchForward(): final verification succeeded - path completed!"
    ...
    const-string v6, "SunCertPathBuilder.depthFirstSearchForward(): backtracking"
...
.method private depthFirstSearchReverse(Ljavax/security/auth/x500/X500Principal;Lsun/security/provider/certpath/ReverseState;Lsun/security/provider/certpath/ReverseBuilder;Ljava/util/List;Ljava/util/LinkedList;)V
    ...
    const-string v5, "SunCertPathBuilder.depthFirstSearchReverse("
    ...
    const-string v5, "SunCertPathBuilder.depthFirstSearchReverse(): certs.size="
    ...
    const-string v3, "SunCertPathBuilder.depthFirstSearchReverse(): path completed!"
    ...
    const-string v5, "SunCertPathBuilder.depthFirstSearchReverse(): validation failed: "
    ...
    const-string v3, "SunCertPathBuilder.depthFirstSearchReverse(): backtracking"
    ...
    const-string v3, "SunCertPathBuilder.depthFirstSearchReverse() all certs in this adjacency list checked"

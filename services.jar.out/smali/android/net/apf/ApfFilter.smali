...
.method installNewProgramLocked()V
    ...
    .line 772
    .local v2, "gen":Landroid/net/apf/ApfGenerator;
    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    .line 773
    .local v8, "rasToFilter":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/net/apf/ApfFilter$Ra;>;"
    ...
    .local v7, "ra$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    .line 774
    .local v6, "ra":Landroid/net/apf/ApfFilter$Ra;
    ...
    .line 780
    .end local v6    # "ra":Landroid/net/apf/ApfFilter$Ra;
    :cond_0
    invoke-direct {p0}, Landroid/net/apf/ApfFilter;->beginProgramLocked()Landroid/net/apf/ApfGenerator;
    ...
    .line 782
    .restart local v6    # "ra":Landroid/net/apf/ApfFilter$Ra;
    invoke-virtual {v6, v2}, Landroid/net/apf/ApfFilter$Ra;->generateFilterLocked(Landroid/net/apf/ApfGenerator;)J
    ...
    .line 787
    .end local v2    # "gen":Landroid/net/apf/ApfGenerator;
    .end local v6    # "ra":Landroid/net/apf/ApfFilter$Ra;
    .end local v7    # "ra$iterator":Ljava/util/Iterator;
    .end local v8    # "rasToFilter":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/net/apf/ApfFilter$Ra;>;"
    :catch_0
    move-exception v0
    ...
    .restart local v2    # "gen":Landroid/net/apf/ApfGenerator;
    .restart local v7    # "ra$iterator":Ljava/util/Iterator;
    .restart local v8    # "rasToFilter":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/net/apf/ApfFilter$Ra;>;"
    :cond_2
    :try_start_1

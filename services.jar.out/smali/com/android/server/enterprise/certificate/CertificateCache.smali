...
.method declared-synchronized dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    .end local v7    # "userId$iterator":Ljava/util/Iterator;
    :catchall_0
    move-exception v8
    ...
    .line 222
    .restart local v0    # "adminUidIt":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/Integer;>;"
    .restart local v1    # "alias":Ljava/lang/String;
    .restart local v2    # "sb":Ljava/lang/StringBuilder;
    .restart local v3    # "userCache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/Integer;>;>;"
    .restart local v4    # "userCacheEntry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/List<Ljava/lang/Integer;>;>;"
    .restart local v5    # "userCacheIt":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/List<Ljava/lang/Integer;>;>;>;"
    .restart local v6    # "userId":Ljava/lang/Integer;
    .restart local v7    # "userId$iterator":Ljava/util/Iterator;
    :cond_2
    :try_start_1
    const-string/jumbo v8, "]"

.class public Lcom/samsung/android/app/music/list/local/GenreDetailFragment;
...
.method public constructor <init>()V
    ...
    .line 156
    new-instance v0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment$1;

    invoke-direct {v0, p0}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment$1;-><init>(Lcom/samsung/android/app/music/list/local/GenreDetailFragment;)V

    iput-object v0, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mOnItemClickListener:Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter$OnItemClickListener;

    return-void
.end method

.method public static newInstance(Ljava/lang/String;)Lcom/samsung/android/app/music/list/local/GenreDetailFragment;
    .locals 3
    .param p0, "genreName"    # Ljava/lang/String;

    .prologue
    .line 59
    new-instance v1, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;

    invoke-direct {v1}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;-><init>()V

    .line 60
    .local v1, "fg":Lcom/samsung/android/app/music/list/local/GenreDetailFragment;
    ...
    .line 62
    invoke-virtual {v1, v0}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setArguments(Landroid/os/Bundle;)V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setScreenId(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected bridge synthetic onCreateAdapter()Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter;
    ...
    .prologue
    .line 52
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->onCreateAdapter()Lcom/samsung/android/app/music/list/local/DefaultTrackAdapter;
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mContextMenu:Lcom/samsung/android/app/musiclibrary/ui/menu/IMusicMenu;

    .line 178
    iget-object v0, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mAdapter:Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter;

    check-cast v0, Lcom/samsung/android/app/music/list/local/DefaultTrackAdapter;

    iget-object v1, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mRecyclerView:Lcom/samsung/android/app/musiclibrary/ui/widget/MusicRecyclerView;
...
.method protected onCreateLayoutManager()Lcom/samsung/android/support/sesl/component/widget/SeslRecyclerView$LayoutManager;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->getActivity()Landroid/app/Activity;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mMusicMenu:Lcom/samsung/android/app/musiclibrary/ui/menu/IMusicMenu;
...
.method protected onCreateQueryArgs(I)Lcom/samsung/android/app/musiclibrary/ui/list/query/QueryArgs;
    ...
    iget-object v2, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mListHeaderManager:Lcom/samsung/android/app/music/list/common/ListHeaderManager;
    ...
    invoke-direct {v0, v1, v2}, Lcom/samsung/android/app/musiclibrary/ui/list/query/GenreTrackQueryArgs;-><init>(Ljava/lang/String;I)V
...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->getFragmentManager()Landroid/app/FragmentManager;
...
.method public bridge synthetic onLoadFinished(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 76
    iget-object v2, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mOnItemClickListener:Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter$OnItemClickListener;

    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setOnItemClickListener(Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter$OnItemClickListener;)V
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setSelectAll(Lcom/samsung/android/app/musiclibrary/ui/list/selectmode/ISelectAll;)V

    .line 79
    const/4 v2, 0x3

    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setChoiceMode(I)V

    .line 80
    new-instance v2, Lcom/samsung/android/app/music/list/local/GenreDetailFragment$ActionModeOptionsMenu;

    invoke-direct {v2, p0, v6}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment$ActionModeOptionsMenu;-><init>(Lcom/samsung/android/app/music/list/local/GenreDetailFragment;Lcom/samsung/android/app/music/list/local/GenreDetailFragment$1;)V

    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setActionModeMenu(Lcom/samsung/android/app/musiclibrary/ui/menu/ActionModeMenu;)V
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setDeleteable(Lcom/samsung/android/app/musiclibrary/ui/Deleteable;)V
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setSelectedItemPlayable(Lcom/samsung/android/app/musiclibrary/ui/list/SelectedItemPlayable;)V
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setShareable(Lcom/samsung/android/app/musiclibrary/ui/list/Shareable;)V
    ...
    .line 92
    invoke-virtual {p0, v1}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->addFragmentLifeCycleCallbacks(Lcom/samsung/android/app/musiclibrary/ui/FragmentLifeCycleCallbacks;)V
    ...
    new-instance v2, Lcom/samsung/android/app/music/list/local/GenreDetailFragment$GenreDetailFilterableImpl;

    invoke-direct {v2, p0, v6}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment$GenreDetailFilterableImpl;-><init>(Lcom/samsung/android/app/music/list/local/GenreDetailFragment;Lcom/samsung/android/app/music/list/local/GenreDetailFragment$1;)V
    ...
    iput-object v2, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mListHeaderManager:Lcom/samsung/android/app/music/list/common/ListHeaderManager;

    .line 99
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->getAdapter()Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter;
    ...
    iget-object v4, p0, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->mListHeaderManager:Lcom/samsung/android/app/music/list/common/ListHeaderManager;
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setEmptyView(Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerViewFragment$EmptyViewCreator;)V

    .line 104
    invoke-virtual {p0, v5}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->setListShown(Z)V

    .line 105
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->getListType()I

    move-result v2

    invoke-virtual {p0, v2}, Lcom/samsung/android/app/music/list/local/GenreDetailFragment;->initListLoader(I)V

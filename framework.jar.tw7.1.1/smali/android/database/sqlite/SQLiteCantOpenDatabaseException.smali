...
.method static constructor <clinit>()V
    ...
    const-string v2, "SQLITE_CANTOPEN_FULLPATH"
    ...
    const-string v2, "SQLITE_CANTOPEN_CONVPATH"
    ...
    const-string v2, "SQLITE_CANTOPEN_ENOENT"
    ...
    const-string v2, "SQLITE_CANTOPEN_ENOMEM"

    aput-object v2, v1, v3

    const-string v2, "No available memory space."
    ...
    const-string v2, "SQLITE_CANTOPEN_EACCES"

    aput-object v2, v1, v3

    const-string v2, "Application has no permission to open the specified database file."
    ...
    const-string v2, "SQLITE_CANTOPEN_EMFILE"

    aput-object v2, v1, v3

    const-string v2, "Application has opened two many files. Maximum of available file descriptors in one process is 1024 in default."
    ...
    const-string v2, "SQLITE_CANTOPEN_ENOSPC"
    ...
    const-string v2, "SQLITE_CANTOPEN_EROFS"

    aput-object v2, v1, v3

    const-string v2, "Current partition has been mounted with read-only mode."
    ...
    const-string v2, "SQLITE_CANTOPEN_WRONG_PWD"

    aput-object v2, v1, v3

    const-string v2, "Can not open secure database because of the wrong password."

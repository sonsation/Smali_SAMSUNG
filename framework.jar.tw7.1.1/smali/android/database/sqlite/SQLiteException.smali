...
.method static constructor <clinit>()V
    ...
    const-string v2, "SQLITE_PERM"

    aput-object v2, v1, v3

    const-string v2, "Access permission denied."
    ...
    const-string v2, "SQLITE_ABORT"

    aput-object v2, v1, v3

    const-string v2, "Callback routine requested an abort."
    ...
    const-string v2, "SQLITE_BUSY"

    aput-object v2, v1, v3

    const-string v2, "The database file is locked."
    ...
    const-string v2, "SQLITE_LOCKED"

    aput-object v2, v1, v3

    const-string v2, "A table in the database is locked."
    ...
    const-string v2, "SQLITE_NOMEM"

    aput-object v2, v1, v3

    const-string v2, "There is no enough heap memory for application."
    ...
    const-string v2, "Attempt to write a readonly database. (database may be deleted by other process)"
    ...
    const-string v2, "SQLITE_INTERRUPT"

    aput-object v2, v1, v3

    const-string v2, "Operation terminated by interrupt function."
    ...
    const-string v2, "SQLITE_CORRUPT"

    aput-object v2, v1, v3

    const-string v2, "The database disk image is malformed."
    ...
    const-string v2, "SQLITE_NOTFOUND"
    ...
    const-string v2, "Database lock protocol error."
    ...
    const-string v2, "Database is empty."
    ...
    const-string v2, "The database schema changed."
    ...
    const-string v2, "String or BLOB exceeds size limits."
    ...
    const-string v2, "SQLITE_MISMATCH"
    ...
    const-string v2, "SQLITE_NOTADB"

    aput-object v2, v1, v3

    const-string v2, "File opened that is not a database file or encrypted."
    ...
    const-string v2, "SQLITE_WARNING"

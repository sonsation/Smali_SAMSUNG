...
.method private getExtrasFromRequest(Landroid/hardware/camera2/legacy/RequestHolder;ILjava/lang/Object;)Landroid/hardware/camera2/impl/CaptureResultExtras;
    ...
    const-string v3, "Buffer drop error reported for unknown Surface"
...
.method public configureOutputs(Landroid/util/SparseArray;)I
    ...
    const-string v15, "configureOutputs - null outputs are not allowed"
    ...
    const-string v15, "configureOutputs - invalid output surfaces are not allowed"
    ...
    const-string v7, "format is invalid."
    ...
    const-string v15, "Surface with size (w=%d, h=%d) and format 0x%x is not valid, %s"
    ...
    const-string v15, "Surface bufferqueue is abandoned, cannot configure as output: "

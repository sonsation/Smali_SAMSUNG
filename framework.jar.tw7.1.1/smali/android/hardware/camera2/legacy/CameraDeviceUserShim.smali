...
.method public beginConfigure()V
    ...
    const-string v0, "Cannot begin configure, configuration change already in progress."
...
.method public cancelRequest(I)J
    ...
    const-string v0, "Cannot cancel request, configuration change in progress."
...
.method public createDefaultRequest(I)Landroid/hardware/camera2/impl/CameraMetadataNative;
    ...
    const-string v1, "Cannot create default request, device has been closed."
...
.method public createStream(Landroid/hardware/camera2/params/OutputConfiguration;)I
    ...
    const-string v0, "Cannot create stream, beginConfigure hasn\'t been called yet."
    ...
    const-string v0, "Cannot create stream, stream rotation is not supported."
...
.method public deleteStream(I)V
    ...
    const-string v0, "Cannot delete stream, no configuration change in progress."
...
.method public endConfigure(Z)V
    ...
    const-string v0, "Cannot end configure, no configuration change in progress."
...
.method public flush()J
    ...
    const-string v0, "Cannot flush, configuration change in progress."
...
.method public setDeferredConfiguration(ILandroid/hardware/camera2/params/OutputConfiguration;)V
    ...
    const-string v0, "Set deferred configuration is not supported on legacy devices"
...
.method public submitRequest(Landroid/hardware/camera2/CaptureRequest;Z)Landroid/hardware/camera2/utils/SubmitInfo;
    ...
    const-string v0, "Cannot submit request, configuration change in progress."
...
.method public waitUntilIdle()V
    ...
    const-string v0, "Cannot wait until idle, configuration change in progress."

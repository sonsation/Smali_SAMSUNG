...
.method public constructor <init>(Landroid/content/pm/PackageManager;)V
    ...
    const-string v8, "com.android.intent.action.MANAGE_VOICE_KEYPHRASES"
    ...
    :cond_0
    const-string v7, "No enrollment applications found"
    ...
    const-string v9, "is not a privileged system app"
    ...
    const-string v9, " does not require MANAGE_VOICE_KEYPHRASES"
    ...
    const-string v2, "No suitable enrollment application found"
...
.method private getKeyphraseFromTypedArray(Landroid/content/res/TypedArray;Ljava/lang/String;Ljava/util/List;)Landroid/hardware/soundtrigger/KeyphraseMetadata;
    ...
    const-string v10, "No valid searchKeyphraseId specified in meta-data for "
    ...
    const-string v10, "No valid searchKeyphrase specified in meta-data for "
    ...
    const-string v10, "No valid searchKeyphraseSupportedLocales specified in meta-data for "
    ...
    const-string v10, "Error reading searchKeyphraseSupportedLocales from meta-data for "
    ...
    const-string v10, "No valid searchKeyphraseRecognitionFlags specified in meta-data for "
...
.method private getKeyphraseMetadataFromApplicationInfo(Landroid/content/pm/PackageManager;Landroid/content/pm/ApplicationInfo;Ljava/util/List;)Landroid/hardware/soundtrigger/KeyphraseMetadata;
    ...
    :try_start_0
    const-string v14, "android.voice_enrollment"
    ...
    const-string v15, "No android.voice_enrollment meta-data for "
    ...
    const-string v14, "KeyphraseEnrollmentInfo"
    ...
    const-string v15, "Error parsing keyphrase enrollment meta-data for "
...
.method public getManageKeyphraseIntent(ILjava/lang/String;Ljava/util/Locale;)Landroid/content/Intent;
    ...
    :cond_0
    const-string v2, "KeyphraseEnrollmentInfo"

    const-string v3, "No enrollment application exists"
    ...
    const-string v3, "com.android.intent.extra.VOICE_KEYPHRASE_HINT_TEXT"
    ...
    const-string v3, "com.android.intent.extra.VOICE_KEYPHRASE_ACTION"

...
.method public build()Landroid/app/job/JobInfo;
    ...
    const-string v3, "You\'re trying to build a job with no constraints, this is not allowed."
    ...
    const-string v3, "An idle mode job will not respect any back-off policy, so calling setBackoffCriteria with setRequiresDeviceIdle is an error."
    ...
    const-string v2, "Specified interval for "
    ...
    const-string v2, "Specified flex for "

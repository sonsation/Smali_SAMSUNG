...
.method public static dumpMemInfoTable(Ljava/io/PrintWriter;Landroid/os/Debug$MemoryInfo;ZZZZILjava/lang/String;JJJJJJ)V
    ...
    const-string v22, "%13s %8s %8s %8s %8s %8s %8s %8s %8s %8s %8s"
    ...
    const-string v21, "%13s %8s %8s %8s %8s %8s %8s %8s %8s %8s %8s"
    ...
    :cond_9
    const-string v22, "%13s %8s %8s %8s %8s %8s %8s %8s"
    ...
    const-string v21, "%13s %8s %8s %8s %8s %8s %8s %8s"
    ...
    const-string v21, " Dalvik Details"
    ...
    const-string v23, "Private Other:"
    ...
    const-string v21, "%21s %8d %21s %8d"
    ...
    const-string v23, "TOTAL SWAP PSS:"
    ...
    const-string v23, "TOTAL SWAP (KB):"
...
.method private getThemeResourceFromMappingTable()V
    ...
    const-string v19, "Exception during parsing theme app list XmlPullParserException"
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    :cond_c
    :goto_6
    const-string v2, "NetworkSecurityConfigProvider.install"
...
.method private handlePauseActivity(Landroid/os/IBinder;ZZIZI)V
    ...
    const-string v3, "handlePauseActivity"
...
.method private handleRelaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    const-string v10, "handleRelaunchActivity"
...
.method public static main([Ljava/lang/String;)V
    ...
    const-string v5, "Unable to add TimaKeyStore provider"
...
.method private performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/os/IBinder;Landroid/content/res/Configuration;Landroid/content/res/Configuration;Z)V
    ...
    const-string v10, " did not call through to super.onConfigurationChanged()"
...
.method private updatePackageInfosLocked(Landroid/util/ArrayMap;)V
    ...
    const-string v8, "Resetting overlays for "

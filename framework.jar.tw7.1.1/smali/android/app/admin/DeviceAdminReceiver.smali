...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_2
    const-string v6, "android.app.action.ACTION_PASSWORD_SUCCEEDED"
    ...
    :cond_4
    const-string v6, "android.app.action.DEVICE_ADMIN_DISABLE_REQUESTED"
    ...
    const-string v6, "android.app.extra.DISABLE_WARNING"
    ...
    :cond_5
    const-string v6, "android.app.action.DEVICE_ADMIN_DISABLED"
    ...
    :cond_7
    const-string v6, "android.app.action.ACTION_RECOVERY_PASSWORD_REQUESTED"
    ...
    :cond_8
    const-string v6, "android.app.action.PROFILE_PROVISIONING_COMPLETE"
    ...
    :cond_9
    const-string v6, "android.app.action.CHOOSE_PRIVATE_KEY_ALIAS"
    ...
    const-string v6, "android.app.extra.CHOOSE_PRIVATE_KEY_SENDER_UID"
    ...
    const-string v6, "android.app.extra.CHOOSE_PRIVATE_KEY_URI"
    ...
    const-string v6, "android.app.extra.CHOOSE_PRIVATE_KEY_ALIAS"
    ...
    :cond_c
    const-string v6, "android.app.action.NOTIFY_PENDING_SYSTEM_UPDATE"
    ...
    const-string v6, "android.app.extra.SYSTEM_UPDATE_RECEIVED_TIME"
    ...
    :cond_d
    const-string v6, "android.app.action.BUGREPORT_SHARING_DECLINED"
    ...
    const-string v6, "android.app.extra.BUGREPORT_HASH"
    ...
    :cond_f
    const-string v6, "android.app.action.BUGREPORT_FAILED"
    ...
    :cond_10
    const-string v6, "android.app.action.SECURITY_LOGS_AVAILABLE"

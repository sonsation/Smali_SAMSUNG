...
.method public static lookUpResourceName(Landroid/content/res/Resources;IZLjava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, ". Resource IDs may change when the application is upgraded, and the system"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, " may not be able to find the correct resource."
...
.method public enforceMandatoryFields()V
    ...
    const-string v2, "Activity must be provided"
    ...
    const-string v2, "Shortcut Intent must be provided"
...
.method public ensureUpdatableWith(Landroid/content/pm/ShortcutInfo;)V
    ...
    :goto_0
    const-string v3, "Owner User ID must match"
    ...
    const-string v3, "Package name must match"
    ...
    :goto_1
    const-string v0, "Target ShortcutInfo is immutable"

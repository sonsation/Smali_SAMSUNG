...
.method private isNFCEnableAllowed()Z
    ...
    const-string v8, "Nfc policy: Enabling NFC"

    :try_start_0
    const-string v0, "NFC"

    const-string v1, "isNFCEnableAllowed - Begin"
...
.method private isNFCStateChangeAllowed(I)Z
    ...
    const-string v1, "Restriction policy block settings change"

    invoke-static {v0, v1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    if-nez p1, :cond_1

    const-string v9, "Enable reject"
    ...
    const-string v1, "EDM : isNFCStateChangeAllowed is false. failed Reason: "
    ...
    :cond_0
    const-string v10, "Disabling NFC"

    goto/16 :goto_0

    :cond_1
    :try_start_3
    const-string v9, "Disable reject"
    :try_end_3
    ...
    const-string v1, "Restriction policy block NFC state change"
...
.method public getDefaultRoutingDestination()Ljava/lang/String;
    ...
    const-string v3, "Fail to get default routing destination"

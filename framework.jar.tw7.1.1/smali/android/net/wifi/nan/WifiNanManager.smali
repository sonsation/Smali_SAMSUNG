...
.method public connect(Landroid/net/wifi/nan/WifiNanEventListener;I)V
    ...
    const-string v2, "Invalid listener - must not be null"
...
.method public publish(ILandroid/net/wifi/nan/PublishData;Landroid/net/wifi/nan/PublishSettings;)V
    ...
    const-string v2, "Invalid publish data & settings: UNSOLICITED publishes (active) can\'t have an Rx filter"
    ...
    const-string v2, "Invalid publish data & settings: SOLICITED publishes (passive) can\'t have a Tx filter"
...
.method public publishRaw(Landroid/net/wifi/nan/PublishData;Landroid/net/wifi/nan/PublishSettings;Landroid/net/wifi/nan/WifiNanSessionListener;I)Landroid/net/wifi/nan/WifiNanPublishSession;
    ...
    const-string v3, "Invalid publish data & settings: UNSOLICITED publishes (active) can\'t have an Rx filter"
    ...
    const-string v3, "Invalid publish data & settings: SOLICITED publishes (passive) can\'t have a Tx filter"
    ...
    const-string v3, "Invalid listener - must not be null"
...
.method public subscribe(ILandroid/net/wifi/nan/SubscribeData;Landroid/net/wifi/nan/SubscribeSettings;)V
    ...
    const-string v2, "Invalid subscribe data & settings: ACTIVE subscribes can\'t have an Rx filter"
    ...
    const-string v2, "Invalid subscribe data & settings: PASSIVE subscribes can\'t have a Tx filter"
...
.method public subscribeRaw(Landroid/net/wifi/nan/SubscribeData;Landroid/net/wifi/nan/SubscribeSettings;Landroid/net/wifi/nan/WifiNanSessionListener;I)Landroid/net/wifi/nan/WifiNanSubscribeSession;
    ...
    const-string v3, "Invalid subscribe data & settings: ACTIVE subscribes can\'t have an Rx filter"
    ...
    const-string v3, "Invalid subscribe data & settings: PASSIVE subscribes can\'t have a Tx filter"

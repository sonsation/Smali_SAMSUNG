...
.method private static getProviderClass()Ljava/lang/Class;
    ...
    :try_start_0
    const-string v6, "WebViewFactory.getWebViewContextAndSetProvider()"
    ...
    const-string v6, "WebViewFactory.getChromiumProviderClass()"
    ...
    :try_start_4
    const-string v6, "com.android.webview.chromium.WebViewChromiumFactoryProvider"
    ...
    :try_start_7
    const-string v6, "com.android.webview.nullwebview.NullWebViewFactoryProvider"
    ...
    const-string v7, "error loading provider"
    ...
    const-string v7, "Chromium WebView package does not exist"
...
.method private static getWebViewContextAndSetProvider()Landroid/content/Context;
    ...
    :try_start_0
    const-string v5, "WebViewUpdateService.waitForAndGetProvider()"
    ...
    const-string v7, "Failed to load WebView provider: "
    ...
    const-string v5, "PackageManager.getPackageInfo()"
    ...
    const-string v5, "initialApplication.createApplicationContext"
...
.method private static loadNativeLibrary(Ljava/lang/ClassLoader;)I
    ...
    const-string v3, "can\'t load with relro file; address space not reserved"
    ...
    const-string v5, "/data/misc/shared_relro/libwebviewchromium64.relro"
...
.method public static loadWebViewNativeLibraryFromPackage(Ljava/lang/String;Ljava/lang/ClassLoader;)I
    ...
    const-string v7, "error waiting for relro creation"

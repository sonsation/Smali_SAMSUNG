...
.method private static computeContentDigests([I[Landroid/util/apk/ApkSignatureSchemeV2Verifier$DataSource;)[[B
    ...
    const-string v33, "Too many chunks: "
    ...
    const-string v33, " digest not supported"
    ...
    const-string v33, "Unexpected output size of "
    ...
    const-string v33, "Failed to digest chunk #"
...
.method private static findSignature(Ljava/io/RandomAccessFile;)Landroid/util/apk/ApkSignatureSchemeV2Verifier$SignatureInfo;
    ...
    const-string v9, "ZIP64 APK not supported"
...
.method private static verify(Ljava/io/FileDescriptor;Landroid/util/apk/ApkSignatureSchemeV2Verifier$SignatureInfo;)[[Ljava/security/cert/X509Certificate;
    ...
    const-string v4, "No signers found"
    ...
    const-string v4, "No content digests found"
...
.method private static verifyIntegrity(Ljava/util/Map;Ljava/io/FileDescriptor;JJJLjava/nio/ByteBuffer;)V
    ...
    const-string v7, "No digests provided"
    ...
    const-string v8, " digest of contents did not verify"
    ...
    const-string v7, "Failed to compute digest(s) of contents"
...
.method private static verifySigner(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    const-string v38, "Signature record too short"
    ...
    const-string v39, "Failed to parse signature record #"
    ...
    const-string v38, "No signatures found"
    ...
    const-string v38, "No supported signatures found"
    ...
    const-string v39, " signature did not verify"
    ...
    const-string v39, "Failed to verify "
    ...
    const-string v38, "Record too short"
    ...
    const-string v39, "Failed to parse digest record #"
    ...
    const-string v38, "Signature algorithms don\'t match between digests and signatures records"
    ...
    const-string v39, " contents digest does not match the digest specified by a preceding signer"
    ...
    const-string v39, "Failed to decode certificate #"
    ...
    const-string v38, "No certificates listed"
    ...
    const-string v38, "Public key mismatch between certificate and signature record"

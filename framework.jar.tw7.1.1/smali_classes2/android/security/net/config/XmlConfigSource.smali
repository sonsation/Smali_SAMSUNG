...
.method private parseConfigEntry(Landroid/content/res/XmlResourceParser;Ljava/util/Set;Landroid/security/net/config/NetworkSecurityConfig$Builder;I)Ljava/util/List;
    ...
    :cond_2
    const-string v16, "cleartextTrafficPermitted"
    ...
    const-string v18, "domain element not allowed in "
    ...
    const-string v17, "Multiple trust-anchor elements not allowed"
    ...
    const-string v17, "Multiple pin-set elements not allowed"
    ...
    :cond_a
    const-string v16, "domain-config"
    ...
    const-string v18, "Nested domain-config not allowed in "
    ...
    const-string v17, "No domain elements in domain-config"
...
.method private parseDebugOverridesResource()Landroid/security/net/config/NetworkSecurityConfig$Builder;
    ...
    const-string v11, "Only one debug-overrides allowed"
...
.method private parseDomain(Landroid/content/res/XmlResourceParser;Ljava/util/Set;)Landroid/security/net/config/Domain;
    ...
    const-string v3, "Domain name missing"
...
.method private parseNetworkSecurityConfig(Landroid/content/res/XmlResourceParser;)V
    ...
    const-string v22, "Only one base-config allowed"
    ...
    :cond_1
    const-string v21, "domain-config"
    ...
    :cond_2
    const-string v21, "debug-overrides"
    ...
    const-string v22, "Only one debug-overrides allowed"
...
.method private parsePin(Landroid/content/res/XmlResourceParser;)Landroid/security/net/config/Pin;
    ...
    const-string v7, "Unsupported pin digest algorithm: "
    ...
    const-string v6, "Missing pin digest"
    ...
    const-string v7, " does not match expected length for "
    ...
    const-string v6, "Invalid pin digest"
...
.method private parsePinSet(Landroid/content/res/XmlResourceParser;)Landroid/security/net/config/PinSet;
    ...
    const-string v10, "Invalid expiration date in pin-set"

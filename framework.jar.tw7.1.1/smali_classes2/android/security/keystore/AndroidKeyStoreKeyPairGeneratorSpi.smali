...
.method private static checkSecureProcessorValidKeySize(II)V
    ...
    const-string v1, "RSA key size must be >= 2048 and <= 2048"
...
.method private generateSelfSignedCertificateBytes(Ljava/security/KeyPair;)[B
    ...
    const-string v3, "Failed to obtain encoded form of self-signed certificate"
    ...
    const-string v3, "Failed to generate self-signed certificate"
...
.method private loadKeystoreKeyPair(Ljava/lang/String;)Ljava/security/KeyPair;
    ...
    const-string v4, "Generated key pair algorithm does not match requested algorithm: "
    ...
    const-string v3, "Failed to load generated key pair from keystore"
...
.method private storeCertificateChain(ILjava/lang/Iterable;)V
    ...
    const-string v5, "Failed to store certificate"
    ...
    const-string v5, "Failed to store attestation CA certificate"
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    const-string v6, "Encryption at rest using secure lock screen credential requested for key pair, but the user has not yet entered the credential"
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    const-string v2, "Key generation failed "
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    const-string v4, "Randomized encryption (IND-CPA) required but may be violated by padding scheme: "

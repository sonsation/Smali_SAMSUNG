...
.method protected engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    const-string v7, "keySpecClass == null"
    ...
    const-string v8, ". This KeyFactory supports only Android Keystore asymmetric keys"
    ...
    const-string v8, ". KeyInfo can be obtained only for Android Keystore private keys"
    ...
    const-string v8, "Invalid key alias: "
    ...
    const-string v8, ". X509EncodedKeySpec can be obtained only for Android Keystore public"
    ...
    const-string v7, "Key material export of Android Keystore private keys is not supported"
    ...
    const-string v7, "Cannot export key material of public key in PKCS#8 format. Only X.509 format (X509EncodedKeySpec) supported for public keys."
    ...
    const-string v8, "Obtaining RSAPublicKeySpec not supported for "
    ...
    const-string v8, "Obtaining ECPublicKeySpec not supported for "
    ...
    const-string v8, "Unsupported key spec: "

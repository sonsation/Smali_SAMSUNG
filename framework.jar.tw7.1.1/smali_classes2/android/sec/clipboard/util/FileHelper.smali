...
.method public createThumnailFromData(Landroid/content/Context;Lcom/samsung/android/content/clipboard/data/SemClipData;)Ljava/lang/String;
    ...
    const-string v20, "FileHelper"

    const-string v21, "Create preview image for html data in createThumnailFromData()"
    ...
    const-string v21, "getFirstImage : FileName is empty."
    ...
    const-string v22, "createThumnailFromData() is false because clip is not html type. clip.GetFomat() :"
    ...
    const-string v22, "createThumnailFromData() is false because clip is invalid data. clip :"
    ...
    const-string v20, "/data/clipboard/temp/"
    ...
    const-string v21, "downloadSimpleBitmap"
    ...
    const-string v21, "getUriPathBitmap..."
...
.method public createThumnailFromUriData(Landroid/content/Context;Lcom/samsung/android/content/clipboard/data/SemUriClipData;)Ljava/lang/String;
    ...
    const-string v19, "FileHelper"

    const-string v20, "Create preview image for uri data in createThumnailFromData()"
    ...
    const-string v21, "createThumnailFromData() is false because clip is not uri type. clip.GetFomat() :"
    ...
    const-string v21, "createThumnailFromData() is false because clip is invalid data. clip :"
    ...
    const-string v19, "/data/clipboard/temp/"
    ...
    const-string v20, "getUriPathBitmap..."
...
.method public loadObjectFile(Ljava/io/File;)Ljava/lang/Object;
    ...
    const-string v11, "load object file"
...
.method public setFirstImagePathFromHtmlData(Lcom/samsung/android/content/clipboard/data/SemHtmlClipData;)Z
    ...
    const-string v5, "getFirstImage : FileName is too long."
    ...
    const-string v6, "directly use firstImagePath...getFilePathBitmap : Substring Filepath  - "
...
.method public setThumbnailImagePathFromUriData(Lcom/samsung/android/content/clipboard/data/SemUriClipData;)Z
    ...
    const-string v4, "getThumbnailImage : FileName is empty."

...
.method public static getImageQualityAnimation(ILandroid/content/Context;)Landroid/graphics/drawable/AnimationDrawable;
    ...
    :try_start_0
    const-string v8, "com.samsung.android.fingerprint.service"
    ...
    const-string v8, "FPMS_FingerprintManager"

    const-string v9, "mRes is null"
    ...
    const-string v9, "getImageQualityAnimation, NameNotFoundException"
    ...
    const-string v8, "spass_errimage_default"

    const-string v9, "anim"

    const-string v10, "com.samsung.android.fingerprint.service"
    ...
    const-string v9, "getImageQualityAnimation: failed to call getLastImageQuality"
    ...
    :sswitch_0
    const-string v8, "spass_errimage_nomatch"
    ...
    :sswitch_1
    const-string v8, "spass_errimage_short"
    ...
    :sswitch_2
    const-string v8, "spass_errimage_speed"
    ...
    :sswitch_3
    const-string v8, "spass_errimage_reverse"
    ...
    :sswitch_4
    const-string v8, "spass_errimage_left"
    ...
    :sswitch_5
    const-string v8, "spass_errimage_right"
    ...
    :sswitch_6
    const-string v8, "spass_errimage_wet"
    ...
    :sswitch_7
    const-string v8, "spass_errimage_diagonal"
    ...
    :sswitch_8
    const-string v8, "spass_errimage_homekey"
    ...
    :sswitch_9
    const-string v8, "spass_errimage_same"
    ...
    const-string v8, "spass_touch_errimage_default"
    ...
    :sswitch_a
    const-string v8, "spass_touch_errimage_nomatch"
    ...
    :sswitch_b
    const-string v8, "spass_touch_errimage_too_fast"
    ...
    :sswitch_c
    const-string v8, "spass_touch_errimage_something_on_the_sensor"
    ...
    :sswitch_d
    const-string v8, "spass_touch_errimage_whole"
    ...
    :sswitch_e
    const-string v8, "spass_touch_errimage_wet"
    ...
    :sswitch_f
    const-string v8, "spass_touch_errimage_position"
    ...
    const-string v9, "getImageQualityAnimation : failed"
...
.method public static getImageQualityFeedbackString(ILandroid/content/Context;)Ljava/lang/String;
    ...
    const-string v6, "FPMS_FingerprintManager"
    ...
    const-string v6, "touch_image_quality_finger_offset_too_far_left"
    ...
    const-string v6, "recognize_fail_verizon"
    ...
    :cond_3
    const-string v6, "recognize_fail"
    ...
    :sswitch_3
    const-string v6, "touch_image_quality_pressure_too_light"
    ...
    :sswitch_4
    const-string v6, "touch_image_quality_pressure_too_hard"
    ...
    :sswitch_5
    const-string v6, "touch_image_quality_same_as_previous"
    ...
    :sswitch_6
    const-string v6, "spass_image_quality_extraction_failure"
    ...
    :sswitch_7
    const-string v6, "spass_image_quality_wet_finger"
    ...
    :sswitch_8
    const-string v6, "spass_something_on_sensor"
    ...
    :sswitch_9
    const-string v6, "spass_status_too_fast"
    ...
    const-string v7, "getImageQualityFeedbackString : failed"
...
.method private static isLowerSpassSdkVersion(Landroid/os/Bundle;Ljava/lang/String;)Z
    ...
    const-string v7, "FPMS_FingerprintManager"

    const-string v8, "isLowerSpassSdkVersion : invalid param"
    ...
    const-string v8, "isLowerSpassSdkVersion : invalid SDK version info"
...
.method private isSpassProcessSDK(Ljava/lang/String;)Z
    ...
    const-string v0, "com.samsung.android.sdk.pass.process"
...
.method private startEnrollActivityWithConfirm(Landroid/content/Context;Lcom/samsung/android/fingerprint/FingerprintManager$EnrollFinishListener;Ljava/lang/String;I)Z
    ...
    const-string v2, "ActivityContext is null!! startEnrollActivityWithConfirm need activityContext"
    ...
    const-string v2, "Listener is null!! startEnrollActivityWithConfirm need EnrollFinishListener"
    ...
    const-string v2, "startEnrollActivityWithConfirm: notifyEnrollBegin failed"
    ...
    const-string v3, "startEnrollActivityWithConfirm: previousStage(mStringId)="
...
.method private static startFingerprintManagerService()V
    ...
    const-string v1, "FingerprintService is not running!"
    ...
    const-string v2, "com.samsung.android.fingerprint.service.FingerprintServiceStarter"

    invoke-direct {v0, v1, v2}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v7, v0}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    const-string v0, "com.samsung.android.fingerprint.action.START_SERVICE"
    ...
    const-string v1, "startFingerprintManagerService : failed to start service"
...
.method private startSettingEnrollActivity(Landroid/content/Context;Lcom/samsung/android/fingerprint/FingerprintManager$EnrollFinishListener;Ljava/lang/String;I)V
    ...
    const-string v3, "com.samsung.settings.REGISTER_FINGERPRINT"
    ...
    const-string v4, "startSettingEnrollActivity: exception"
...
.method private static waitForService()Z
    ...
    const-string v5, "waitForService: FPMS started"
    ...
    const-string v5, "waitForService: Timeout"
...
.method public cancel(Landroid/os/IBinder;)Z
    ...
    const-string v3, "cancel : FingerCompat is NULL"
...
.method public getEnrollRepeatCount()I
    ...
    const-string v1, "getFingerprintId"
...
.method public getEnrolledFingers()I
    ...
    const-string v0, "getFingerprintId"
    ...
    const-string v0, "getEnrolledFingers"
    ...
    const-string v1, "getEnrolledFingers : 0"
...
.method public getFingerprintId(I)Ljava/lang/String;
    ...
    const-string v4, "getFingerprintId"
...
.method public getFingerprintIds()[Ljava/lang/String;
    ...
    const-string v0, "getFingerprintIds"
...
.method public getLastImageQualityMessage(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v1, "getLastImageQualityMessage"
...
.method public hasPendingCommand()Z
    ...
    const-string v2, "hasPendingCommand : FingerCompat is NULL"
    ...
    const-string v1, "hasPendingCommand"
...
.method public identifyForMultiUser(Landroid/os/IBinder;ILjava/lang/String;)I
    ...
    const-string v2, "identifyForMultiUser : FingerCompat is NULL"
    ...
    const-string v1, "identifyForMultiUser"
...
.method public identifyWithDialog(Landroid/content/Context;Lcom/samsung/android/fingerprint/IFingerprintClient;Landroid/os/Bundle;)I
    ...
    const-string v4, "Context or Client is null"
    ...
    const-string v4, "identifyWithDialog : client is not Activity"
...
.method public isVZWPermissionGranted()Z
    ...
    const-string v1, "isVZWPermissionGranted"
...
.method public notifyEnrollBegin()Z
    ...
    const-string v1, "notifyEnrollBegin"
...
.method public notifyEnrollEnd()Z
    ...
    const-string v1, "notifyEnrollEnd"
...
.method public process(Landroid/os/IBinder;Ljava/lang/String;[B)[B
    ...
    const-string v6, "FingerprintService is not running!"
    ...
    const-string v6, "process : invalid param"
    ...
    const-string v6, "Invaild params"
...
.method public removeAllEnrolledFingers()Z
    ...
    const-string v1, "removeAllEnrolledFingers"
...
.method public removeEnrolledFinger(I)Z
    ...
    const-string v1, "removeEnrolledFinger"
...
.method public showIdentifyDialog(Landroid/content/Context;Lcom/samsung/android/fingerprint/FingerprintIdentifyDialog$FingerprintListener;Ljava/lang/String;Z)Landroid/app/Dialog;
    ...
    const-string v4, "showIdentifyDialog"
...
.method public startEnrollActivity(Landroid/content/Context;Lcom/samsung/android/fingerprint/FingerprintManager$EnrollFinishListener;Ljava/lang/String;)Z
    ...
    const-string v1, "ActivityContext is null!! startEnrollActivity need activityContext"
    ...
    const-string v1, "Listener is null!! startEnrollActivity need EnrollFinishListener"
    ...
    const-string v1, "Id parameter is needed. Please give a correct id."
    ...
    const-string v2, "startEnrollActivity : ID ="
...
.method public unregisterClient(Landroid/os/IBinder;)Z
    ...
    const-string v3, "unregisterClient : FingerCompat is NULL"
...
.method public verifySensorState(IIIII)I
    ...
    const-string v1, "verifySensorState : FingerCompat is NULL"

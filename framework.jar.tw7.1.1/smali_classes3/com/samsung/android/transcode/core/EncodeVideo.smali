...
.method private CheckVideoCodec(IILandroid/content/Context;Landroid/net/Uri;Z)Z
    ...
    const-string v3, "Resolution Error appear : width = "
    ...
    const-string v4, "Can\'t create Extractor"
    ...
    const-string v5, "Can\'t get VideoTrack"
    ...
    const-string v3, "Extactor Error appear : "
    ...
    const-string v2, "Codec resource is not enough"
...
.method public static checkRewritable(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    const-string v6, "Number of tracks: "
    ...
    const-string v4, "Valid video track absent"
    ...
    const-string v4, "Unsupported mime type: video"
    ...
    const-string v6, "Valid audio track absent"
...
.method public checkTransRewritable(Landroid/media/MediaFormat;I)I
    ...
    const-string v3, "Unable to detect csd-0: "
    ...
    const-string v0, "Overshoot capability"
    ...
    const-string v0, "Unable to detect csd-0 or csd-1"
    ...
    :cond_5
    :try_start_2
    const-string v0, "localSPS is null"
    ...
    :cond_8
    const-string v0, "SPS does not match"
    ...
    :cond_b
    :try_start_5
    const-string v0, "PPS does not match"
...
.method public checkTransRewritable(Landroid/media/MediaFormat;ILjava/lang/String;)I
    ...
    const-string v6, "Build.VERSION.SEM_PLATFORM_INT: "
...
.method public getLocalEncHeader(I)Lcom/samsung/android/transcode/core/EncodeVideo$SpsPps;
    ...
    const-string v3, "Local video format "
    ...
    const-string v3, "inputBufferIndex A: "
    ...
    const-string v2, "outputBufferIndex 4: "
    ...
    const-string v2, "codec cannot be created"
    ...
    const-string v3, "type is not a valid mime type: "
    ...
    const-string v3, "inputBufferIndex G4: "
    ...
    const-string v3, "inputBufferIndex G5: "
    ...
    const-string v6, "bufferInfo.size: "
    ...
    const-string v5, "Invalid start pattern"
    ...
    :cond_4
    :try_start_5
    const-string v5, "start pattern match"
...
.method protected prepareAudioCodec()V
    ...
    const-string v1, "mTrimAudioEndUs was 0 but updated"
    ...
    const-string v1, "Audio mime type is unknown. Ignore audio track."
    ...
    const-string v3, "Audio codec error appear : "
    ...
    const-string v1, "audio decoder input try again later while preparing audio codec"
    ...
    const-string v1, "audio decoder output buffer try again later while preparing audio codec"
    ...
    const-string v2, "audio decoder: output format changed: SampleRate"
...
.method protected prepareVideoCodec()V
    ...
    const-string v2, "input video format: "
    ...
    const-string v1, "mTrimVideoEndUs was 0 but updated"
    ...
    const-string v3, "output video format "
    ...
    const-string v1, "can\'t set VideoDecoder"
...
.method protected prepareVideoCodecNeo()V
    ...
    const-string v0, "mTrimVideoEndUs was 0 but updated"
    ...
    const-string v3, "mOutputVideoFrameRate: "
    ...
    const-string v1, "mTransRewritable: "
    ...
    const-string v1, "Skip video profile setup"
    ...
    const-string v1, "Unable to handle input file"
...
.method protected release()V
    ...
    const-string v2, "Exception in releasing output video encoder."
    ...
    const-string v2, "Exception in releasing input video decoder."
    ...
    const-string v2, "Exception in releasing outputSurface."
    ...
    const-string v2, "Exception in releasing logo renderer."
    ...
    const-string v2, "Exception in releasing input surface."
    ...
    const-string v2, "Exception in releasing output audio encoder."
    ...
    const-string v2, "Exception in releasing audio extractor."
...
.method public setEncodingCodecs(II)V
    ...
    const-string v2, "videoCodecType is: "
...
.method public setMaxOutputSize(I)V
    ...
    const-string v4, "max output size is "
...
.method protected startEncoding()V
    ...
    const-string v5, "Not starting encoding because it is stopped by user."
    ...
    const-string v6, "video extractor: EOS"
    ...
    const-string v6, "no video decoder input buffer"
    ...
    const-string v7, "video decoder: returned buffer for time "
    ...
    const-string v5, "video decoder: EOS"
    ...
    const-string v5, "no video decoder output buffer"
    ...
    const-string v5, "video decoder: output buffers changed"
    ...
    const-string v6, "video decoder: codec info format changed"
    ...
    const-string v6, "video decoder: codec config buffer"
    ...
    const-string v5, "output surface: await new image"
    ...
    const-string v5, "output surface: draw image"
    ...
    const-string v6, "input surface: swap buffers"
    ...
    const-string v6, "video encoder: notified of new frame"
    ...
    const-string v6, "video decoder: checkForNewImage return false!!  mUserStop : "
    ...
    const-string v5, "no video encoder output buffer"
    ...
    const-string v5, "video encoder: output buffers changed"
    ...
    const-string v6, "video encoder: output format changed "
    ...
    const-string v5, "Video encoder output format changed after muxer has started"
    ...
    const-string v5, "Unexpected result from video encoder dequeue output format."
    ...
    const-string v6, "video encoder: codec config buffer"
    ...
    const-string v8, "video encoder: writing sample data timestamp "
    ...
    const-string v6, "video encoder: EOS"
    ...
    const-string v5, "audio decoder input try again later"
    ...
    const-string v5, "TempAudio is null!"
    ...
    const-string v7, "audio encoder writing sample data to muxer "
    ...
    const-string v9, "audio encoder: EOS"
    ...
    const-string v5, "Encoding abruptly stopped."
...
.method public startTransRewriting()V
    ...
    :cond_2
    const-string v4, "Transcoding start"
    ...
    const-string v8, " After seekto previous I: "
    ...
    const-string v8, "Proceed to find I: Sampletime: "
    ...
    const-string v8, "Transcode section Start: "
    ...
    const-string v4, "Reversed. Recalculating..."
    ...
    const-string v5, "Now...Input time: "
    ...
    const-string v8, "Set transcode mode: Start: "
    ...
    const-string v5, "Abandon TransRewrite. Switch to Rewrite mode."
    ...
    const-string v5, "Start point has not been updated!"
    ...
    const-string v5, "Audio Transcode section: Current position: "
    ...
    const-string v5, " mTrimAudioStartUs: "
    ...
    :goto_18
    const-string v2, "Rewriting starts"
    ...
    :goto_19
    const-string v2, "Transcoding Done"
    ...
    :goto_1c
    const-string v4, "Move forward to locate: Video"
    ...
    :cond_23
    const-string v3, "no video decoder input buffer"
    ...
    :cond_31
    const-string v2, "output surface: await new image"
    ...
    const-string v2, "output surface: draw image"
    ...
    const-string v3, "input surface: swap buffers"
    ...
    const-string v3, "video encoder: notified of new frame"
    ...
    const-string v3, "video decoder: checkForNewImage return false!!  mUserStop : "
    ...
    const-string v5, "video encoder: writing sample data timestamp "
    ...
    :cond_4d
    const-string v2, "audio decoder input try again later"
    ...
    :cond_55
    const-string v2, "audio decoder output buffer try again later"
    ...
    :cond_59
    const-string v3, "audio decoder: codec config buffer"
    ...
    :cond_5b
    const-string v2, "audio encoder input buffer try again later"
    ...
    const-string v3, "Audio encoder output format changed after muxer is started."
    ...
    :cond_66
    const-string v3, "audio encoder ignoring BUFFER_FLAG_CODEC_CONFIG"
    ...
    :cond_6f
    const-string v2, "Encoding abruptly stopped."
    ...
    :cond_79
    const-string v4, "saw input EOS: Video"
    ...
    :cond_7d
    const-string v2, "saw input EOS: Audio"

...
.method protected prepare()V
    ...
    const-string v2, "Total frames to be written "
    ...
    const-string v2, ". Frames per image "
...
.method protected prepareAudioCodecs()V
    ...
    const-string v4, "Audio output format "
    ...
    const-string v1, "Codec initialization error, unable to create Codecs!"
    ...
    const-string v3, "Audio max input size not defined"
...
.method protected release()V
    ...
    const-string v2, "Exception in releasing renderer."
...
.method protected startEncoding()V
    ...
    const-string v13, "reached video encoder end of stream unexpectedly"
    ...
    const-string v14, "Video encoder output try again later "
    ...
    const-string v14, "Unexpected result from video encoder dequeue output format."
    ...
    const-string v6, "video encoder OutputBuffer "
    ...
    const-string v16, "ignoring BUFFER_FLAG_CODEC_CONFIG"
    ...
    const-string v16, " bytes to muxer"
    ...
    const-string v5, "muxer hasn\'t started. We cannot write video encoder output."
    ...
    const-string v13, "video endcoder end of stream reached"
    ...
    const-string v6, " to video encoder"
    ...
    const-string v5, "sending EOS to video encoder"
    ...
    const-string v5, "audio decoder output buffer try again later"
    ...
    const-string v7, "audio encoder ignoring BUFFER_FLAG_CODEC_CONFIG"

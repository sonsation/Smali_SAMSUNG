...
.method public static typeToString(I)Ljava/lang/String;
    ...
    :sswitch_2
    const-string v0, "DIALOG_TYPE_LAUNCH_CONFIRMATION_MIRRORING"

    goto :goto_0

    :sswitch_3
    const-string v0, "DIALOG_TYPE_LAUNCH_CONFIRMATION_PRESENTATION"

    goto :goto_0

    :sswitch_4
    const-string v0, "DIALOG_TYPE_PROMOTION_MOUSE"

    goto :goto_0

    :sswitch_5
    const-string v0, "DIALOG_TYPE_PROMOTION_DOCK"
    ...
    :sswitch_8
    const-string v0, "PRESENTATION_TYPE_ANY"

    goto :goto_0

    :sswitch_9
    const-string v0, "PRESENTATION_TYPE_INTRO"

    goto :goto_0

    :sswitch_a
    const-string v0, "PRESENTATION_TYPE_LOADING_SCREEN_ENTER"

    goto :goto_0

    :sswitch_b
    const-string v0, "PRESENTATION_TYPE_LOADING_SCREEN_EXIT"

    goto :goto_0

    :sswitch_c
    const-string v0, "PRESENTATION_TYPE_BLACK_SCREEN"

    goto :goto_0

    :sswitch_d
    const-string v0, "NOTIFICATION_TYPE_ONGOING_AVAILABLE_FIRST"

    goto :goto_0

    :sswitch_e
    const-string v0, "NOTIFICATION_TYPE_ONGOING_AVAILABLE"

    goto :goto_0

    :sswitch_f
    const-string v0, "NOTIFICATION_TYPE_ONGOING_USING"

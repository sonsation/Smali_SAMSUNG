...
.method private ReadXMLMetaData(Ljava/lang/String;)V
    ...
    const-string v1, "TilePose"

    invoke-interface {v0, v1}, Lorg/w3c/dom/Element;->getElementsByTagName(Ljava/lang/String;)Lorg/w3c/dom/NodeList;

    move-result-object v5

    const-string v0, "VirtualTourDataManager"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Tile Pose Count "
...
.method private WriteXMLMetaData(IFF[I[F[I[Lcom/samsung/android/media/virtualtour/CVector3;[Lcom/samsung/android/media/virtualtour/CVector3;Ljava/util/Vector;)Ljava/lang/String;
    ...
    const-string v10, "NextTransition"
    ...
    const-string v3, "NextTransition"
...
.method public decodeSEF(Ljava/lang/String;)Z
    ...
    const-string v5, "\' is a not Virtual Tour SEF File"
    ...
    const-string v5, "\' is a Virtual Tour SEF File"
    ...
    const-string v6, "Number of SEF data :"
    ...
    const-string v4, "VirtualTourDataManager"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "[TIME] DecodeSEF::XMLParsing "
    ...
    const-string v1, "Failed in SEF decode"
    ...
    :cond_8
    const-string v0, "SEFParfer"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Unsupported Transition Type:"
    ...
    :cond_11
    const-string v2, "VirtualTourDataManager"

    const-string v3, "XML Parsing Failed - Continuing with BIN"
...
.method public encodeSEF(Ljava/lang/String;Ljava/lang/String;I[I[F[I[Lcom/samsung/android/media/virtualtour/CVector3;Ljava/util/Vector;)I
    ...
    const-string v8, "VirtualTourHeader.bin"
    ...
    const-string v6, "XML Formatting Time = "
    ...
    const-string v4, "VirtualTourHeader.bin"
    ...
    const-string v3, "VirtualTour_Info"
    ...
    const-string v3, "No Images to save"
    ...
    const-string v4, "VirtualTour_%03d"

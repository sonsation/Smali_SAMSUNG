...
.method public static declared-synchronized getInstance(Landroid/content/Context;Lcom/samsung/android/privatemode/IPrivateModeClient;)Lcom/samsung/android/privatemode/SemPrivateModeManager;
    ...
    const-string v2, "getInstance: context or client is null"
    ...
    const-string v2, "getInstance: Not support Private Mode"
...
.method private static isKnoxMode(Landroid/content/Context;)Z
    ...
    :cond_1
    const-string v5, "PPS_SemPrivateModeManager"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "isKnoxMode : "
    ...
    const-string v7, "not call com.samsung.android.knox.SemPersonaManager;."
...
.method public static isPrivateModeReady(Landroid/content/Context;)Z
    ...
    const-string v4, "isReady: getSystemFeatureLevel : "
    ...
    const-string v4, "isReady: versionPrivatemode : "
    ...
    const-string v3, "isReady: AFW_CL"
    ...
    const-string v3, "isReady: Has no locktype"
    ...
    const-string v3, "isReady: Current User is not Owner User(guest mode)"
    ...
    const-string v3, "isReady: AFW_BYOD"
...
.method public static isPrivateStorageMounted(Landroid/content/Context;)Z
    ...
    const-string v4, "PPS_SemPrivateModeManager"

    const-string v5, "isPrivateStorageMounted: context is null"
    ...
    const-string v6, "isPrivateStorageMounted: "
    ...
    const-string v5, "isKnoxMode : return false"
    ...
    const-string v5, "PROPERTY_KEY_PRIVATE_MODE[0] : return false"
...
.method public registerListener(Lcom/samsung/android/privatemode/IPrivateModeClient;)Landroid/os/IBinder;
    ...
    const-string v2, "registerClient"

    const-string v3, "PrivateMode Service is not running!"
    ...
    const-string v3, "Private Mode ON!!"

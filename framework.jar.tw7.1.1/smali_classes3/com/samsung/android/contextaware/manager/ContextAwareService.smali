...
.method public static final getCAEService()Lcom/samsung/android/contextaware/manager/ContextAwareService;
    ...
    const-string v3, "CAE Service is null"
    ...
    const-string v3, "CAE class not match"
...
.method public sendApStatusToSensorHub(I)V
    ...
    const-string v3, "[apStat 01] Mutex is locked for sending AP Status "
    ...
    const-string v3, "[apStat 02] Mutex is unlocked for sending AP Status "
...
.method public final sendCurTimeToSensorHub()V
    ...
    :try_start_0
    const-string v3, "[curTime 01] Mutex is locked for sending current time"
    ...
    :cond_0
    const-string v3, "[curTime 02] Mutex is unlocked for sending current time"
...
.method public final sendPCPositiontoSensorHub([BBB)I
    ...
    :try_start_0
    const-string v1, "[PCPos 01] Mutex is locked for sending passive current position"
    ...
    const-string v1, "[PCPos 02] Mutex is unlocked for sending passive current position"
...
.method public final sendTelephonyCmdToSensorHub([BBB)V
    ...
    :try_start_0
    const-string v0, "[telStat 01] Mutex is locked for sending telephony state"
    ...
    const-string v0, "[telStat 02] Mutex is unlocked for sending telephony state"

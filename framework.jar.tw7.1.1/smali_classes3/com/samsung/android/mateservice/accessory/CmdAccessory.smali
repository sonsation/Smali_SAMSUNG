...
.method private assertAccessory(Ljava/io/PrintWriter;)Z
    ...
    const-string v0, "Failed. Retry after removing all attached accessories."
...
.method private internalAdd(Ljava/io/PrintWriter;[B[B)Lcom/samsung/android/mateservice/accessory/CmdAccessory$AccessoryInfo;
    ...
    :cond_1
    const-string v4, "Failed! Wrong parameter."
    ...
    const-string v4, "Failed! Exceed max accessory count."
    ...
    const-string v5, "A new fake accessory ["
    ...
    :cond_8
    const-string v4, "Failed to add a fake accessory."
...
.method public accessoryStateChanged(Ljava/io/PrintWriter;IZ)Z
    ...
    :cond_0
    :goto_0
    const-string v6, "A fake accessory [%d] event is failed."
    ...
    const-string v7, "Error! A fake accessory [%d] is already %s."
    ...
    const-string v7, "A fake accessory [%d] is %s."
...
.method public clearAll(Ljava/io/PrintWriter;)Z
    ...
    const-string v1, "All fake accessories are removed."
...
.method public remove(Ljava/io/PrintWriter;I)Z
    ...
    const-string v8, "A fake accessory ["
    ...
    const-string v8, "Failed to remove a fake accessory ["
...
.method public showStatus(Ljava/io/PrintWriter;)Z
    ...
    const-string v17, "-------- Fake accessory list: "
    ...
    const-string v15, "[%d] %s / svc type[%d] / svc id[0x%x] / serial no[%s] / %s"
    ...
    :cond_4
    :try_start_1
    const-string v15, "No fake accessory"

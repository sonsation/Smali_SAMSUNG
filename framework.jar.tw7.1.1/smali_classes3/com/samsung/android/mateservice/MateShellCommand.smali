...
.method private runAdd()I
    ...
    const-string v5, "Error! Wrong argument"
...
.method private runAddRaw()I
    ...
    const-string v4, "Error! Wrong argument"
...
.method private runAttach()I
    ...
    const-string v3, "Error! No accessory id"
...
.method public onHelp()V
    ...
    const-string v1, "  add <SERVICE_TYPE> <SERVICE_ID> <SERIAL_NUMBER>"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "  add-raw <DATA_BYTES_STRING> <EXTRA_DATA_BYTES_STRING>"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "    add a fake accessory info.\n"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "  remove <ACCESSORY_ID>"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "    remove a fake accessory info.\n"
    ...
    const-string v1, "    clear all fake accessory info.\n"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "  attach <ACCESSORY_ID>"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "    send the event of attached fake accessory\n"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "  detach <ACCESSORY_ID>"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/mateservice/MateShellCommand;->mOut:Ljava/io/PrintWriter;

    const-string v1, "    send the event of detached fake accessory\n"
    ...
    const-string v1, "    show the status of fake accessory\n"

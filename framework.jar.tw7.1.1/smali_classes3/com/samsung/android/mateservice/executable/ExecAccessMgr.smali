...
.method private addPlatformPkg(Ljava/lang/String;)Z
    ...
    const-string v3, "exceeds max count"
...
.method private isPrivilegedPkg(I)Z
    ...
    const-string v6, "isPrivilegedPkg uid[%d] is invalid"
...
.method private isRegisteredPlatformPkg(I)Z
    ...
    const-string v4, "isRegisteredPlatformPkg pkg[%s] uid[%s] is valid"
    ...
    const-string v4, "isRegisteredPlatformPkg uid[%d] is invalid"
...
.method public static throwSecurityException(ILjava/lang/String;)V
    ...
    const-string v4, "illegal access: uid[%d] / pid[%d] / %d / %s"
...
.method public isAccessible(I)Z
    ...
    const-string v4, "isAccessible returns false / action[0x%x], uid [%d], pid[%d]"
    ...
    const-string v4, "privileged uid"
    ...
    const-string v4, "platform key signed pkg"

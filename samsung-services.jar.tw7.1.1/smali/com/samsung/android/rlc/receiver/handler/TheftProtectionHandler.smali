...
.method private static getTheftProtectionBody(Landroid/content/Context;)Lcom/samsung/android/rlc/vo/DeviceApiRequestVO;
    ...
    .line 97
    .local v6, "imeis":[Ljava/lang/String;
    const-string v7, ""

    .line 98
    .local v7, "regImei":Ljava/lang/String;
    if-eqz v6, :cond_0
    ...
    .line 107
    .local v3, "fakeRlcId":Ljava/lang/String;
    const/4 v5, 0x0
    ...
    .line 111
    .local v4, "fakeSvrNonce":Ljava/lang/String;
    const/4 v5, 0x0
    ...
    const-string v11, "[getTheftProtectionBody] fakeSvrNonce : "
    ...
    const-string v11, "[getTheftProtectionBody] fakeRlcId : "
    ...
    .end local v3    # "fakeRlcId":Ljava/lang/String;
    .end local v4    # "fakeSvrNonce":Ljava/lang/String;
    .end local v5    # "i":I
    .end local v6    # "imeis":[Ljava/lang/String;
    .end local v7    # "regImei":Ljava/lang/String;
    :goto_2
    return-object v8
...
.method public static run(Landroid/content/Context;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string v11, "TheftProtectionHandler run"
    ...
    .line 40
    .local v8, "thirdCheck":Ljava/lang/String;
    const-string v10, "theftptc"
    ...
    .line 41
    .local v7, "theftCheck":Ljava/lang/String;
    ...
    const-string v11, "Not final check case"

    invoke-static {v10, v11}, Lcom/samsung/android/rlc/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)V

    .line 81
    .end local v7    # "theftCheck":Ljava/lang/String;
    .end local v8    # "thirdCheck":Ljava/lang/String;
    :cond_2
    :goto_0
    const/4 v10, 0x0
    ...
    .line 41
    .restart local v7    # "theftCheck":Ljava/lang/String;
    .restart local v8    # "thirdCheck":Ljava/lang/String;
    :cond_3
    const-string v10, "Y"
    ...
    const-string v10, "https://%s/dm/v1/dev/checkDestroy"
    ...
    const-string v11, "TheftProtectionHandler : SUCCESS "
    ...
    .line 49
    .local v3, "resVO":Lcom/samsung/android/rlc/vo/DeviceApiResponseVO;
    invoke-virtual {v3}, Lcom/samsung/android/rlc/vo/DeviceApiResponseVO;->getSignByte()[B

    move-result-object v6

    .line 50
    .local v6, "signedData":[B
    ...
    .line 51
    .local v0, "backUpData":Lorg/json/JSONObject;
    invoke-static {p0}, Lcom/samsung/android/rlc/util/RLCUtil;->getInstance(Landroid/content/Context;)Lcom/samsung/android/rlc/util/RLCUtil;
    ...
    const-string v12, "Data backup result : "
    ...
    .line 59
    :cond_4
    const-string v10, "rmm.samsung.com"
    ...
    const-string v11, "Reset CSC Feature info"
    ...
    const-string v11, "RMM Status is not prenormal"

...
.method private addUUIDPrefs(IILjava/lang/String;)Z
    ...
    .line 240
    const-string v18, "SD card uuid field is null"
    ...
    const-string v18, "/efs/sec_efs/"

    const-string v19, "SDCardEncryption.Pref"
    ...
    const-string v19, "SD card status is same "
    ...
    .line 273
    const-string v18, "Only SD card policy update"
    ...
    .line 286
    const-string v18, "delete first UUID list"
...
.method private removeUUIDPrefs(Ljava/lang/String;)Z
    ...
    .line 391
    const-string v15, "SD card uuid field is null"
    ...
    const-string v15, "/efs/sec_efs/"

    const-string v16, "SDCardEncryption.Pref"
    ...
    const-string v16, "remove the item : "
    ...
    .line 419
    const-string v15, "can\'t find remove uuid"
...
.method private restoreUUIDPrefs(Landroid/os/Bundle;)Ljava/util/List;
    ...
    .line 344
    :try_start_0
    const-string v10, "restoreUUIDPrefs"
    ...
    .line 349
    const-string v10, "read data is null from file"
    ...
    :cond_1
    const-string v10, "Can\'t read or open pref file"
...
.method private updateMDMPolicyPrefs(I)Z
    ...
    .line 191
    const-string v11, "policy is same"
...
.method public clearPrefs(Ljava/lang/String;)V
    ...
    const-string v5, "UUID list size : "
...
.method public migrationUUIDPrefs(Ljava/lang/String;Z)I
    ...
    .line 456
    const-string v12, "SD card uuid field for migration is null"
    ...
    const-string v13, "DirEncryption.Pref"
    ...
    :cond_5
    :goto_3
    const-string v12, "Migration Success [Encryption Policy File]"
    ...
    .restart local v9    # "reader":Ljava/io/BufferedReader;
    :cond_8
    const-string v12, "There is no old encryption pref file"

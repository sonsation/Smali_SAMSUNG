...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 52
    .local v43, "_result":Landroid/view/DisplayInfo;
    ...
    .end local v43    # "_result":Landroid/view/DisplayInfo;
    :sswitch_2
    const-string/jumbo v4, "android.hardware.display.IDisplayManager"
    ...
    .line 147
    .local v40, "_result":Landroid/hardware/display/WifiDisplayStatus;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 159
    .end local v40    # "_result":Landroid/hardware/display/WifiDisplayStatus;
    :sswitch_d
    const-string/jumbo v4, "android.hardware.display.IDisplayManager"
    ...
    .local v32, "_arg1":Landroid/view/Surface;
    goto :goto_3

    .line 243
    .end local v5    # "_arg0":Landroid/hardware/display/IVirtualDisplayCallback;
    .end local v32    # "_arg1":Landroid/view/Surface;
    :sswitch_12
    const-string/jumbo v4, "android.hardware.display.IDisplayManager"
    ...
    .end local v22    # "_arg0":I
    .end local v30    # "_arg1":I
    .end local v34    # "_arg2":Landroid/os/Bundle;
    :sswitch_1a
    const-string/jumbo v4, "android.hardware.display.IDisplayManager"
    ...
    .line 422
    .local v39, "_result":Landroid/hardware/display/WifiDisplay;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 420
    .end local v27    # "_arg0":Z
    .end local v39    # "_result":Landroid/hardware/display/WifiDisplay;
    :cond_9
    const/16 v27, 0x0
    ...
    .line 428
    .restart local v27    # "_arg0":Z
    .restart local v39    # "_result":Landroid/hardware/display/WifiDisplay;
    :cond_a
    const/4 v4, 0x0
    ...
    .line 528
    .local v41, "_result":Landroid/os/Bundle;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 540
    .end local v15    # "_arg0":Ljava/lang/String;
    .end local v41    # "_result":Landroid/os/Bundle;
    :sswitch_2d
    const-string/jumbo v4, "android.hardware.display.IDisplayManager"
    ...
    .line 544
    .restart local v41    # "_result":Landroid/os/Bundle;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 583
    .local v38, "_result":Landroid/hardware/display/SemDlnaDevice;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 595
    .end local v38    # "_result":Landroid/hardware/display/SemDlnaDevice;
    :sswitch_31
    const-string/jumbo v4, "android.hardware.display.IDisplayManager"
    ...
    .line 645
    .restart local v38    # "_result":Landroid/hardware/display/SemDlnaDevice;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .local v31, "_arg1":Landroid/hardware/display/SemDlnaDevice;
    goto :goto_18

    .line 683
    .end local v25    # "_arg0":Landroid/os/IBinder;
    .end local v31    # "_arg1":Landroid/hardware/display/SemDlnaDevice;
    :sswitch_3a
    const-string/jumbo v4, "android.hardware.display.IDisplayManager"
    ...
    .line 703
    .local v42, "_result":Landroid/os/IBinder;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 700
    .end local v42    # "_result":Landroid/os/IBinder;
    :cond_19
    move/from16 v0, v29

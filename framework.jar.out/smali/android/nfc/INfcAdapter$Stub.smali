...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 52
    .local v37, "_result":Landroid/nfc/INfcTag;
    ...
    .line 58
    .end local v37    # "_result":Landroid/nfc/INfcTag;
    :sswitch_2
    const-string/jumbo v4, "android.nfc.INfcAdapter"
    ...
    .line 60
    .local v35, "_result":Landroid/nfc/INfcCardEmulation;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 66
    .end local v35    # "_result":Landroid/nfc/INfcCardEmulation;
    :sswitch_3
    const-string/jumbo v4, "android.nfc.INfcAdapter"
    ...
    .line 68
    .local v36, "_result":Landroid/nfc/INfcFCardEmulation;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 74
    .end local v36    # "_result":Landroid/nfc/INfcFCardEmulation;
    :sswitch_4
    const-string/jumbo v4, "android.nfc.INfcAdapter"
    ...
    .line 78
    .local v34, "_result":Landroid/nfc/INfcAdapterExtras;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v34    # "_result":Landroid/nfc/INfcAdapterExtras;
    :sswitch_5
    const-string/jumbo v4, "android.nfc.INfcAdapter"
    ...
    .line 178
    .local v27, "_arg1":[Landroid/content/IntentFilter;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 173
    .end local v27    # "_arg1":[Landroid/content/IntentFilter;
    :cond_c
    const/4 v12, 0x0
    ...
    .restart local v27    # "_arg1":[Landroid/content/IntentFilter;
    :cond_d
    const/16 v30, 0x0

    .local v30, "_arg2":Landroid/nfc/TechListParcel;
    goto :goto_d

    .line 190
    .end local v27    # "_arg1":[Landroid/content/IntentFilter;
    .end local v30    # "_arg2":Landroid/nfc/TechListParcel;
    :sswitch_10
    const-string/jumbo v4, "android.nfc.INfcAdapter"
    ...
    .line 234
    .local v29, "_arg2":Landroid/nfc/ITagRemovedCallback;
    move-object/from16 v0, p0
    ...
    .end local v11    # "_arg0":I
    .end local v29    # "_arg2":Landroid/nfc/ITagRemovedCallback;
    .end local v39    # "_result":Z
    :sswitch_15
    const-string/jumbo v4, "android.nfc.INfcAdapter"
    ...
    .local v31, "_arg3":Landroid/os/Bundle;
    goto :goto_11
    ...
    .end local v31    # "_arg3":Landroid/os/Bundle;
    :sswitch_17
    const-string/jumbo v4, "android.nfc.INfcAdapter"
    ...
    .line 616
    .local v33, "_result":Landroid/graphics/Bitmap;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 628
    .end local v19    # "_arg0":Ljava/lang/String;
    .end local v33    # "_result":Landroid/graphics/Bitmap;
    :sswitch_3c
    const-string/jumbo v4, "android.nfc.INfcAdapter"
